...
export class AccuracyService {
  ...
  private async getAccuracyByResults({
    ...
    const [
      ...
      this.prismaChessClient.$queryRaw<{ average: number }[]>(winQuery),
      this.prismaChessClient.$queryRaw<{ average: number }[]>(drawQuery),
      this.prismaChessClient.$queryRaw<{ average: number }[]>(lossQuery),
    ]);
  ...
  private async getAverageAccuracy({
    ...
    const [
      ...
      this.prismaChessClient.$queryRaw<AccuracyByPeriodDto[]>(
  ...
  async getAccuracy(username: string): Promise<AccuracyDto> {
