...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    'src/generated/prisma/chess/client',
    'generated/prisma/chess/client',
  ];
...
path.join(
  process.cwd(),
  'src/generated/prisma/chess/client/libquery_engine-darwin-arm64.dylib.node'
);
// file annotations for bundling tools to include these files
path.join(__dirname, 'schema.prisma');
path.join(process.cwd(), 'src/generated/prisma/chess/client/schema.prisma');
