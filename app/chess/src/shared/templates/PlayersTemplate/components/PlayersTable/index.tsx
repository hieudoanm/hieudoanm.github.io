          ...
          <tbody>
            {players.map(
              ({
                ...
                const bulletStats = getStatsByTimeClass(ChessTimeClass.bullet);
                const blitzStats = getStatsByTimeClass(ChessTimeClass.blitz);
                const rapidStats = getStatsByTimeClass(ChessTimeClass.rapid);
