...
export type PlayerInsightsGeographyProperties = {
  insights?: Insights;
};

export const PlayerInsightsGeography: React.FC<
  PlayerInsightsGeographyProperties
...
PlayerInsightsGeography.displayName = 'PlayerInsightsGeography';
