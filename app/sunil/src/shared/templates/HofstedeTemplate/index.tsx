...
import countries from '@sunil/common/json/hofstede.json';
import {
  Chart as ChartJS,
  ChartData,
  ChartDataset,
...
export const HofstedeTemplate: NextPage = () => {
      ...
      <div className="p-8">
        <form
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                  ...
                  <IconButton
                    ...
                    onClick={(event) => {
                      ...
                      setCountryIds((previous) => {
                        ...
                        const newCountryIds: number[] = [...new Set(previous)];
            ...
            <div className="col-span-1">
              <Text>Uncertainty Avoidance ({scales.uncertaintyAvoidance})</Text>
              <Slider
            ...
            <div className="col-span-1">
              <Text>Long Term Orientation ({scales.longTermOrientation})</Text>
              <Slider
