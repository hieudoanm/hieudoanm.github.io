    ...
    <div className="flex items-center justify-center">
      <Link href={`/${encodeURI(id)}`}>
        <div className="flex flex-col items-center gap-y-2 md:gap-y-4">
          <div className="flex aspect-square h-16 w-16 items-center justify-center rounded-full border transition-all ease-linear hover:shadow md:h-20 md:w-20 lg:h-24 lg:w-24">
            {icon}
          </div>
...
const HomePage: NextPage = () => {
  ...
  return (
    <>
      ...
      <div className="grid min-h-full grid-cols-4 gap-6 md:grid-cols-6 md:gap-8">
