...
import { ChessCastling } from '@chess/common/types/chess';
...
const PlayerInsightsMovesCastlingByType: React.FC<{
  title: string;
...
export const PlayerInsightsMovesCastling: React.FC<{ insights?: Insights }> = ({
  ...
  return (
    <div className="card border border-gray-200 shadow">
      ...
      <div className="card-body border-b">
        <PlayerInsightsMovesCastlingByType
