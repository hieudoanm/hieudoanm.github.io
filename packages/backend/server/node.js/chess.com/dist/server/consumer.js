...
const startConsumerServer = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      yield exports.consumer.connect();
      log_1.logger.info('✅ Kafka Consumer Connected');
      yield exports.consumer.subscribe({
        topic: constants_1.TOPIC,
        fromBeginning: true,
      });
        ...
        eachMessage: (_a) =>
          __awaiter(
            ...
            function* ({ topic, partition, message }) {
              ...
              const messageValue =
                (_c =
                  (_b = message.value) === null || _b === void 0
                    ? void 0
              ...
              log_1.logger.info(
                `📩 Received message: ${topic} ${partition} ${(_d = message.value) === null || _d === void 0 ? void 0 : _d.toString()}`
              );
            }
          ),
      });
