...
const getIndex = (request, response) => {
    var _a, _b;
    const parsedUrl = node_url_1.default.parse((_a = request.url) !== null && _a !== void 0 ? _a : '', true);
    const pathname = (_b = parsedUrl.pathname) !== null && _b !== void 0 ? _b : '';
    const filePath = node_path_1.default.join(PUBLIC_DIR, pathname === '/' ? 'index.html' : pathname);
...
const getTitled = (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const { url = '' } = request;
...
const postTitled = (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d;
    const { url = '' } = request;
    const [path, queryString] = url.split('?');
    const query = new URLSearchParams(queryString);
    ...
    const titleMap = (_b = (_a = query.get('titleMap')) === null || _a === void 0 ? void 0 : _a.toLowerCase()) !== null && _b !== void 0 ? _b : 'all';
    const title = (_d = (_c = query.get('title')) === null || _c === void 0 ? void 0 : _c.toUpperCase()) !== null && _d !== void 0 ? _d : '';
    const titles = title !== '' ? [title] : constants_1.TITLES_MAP.get(titleMap);
    for (const title of titles) {
        const { data: players = [] } = yield (0, try_catch_1.tryCatch)((0, chess_client_1.getPlayers)(title));
        if (!players) {
...
const producerServer = (0, node_http_1.createServer)((request, response) => __awaiter(void 0, void 0, void 0, function* () {
