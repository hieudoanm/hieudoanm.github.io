...
import { FaFileWord, FaTable } from 'react-icons/fa6';
...
const JsonAppsPage: NextPage = () => {
  const apps: NothingApp[] = [
    ...
    },
    {
      ...
      name: 'JSON to YAML',
      shortName: 'json2yaml',
      icon: <FaFileWord className="text-xl md:text-2xl" />,
    },
  ];
  ...
  return (
    <div className="h-screen w-screen overflow-hidden bg-gray-100 md:h-screen">
      <div className="container mx-auto h-full p-4 md:p-8">
        <div className="grid h-full grid-cols-1 grid-rows-2 gap-4 md:grid-cols-2 md:grid-rows-1 md:gap-8">
          {apps.map(
