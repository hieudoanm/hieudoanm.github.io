if (!self.define) {
  ...
  self.define = (a, i) => {
    ...
    s[n] = Promise.all(a.map((e) => d[e] || r(e))).then((e) => (i(...e), c));
  };
}
    ...
    e.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: 'tKyBB9mzNnIT_sbUB4vgC',
        },
        {
        ...
        {
          url: '/_next/static/chunks/pages/_app-7d29fb429638fef1.js',
          revision: 'tKyBB9mzNnIT_sbUB4vgC',
        },
        {
        ...
        {
          url: '/_next/static/chunks/pages/apps-03aa2530c0f8fb69.js',
          revision: 'tKyBB9mzNnIT_sbUB4vgC',
        },
        {
        ...
        {
          url: '/_next/static/css/725c8d587f0a9f16.css',
          revision: '725c8d587f0a9f16',
        },
        {
        ...
        {
          url: '/_next/static/tKyBB9mzNnIT_sbUB4vgC/_buildManifest.js',
          revision: 'a971af129251dbacf31003fee3c4d6db',
        },
        {
          url: '/_next/static/tKyBB9mzNnIT_sbUB4vgC/_ssgManifest.js',
