if (!self.define) {
  ...
  self.define = (t, i) => {
    ...
    let c = {};
    const l = (e) => n(e, a),
      o = { module: { uri: a }, exports: c, require: l };
    s[a] = Promise.all(t.map((e) => o[e] || l(e))).then((e) => (i(...e), c));
  };
}
  ...
  importScripts(),
    ...
    e.precacheAndRoute(
      [
        ...
        {
          url: '/nothing/_next/static/PlbJEUt6HBEblST1l1PyY/_buildManifest.js',
          revision: '62b1d2350eb68fa4c960520fae0d2456',
        },
        {
          url: '/nothing/_next/static/PlbJEUt6HBEblST1l1PyY/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/nothing/_next/static/chunks/1265-f16836d48b1fa31c.js',
          revision: 'PlbJEUt6HBEblST1l1PyY',
        },
        {
