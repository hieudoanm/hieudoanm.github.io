if (!self.define) {
  ...
  self.define = (t, i) => {
    ...
    s[a] = Promise.all(t.map((e) => f[e] || o(e))).then((e) => (i(...e), c));
  };
}
  ...
  importScripts(),
    ...
    e.precacheAndRoute(
      [
        ...
        {
          url: '/nothing/_next/static/UPtX0C3RofXO3kQx4f2e9/_buildManifest.js',
          revision: '447e59f6a99e2e4bd67b529cafd7f738',
        },
        {
          url: '/nothing/_next/static/UPtX0C3RofXO3kQx4f2e9/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/nothing/_next/static/chunks/0bf34dc7-d7403df3b8615ebe.js',
          revision: 'UPtX0C3RofXO3kQx4f2e9',
        },
        {
        ...
        {
          url: '/nothing/_next/static/chunks/pages/apps/chess/converter/fen2png-e3e86ef034c09b6d.js',
          revision: 'UPtX0C3RofXO3kQx4f2e9',
        },
        {
