if (!self.define) {
  ...
  self.define = (i, t) => {
    ...
    e[a] = Promise.all(i.map((n) => o[n] || g(n))).then((n) => (t(...n), c));
  };
}
    ...
    n.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: 'dBmOnvpPkHLukhUpJYj1g',
        },
        {
        ...
        {
          url: '/nothing/_next/static/dBmOnvpPkHLukhUpJYj1g/_buildManifest.js',
          revision: '62b1d2350eb68fa4c960520fae0d2456',
        },
        {
          url: '/nothing/_next/static/dBmOnvpPkHLukhUpJYj1g/_ssgManifest.js',
