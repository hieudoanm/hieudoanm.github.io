if (!self.define) {
    ...
    s[e] ||
      new Promise((s) => {
        if ('document' in self) {
          ...
          (i.src = e), (i.onload = s), document.head.appendChild(i);
        } else (i = e), importScripts(e), s();
      }).then(() => {
        let i = s[e];
  ...
  self.define = (n, t) => {
    ...
    s[a] = Promise.all(n.map((i) => g[i] || o(i))).then((i) => (t(...i), c));
  };
}
define(['./workbox-01fd22c6'], function (i) {
  'use strict';
  importScripts(),
    self.skipWaiting(),
    i.clientsClaim(),
    i.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: 'jTgidgok3rVNRCMaNxifG',
        },
        {
        ...
        {
          url: '/nothing/_next/static/chunks/pages/_app-73818d2aaaef4c2f.js',
          revision: 'jTgidgok3rVNRCMaNxifG',
        },
        {
        ...
        {
          url: '/nothing/_next/static/css/a8068a00a7d97650.css',
          revision: 'a8068a00a7d97650',
        },
        {
          url: '/nothing/_next/static/jTgidgok3rVNRCMaNxifG/_buildManifest.js',
          revision: 'b2fab154a7d229ce96e415da83947dc1',
        },
        {
          url: '/nothing/_next/static/jTgidgok3rVNRCMaNxifG/_ssgManifest.js',
