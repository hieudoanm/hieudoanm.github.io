if (!self.define) {
  ...
  self.define = (t, i) => {
    ...
    n[a] = Promise.all(t.map((s) => u[s] || o(s))).then((s) => (i(...s), c));
  };
}
    ...
    s.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: 'pXRs31RBLtnucPW1a7xOH',
        },
        {
        ...
        {
          url: '/nothing/_next/static/pXRs31RBLtnucPW1a7xOH/_buildManifest.js',
          revision: '62b1d2350eb68fa4c960520fae0d2456',
        },
        {
          url: '/nothing/_next/static/pXRs31RBLtnucPW1a7xOH/_ssgManifest.js',
