if (!self.define) {
  ...
  self.define = (t, a) => {
    ...
    e[i] = Promise.all(t.map((n) => r[n] || o(n))).then((n) => (a(...n), c));
  };
}
    ...
    n.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: 'nac3ac_1FkEOz9NKzjTtN',
        },
        {
        ...
        {
          url: '/nothing/_next/static/nac3ac_1FkEOz9NKzjTtN/_buildManifest.js',
          revision: 'c757db7df2a3130da7979ba93e66fb4b',
        },
        {
          url: '/nothing/_next/static/nac3ac_1FkEOz9NKzjTtN/_ssgManifest.js',
