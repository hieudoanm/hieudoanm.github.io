if (!self.define) {
  ...
  self.define = (i, t) => {
    ...
    let c = {};
    const o = (s) => n(s, a),
      h = { module: { uri: a }, exports: c, require: o };
    e[a] = Promise.all(i.map((s) => h[s] || o(s))).then((s) => (t(...s), c));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/nothing/_next/static/90hsAbzZqWwhxobFZ2FzP/_buildManifest.js',
          revision: '62b1d2350eb68fa4c960520fae0d2456',
        },
        {
          url: '/nothing/_next/static/90hsAbzZqWwhxobFZ2FzP/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/nothing/_next/static/chunks/1265-f16836d48b1fa31c.js',
          revision: '90hsAbzZqWwhxobFZ2FzP',
        },
        {
