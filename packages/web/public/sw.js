if (!self.define) {
  ...
  self.define = (t, i) => {
    ...
    s[a] = Promise.all(t.map((e) => o[e] || c(e))).then((e) => (i(...e), r));
  };
}
    ...
    e.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: 'qpB7kWz4r5JrtPdQ2wGb1',
        },
        {
        ...
        {
          url: '/nothing/_next/static/qpB7kWz4r5JrtPdQ2wGb1/_buildManifest.js',
          revision: '62b1d2350eb68fa4c960520fae0d2456',
        },
        {
          url: '/nothing/_next/static/qpB7kWz4r5JrtPdQ2wGb1/_ssgManifest.js',
