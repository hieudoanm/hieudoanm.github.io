if (!self.define) {
  ...
  self.define = (i, t) => {
    ...
    let c = {};
    const d = (n) => s(n, a),
      g = { module: { uri: a }, exports: c, require: d };
    e[a] = Promise.all(i.map((n) => g[n] || d(n))).then((n) => (t(...n), c));
  };
}
  ...
  importScripts(),
    ...
    n.precacheAndRoute(
      [
        ...
        {
          url: '/nothing/_next/static/R79izdYNnGOlegldn8VBZ/_buildManifest.js',
          revision: '62b1d2350eb68fa4c960520fae0d2456',
        },
        {
          url: '/nothing/_next/static/R79izdYNnGOlegldn8VBZ/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/nothing/_next/static/chunks/1265-f16836d48b1fa31c.js',
          revision: 'R79izdYNnGOlegldn8VBZ',
        },
        {
