if (!self.define) {
  ...
  self.define = (t, i) => {
    ...
    e[c] = Promise.all(t.map((n) => r[n] || o(n))).then((n) => (i(...n), a));
  };
}
  ...
  importScripts(),
    ...
    n.precacheAndRoute(
      [
        ...
        {
          url: '/nothing/_next/static/0YtSZD71c_24blFonrMDp/_buildManifest.js',
          revision: '62b1d2350eb68fa4c960520fae0d2456',
        },
        {
          url: '/nothing/_next/static/0YtSZD71c_24blFonrMDp/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/nothing/_next/static/chunks/1265-f16836d48b1fa31c.js',
          revision: '0YtSZD71c_24blFonrMDp',
        },
        {
