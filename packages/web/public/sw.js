if (!self.define) {
  ...
  self.define = (i, t) => {
    ...
    s[c] = Promise.all(i.map((e) => o[e] || r(e))).then((e) => (t(...e), a));
  };
}
  ...
  importScripts(),
    ...
    e.precacheAndRoute(
      [
        ...
        {
          url: '/nothing/_next/static/JG-VNckAm_uyF7r6dQb8q/_buildManifest.js',
          revision: '15a9e3fbb631b6898bf43562dc86ab62',
        },
        {
          url: '/nothing/_next/static/JG-VNckAm_uyF7r6dQb8q/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/nothing/_next/static/chunks/4799-070eb27c2ab86829.js',
          revision: 'JG-VNckAm_uyF7r6dQb8q',
        },
        {
