if (!self.define) {
  ...
  self.define = (a, t) => {
    ...
    s[c] = Promise.all(a.map((e) => f[e] || r(e))).then((e) => (t(...e), n));
  };
}
  ...
  importScripts(),
    ...
    e.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/SvDe3SfE6NUi-w6BDZ616/_buildManifest.js',
          revision: 'eb97781d0e13a16dc9bd5e12de1e14b1',
        },
        {
          url: '/_next/static/SvDe3SfE6NUi-w6BDZ616/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/097cc682-d9464a339152968f.js',
          revision: 'SvDe3SfE6NUi-w6BDZ616',
        },
        {
