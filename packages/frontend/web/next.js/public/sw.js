if (!self.define) {
  ...
  self.define = (i, n) => {
    ...
    let c = {};
    const l = (e) => a(e, t),
      d = { module: { uri: t }, exports: c, require: l };
    s[t] = Promise.all(i.map((e) => d[e] || l(e))).then((e) => (n(...e), c));
  };
}
  ...
  importScripts(),
    ...
    e.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/Zl1dLylnOGbZ_Q1RUUWl6/_buildManifest.js',
          revision: 'a75d2881dedf71ce66df4829e9e18d75',
        },
        {
          url: '/_next/static/Zl1dLylnOGbZ_Q1RUUWl6/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/016399ef-e4e9133a0b1fccb6.js',
          revision: 'Zl1dLylnOGbZ_Q1RUUWl6',
        },
        {
