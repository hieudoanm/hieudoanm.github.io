if (!self.define) {
  ...
  self.define = (c, i) => {
    ...
    let n = {};
    const r = (e) => t(e, a),
      d = { module: { uri: a }, exports: n, require: r };
    s[a] = Promise.all(c.map((e) => d[e] || r(e))).then((e) => (i(...e), n));
  };
}
    ...
    e.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: 'twj8YIDxhRwmcJ0KJT1p4',
        },
        {
        ...
        {
          url: '/_next/static/chunks/pages/index-5eb0abd7b65f71c0.js',
          revision: 'twj8YIDxhRwmcJ0KJT1p4',
        },
        {
        ...
        {
          url: '/_next/static/twj8YIDxhRwmcJ0KJT1p4/_buildManifest.js',
          revision: 'eb97781d0e13a16dc9bd5e12de1e14b1',
        },
        {
          url: '/_next/static/twj8YIDxhRwmcJ0KJT1p4/_ssgManifest.js',
