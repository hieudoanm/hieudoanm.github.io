if (!self.define) {
  ...
  self.define = (i, t) => {
    ...
    e[c] = Promise.all(i.map((s) => f[s] || r(s))).then((s) => (t(...s), n));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/ICrAfLaxZGs2Q3Is1qB2U/_buildManifest.js',
          revision: 'a75d2881dedf71ce66df4829e9e18d75',
        },
        {
          url: '/_next/static/ICrAfLaxZGs2Q3Is1qB2U/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/016399ef-e4e9133a0b1fccb6.js',
          revision: 'ICrAfLaxZGs2Q3Is1qB2U',
        },
        {
