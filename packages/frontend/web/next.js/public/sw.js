if (!self.define) {
  ...
  self.define = (t, a) => {
    ...
    s[c] = Promise.all(t.map((e) => d[e] || r(e))).then((e) => (a(...e), n));
  };
}
  ...
  importScripts(),
    ...
    e.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/-YOwt8vAx6yKCiBGDH2xQ/_buildManifest.js',
          revision: 'a75d2881dedf71ce66df4829e9e18d75',
        },
        {
          url: '/_next/static/-YOwt8vAx6yKCiBGDH2xQ/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/016399ef-e4e9133a0b1fccb6.js',
          revision: '-YOwt8vAx6yKCiBGDH2xQ',
        },
        {
