if (!self.define) {
  ...
  self.define = (t, a) => {
    ...
    s[n] = Promise.all(t.map((e) => d[e] || r(e))).then((e) => (a(...e), c));
  };
}
  ...
  importScripts(),
    ...
    e.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/bvLQ1t_PMGonlGx8duKir/_buildManifest.js',
          revision: 'c656634d4b95400993735188d50b0621',
        },
        {
          url: '/_next/static/bvLQ1t_PMGonlGx8duKir/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/097cc682-d9464a339152968f.js',
          revision: 'bvLQ1t_PMGonlGx8duKir',
        },
        {
