if (!self.define) {
  ...
  self.define = (t, a) => {
    ...
    s[c] = Promise.all(t.map((e) => d[e] || f(e))).then((e) => (a(...e), n));
  };
}
  ...
  importScripts(),
    ...
    e.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/7sdXJ16pAb5-yiq9fftbg/_buildManifest.js',
          revision: 'c656634d4b95400993735188d50b0621',
        },
        {
          url: '/_next/static/7sdXJ16pAb5-yiq9fftbg/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/097cc682-d9464a339152968f.js',
          revision: '7sdXJ16pAb5-yiq9fftbg',
        },
        {
