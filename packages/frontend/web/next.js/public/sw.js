if (!self.define) {
  ...
  self.define = (a, t) => {
    ...
    s[c] = Promise.all(a.map((e) => o[e] || d(e))).then((e) => (t(...e), n));
  };
}
  ...
  importScripts(),
    ...
    e.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/IMyID_JdiBA7oI3K7a0Uv/_buildManifest.js',
          revision: 'c656634d4b95400993735188d50b0621',
        },
        {
          url: '/_next/static/IMyID_JdiBA7oI3K7a0Uv/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/097cc682-d9464a339152968f.js',
          revision: 'IMyID_JdiBA7oI3K7a0Uv',
        },
        {
