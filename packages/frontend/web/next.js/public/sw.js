if (!self.define) {
  ...
  self.define = (t, i) => {
    ...
    let n = {};
    const b = (e) => a(e, c),
      r = { module: { uri: c }, exports: n, require: b };
    s[c] = Promise.all(t.map((e) => r[e] || b(e))).then((e) => (i(...e), n));
  };
}
    ...
    e.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: 'gqNTNhT04mUaqby_zW9bt',
        },
        {
        ...
        {
          url: '/_next/static/gqNTNhT04mUaqby_zW9bt/_buildManifest.js',
          revision: 'c656634d4b95400993735188d50b0621',
        },
        {
          url: '/_next/static/gqNTNhT04mUaqby_zW9bt/_ssgManifest.js',
