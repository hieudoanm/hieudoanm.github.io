if (!self.define) {
  ...
  self.define = (t, a) => {
    ...
    e[c] = Promise.all(t.map((s) => d[s] || r(s))).then((s) => (a(...s), n));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/GvpGi1b3pswtHiNT7FisS/_buildManifest.js',
          revision: 'e76bcbc0add1f1f3064b5be8965f3f67',
        },
        {
          url: '/_next/static/GvpGi1b3pswtHiNT7FisS/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/1296-7766d84f4c7a9060.js',
          revision: 'GvpGi1b3pswtHiNT7FisS',
        },
        {
        ...
        {
          url: '/_next/static/chunks/pages/_app-add01d7826365a03.js',
          revision: 'GvpGi1b3pswtHiNT7FisS',
        },
        {
        ...
        {
          url: '/_next/static/chunks/pages/apps-49c018b8884fdf31.js',
          revision: 'GvpGi1b3pswtHiNT7FisS',
        },
        {
