if (!self.define) {
  ...
  self.define = (i, a) => {
    ...
    let n = {};
    const r = (e) => c(e, t),
      x = { module: { uri: t }, exports: n, require: r };
    s[t] = Promise.all(i.map((e) => x[e] || r(e))).then((e) => (a(...e), n));
  };
}
  ...
  importScripts(),
    ...
    e.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/ICxW3qI7Kx_xOX68qchS-/_buildManifest.js',
          revision: 'c656634d4b95400993735188d50b0621',
        },
        {
          url: '/_next/static/ICxW3qI7Kx_xOX68qchS-/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/097cc682-d9464a339152968f.js',
          revision: 'ICxW3qI7Kx_xOX68qchS-',
        },
        {
