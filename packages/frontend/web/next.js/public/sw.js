if (!self.define) {
  ...
  self.define = (i, a) => {
    ...
    s[c] = Promise.all(i.map((e) => d[e] || r(e))).then((e) => (a(...e), n));
  };
}
    ...
    e.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: 'gBOaGFwt5MmtiZ0x0WI3J',
        },
        {
        ...
        {
          url: '/_next/static/gBOaGFwt5MmtiZ0x0WI3J/_buildManifest.js',
          revision: 'eb97781d0e13a16dc9bd5e12de1e14b1',
        },
        {
          url: '/_next/static/gBOaGFwt5MmtiZ0x0WI3J/_ssgManifest.js',
