if (!self.define) {
  ...
  self.define = (a, i) => {
    ...
    s[t] = Promise.all(a.map((e) => d[e] || r(e))).then((e) => (i(...e), c));
  };
}
  ...
  importScripts(),
    ...
    e.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/2bnVMMxNJ-Snnah8UySJN/_buildManifest.js',
          revision: 'a75d2881dedf71ce66df4829e9e18d75',
        },
        {
          url: '/_next/static/2bnVMMxNJ-Snnah8UySJN/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/016399ef-e4e9133a0b1fccb6.js',
          revision: '2bnVMMxNJ-Snnah8UySJN',
        },
        {
