if (!self.define) {
  ...
  self.define = (c, a) => {
    ...
    s[t] = Promise.all(c.map((e) => r[e] || d(e))).then((e) => (a(...e), n));
  };
}
  ...
  importScripts(),
    ...
    e.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/5PvpiIdVxcKREBSNNIysF/_buildManifest.js',
          revision: 'eb97781d0e13a16dc9bd5e12de1e14b1',
        },
        {
          url: '/_next/static/5PvpiIdVxcKREBSNNIysF/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/097cc682-d9464a339152968f.js',
          revision: '5PvpiIdVxcKREBSNNIysF',
        },
        {
