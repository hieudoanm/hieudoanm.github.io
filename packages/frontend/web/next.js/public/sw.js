if (!self.define) {
  ...
  self.define = (c, i) => {
    ...
    s[t] = Promise.all(c.map((e) => r[e] || o(e))).then((e) => (i(...e), n));
  };
}
  ...
  importScripts(),
    ...
    e.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/_z5obF7B3XGWRaNUk7Cpc/_buildManifest.js',
          revision: 'a75d2881dedf71ce66df4829e9e18d75',
        },
        {
          url: '/_next/static/_z5obF7B3XGWRaNUk7Cpc/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/016399ef-e4e9133a0b1fccb6.js',
          revision: '_z5obF7B3XGWRaNUk7Cpc',
        },
        {
