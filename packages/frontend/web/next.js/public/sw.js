if (!self.define) {
  ...
  self.define = (i, a) => {
    ...
    s[n] = Promise.all(i.map((e) => d[e] || r(e))).then((e) => (a(...e), t));
  };
}
  ...
  importScripts(),
    ...
    e.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/89bJczJUgu0SRr2xqvnsp/_buildManifest.js',
          revision: 'c656634d4b95400993735188d50b0621',
        },
        {
          url: '/_next/static/89bJczJUgu0SRr2xqvnsp/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/097cc682-d9464a339152968f.js',
          revision: '89bJczJUgu0SRr2xqvnsp',
        },
        {
