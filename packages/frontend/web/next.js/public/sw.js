if (!self.define) {
  ...
  self.define = (i, a) => {
    ...
    s[c] = Promise.all(i.map((e) => r[e] || o(e))).then((e) => (a(...e), n));
  };
}
  ...
  importScripts(),
    ...
    e.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/FPtWoAJz_-RvbBQ8Wgv_5/_buildManifest.js',
          revision: 'c656634d4b95400993735188d50b0621',
        },
        {
          url: '/_next/static/FPtWoAJz_-RvbBQ8Wgv_5/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/097cc682-d9464a339152968f.js',
          revision: 'FPtWoAJz_-RvbBQ8Wgv_5',
        },
        {
