...
const Block: FC<{
  ...
  return (
    <div className="relative aspect-square w-16 transform rounded rounded-lg border border-gray-800 bg-gray-900 text-gray-100 transition-all duration-100 ease-linear hover:z-10 hover:scale-[2]">
      {number > 0 ? (
      ...
      <div className="absolute right-0 bottom-1 left-0 truncate px-2 text-center text-[8px]">
        <p
          className="truncate text-center text-[8px]"
        ...
        <thead>
          <tr>
            <th colSpan={20}>
              ...
              <p className="truncate pb-2">G / P (Group / Period)</p>
            </th>
          </tr>
        </thead>
        <tbody>
          <tr>
            ...
            <td className="p-2" align="center"></td>
          </tr>
          <tr>
