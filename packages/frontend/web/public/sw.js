if (!self.define) {
  ...
  self.define = (i, t) => {
    ...
    e[c] = Promise.all(i.map((s) => r[s] || o(s))).then((s) => (t(...s), n));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/Pk0ih_6lIkaAC6HNodNUs/_buildManifest.js',
          revision: '1a00b521a621f3d590c8537e6416ba08',
        },
        {
          url: '/_next/static/Pk0ih_6lIkaAC6HNodNUs/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'Pk0ih_6lIkaAC6HNodNUs',
        },
        {
