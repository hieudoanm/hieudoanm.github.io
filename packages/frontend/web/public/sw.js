if (!self.define) {
  ...
  self.define = (a, t) => {
    ...
    e[c] = Promise.all(a.map((s) => r[s] || d(s))).then((s) => (t(...s), n));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/bgOi3IYudyiQ3YfJ5d110/_buildManifest.js',
          revision: 'd7064ac4f5b31c9924ee042fbaec00da',
        },
        {
          url: '/_next/static/bgOi3IYudyiQ3YfJ5d110/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'bgOi3IYudyiQ3YfJ5d110',
        },
        {
