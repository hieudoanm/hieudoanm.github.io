if (!self.define) {
  ...
  self.define = (a, t) => {
    ...
    let n = {};
    const o = (e) => i(e, c),
      K = { module: { uri: c }, exports: n, require: o };
    s[c] = Promise.all(a.map((e) => K[e] || o(e))).then((e) => (t(...e), n));
  };
}
  ...
  importScripts(),
    ...
    e.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/xiohRl1e5K8KqVjzKxK8-/_buildManifest.js',
          revision: '772768ef9c2c20ee36180103137e4d5e',
        },
        {
          url: '/_next/static/xiohRl1e5K8KqVjzKxK8-/_ssgManifest.js',
