if (!self.define) {
  ...
  self.define = (a, t) => {
    ...
    let o = {};
    const c = (e) => n(e, i),
      g = { module: { uri: i }, exports: o, require: c };
    s[i] = Promise.all(a.map((e) => g[e] || c(e))).then((e) => (t(...e), o));
  };
}
  ...
  importScripts(),
    ...
    e.precacheAndRoute(
      [
        ...
        {
          url: '/nothing/_next/static/wXKTZ4Xq5--gLeajoS472/_buildManifest.js',
          revision: '6257ed3c4af95fdb14dddee0fadece11',
        },
        {
          url: '/nothing/_next/static/wXKTZ4Xq5--gLeajoS472/_ssgManifest.js',
