if (!self.define) {
  ...
  self.define = (i, t) => {
    ...
    let h = {};
    const o = (s) => n(s, a),
      c = { module: { uri: a }, exports: h, require: o };
    e[a] = Promise.all(i.map((s) => c[s] || o(s))).then((s) => (t(...s), h));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/nothing/_next/static/hhwoHUkX9Q0lUi0hFs8Z-/_buildManifest.js',
          revision: 'f18a6d39d7775627b6473706ab7a3367',
        },
        {
          url: '/nothing/_next/static/hhwoHUkX9Q0lUi0hFs8Z-/_ssgManifest.js',
