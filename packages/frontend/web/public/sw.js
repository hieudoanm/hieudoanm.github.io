if (!self.define) {
  ...
  self.define = (a, t) => {
    ...
    e[i] = Promise.all(a.map((s) => d[s] || r(s))).then((s) => (t(...s), c));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/4dnRUaEj50fSQ5wkKn2LF/_buildManifest.js',
          revision: 'd7064ac4f5b31c9924ee042fbaec00da',
        },
        {
          url: '/_next/static/4dnRUaEj50fSQ5wkKn2LF/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: '4dnRUaEj50fSQ5wkKn2LF',
        },
        {
