if (!self.define) {
  ...
  self.define = (i, a) => {
    ...
    e[c] = Promise.all(i.map((s) => u[s] || r(s))).then((s) => (a(...s), n));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/AbLtu3Kik0AUflXBChCTV/_buildManifest.js',
          revision: '772768ef9c2c20ee36180103137e4d5e',
        },
        {
          url: '/_next/static/AbLtu3Kik0AUflXBChCTV/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/1314-5582cba5ae032e4d.js',
          revision: 'AbLtu3Kik0AUflXBChCTV',
        },
        {
