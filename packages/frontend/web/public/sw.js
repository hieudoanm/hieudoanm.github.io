if (!self.define) {
  ...
  self.define = (a, t) => {
    ...
    let n = {};
    const r = (s) => c(s, i),
      u = { module: { uri: i }, exports: n, require: r };
    e[i] = Promise.all(a.map((s) => u[s] || r(s))).then((s) => (t(...s), n));
  };
}
    ...
    s.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: 'uGdSAA95wANChEEqVLl8c',
        },
        {
        ...
        {
          url: '/_next/static/uGdSAA95wANChEEqVLl8c/_buildManifest.js',
          revision: '2b2e23a372fb57da2ed35a58ec28fabe',
        },
        {
          url: '/_next/static/uGdSAA95wANChEEqVLl8c/_ssgManifest.js',
