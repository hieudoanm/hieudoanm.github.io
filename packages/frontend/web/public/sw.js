if (!self.define) {
  ...
  self.define = (t, i) => {
    ...
    e[c] = Promise.all(t.map((s) => b[s] || r(s))).then((s) => (i(...s), n));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/-cXSUriCA1lbBvbavXdSt/_buildManifest.js',
          revision: '772768ef9c2c20ee36180103137e4d5e',
        },
        {
          url: '/_next/static/-cXSUriCA1lbBvbavXdSt/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/1314-5582cba5ae032e4d.js',
          revision: '-cXSUriCA1lbBvbavXdSt',
        },
        {
