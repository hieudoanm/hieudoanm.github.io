if (!self.define) {
  ...
  self.define = (t, i) => {
    ...
    s[a] = Promise.all(t.map((n) => d[n] || r(n))).then((n) => (i(...n), c));
  };
}
  ...
  importScripts(),
    ...
    n.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/MTdtynn9rCkOWz-iXnn5w/_buildManifest.js',
          revision: 'b70dff949e328c36d515000467fbaf60',
        },
        {
          url: '/_next/static/MTdtynn9rCkOWz-iXnn5w/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'MTdtynn9rCkOWz-iXnn5w',
        },
        {
