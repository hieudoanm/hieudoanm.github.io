if (!self.define) {
  ...
  self.define = (a, t) => {
    ...
    e[i] = Promise.all(a.map((s) => r[s] || o(s))).then((s) => (t(...s), n));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/N9YDLzFYhC6c14YBAoLMC/_buildManifest.js',
          revision: 'd7064ac4f5b31c9924ee042fbaec00da',
        },
        {
          url: '/_next/static/N9YDLzFYhC6c14YBAoLMC/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'N9YDLzFYhC6c14YBAoLMC',
        },
        {
