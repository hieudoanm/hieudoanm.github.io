if (!self.define) {
  ...
  self.define = (i, c) => {
    ...
    e[a] = Promise.all(i.map((s) => d[s] || r(s))).then((s) => (c(...s), n));
  };
}
    ...
    s.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: 'jBcMyUItMYxbhlDidQPIG',
        },
        {
        ...
        {
          url: '/_next/static/jBcMyUItMYxbhlDidQPIG/_buildManifest.js',
          revision: '1a00b521a621f3d590c8537e6416ba08',
        },
        {
          url: '/_next/static/jBcMyUItMYxbhlDidQPIG/_ssgManifest.js',
