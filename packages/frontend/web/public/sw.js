if (!self.define) {
  ...
  self.define = (a, i) => {
    ...
    let n = {};
    const p = (s) => t(s, c),
      r = { module: { uri: c }, exports: n, require: p };
    e[c] = Promise.all(a.map((s) => r[s] || p(s))).then((s) => (i(...s), n));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/KS7IC-pJNUpHtdfzPUzvu/_buildManifest.js',
          revision: 'b70dff949e328c36d515000467fbaf60',
        },
        {
          url: '/_next/static/KS7IC-pJNUpHtdfzPUzvu/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'KS7IC-pJNUpHtdfzPUzvu',
        },
        {
