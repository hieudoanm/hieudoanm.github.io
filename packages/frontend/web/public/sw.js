if (!self.define) {
  ...
  self.define = (a, t) => {
    ...
    e[n] = Promise.all(a.map((s) => l[s] || r(s))).then((s) => (t(...s), c));
  };
}
    ...
    s.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: 'y5bkwNw4GilH2CT-Pj4ia',
        },
        {
        ...
        {
          url: '/_next/static/y5bkwNw4GilH2CT-Pj4ia/_buildManifest.js',
          revision: '4dadee6fbb0f9909f26f588897b4c1f6',
        },
        {
          url: '/_next/static/y5bkwNw4GilH2CT-Pj4ia/_ssgManifest.js',
