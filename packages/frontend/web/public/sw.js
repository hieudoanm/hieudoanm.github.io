if (!self.define) {
  ...
  self.define = (i, a) => {
    ...
    e[t] = Promise.all(i.map((s) => o[s] || c(s))).then((s) => (a(...s), r));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/nothing/_next/static/NIuh28QrPAkrxCKiaP0pB/_buildManifest.js',
          revision: '6257ed3c4af95fdb14dddee0fadece11',
        },
        {
          url: '/nothing/_next/static/NIuh28QrPAkrxCKiaP0pB/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'NIuh28QrPAkrxCKiaP0pB',
        },
        {
