if (!self.define) {
  ...
  self.define = (c, t) => {
    ...
    e[i] = Promise.all(c.map((s) => l[s] || r(s))).then((s) => (t(...s), n));
  };
}
    ...
    s.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: 'rpB7llU1T1a-NC9cYojxE',
        },
        {
        ...
        {
          url: '/_next/static/rpB7llU1T1a-NC9cYojxE/_buildManifest.js',
          revision: '1878e3855a8c4fe60ebadffa3f747217',
        },
        {
          url: '/_next/static/rpB7llU1T1a-NC9cYojxE/_ssgManifest.js',
