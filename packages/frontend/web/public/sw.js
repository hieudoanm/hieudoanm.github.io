if (!self.define) {
  ...
  self.define = (a, i) => {
    ...
    e[c] = Promise.all(a.map((s) => o[s] || r(s))).then((s) => (i(...s), n));
  };
}
    ...
    s.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: 'xq4Dhrvhg6LQLsyZxoZzt',
        },
        {
        ...
        {
          url: '/_next/static/xq4Dhrvhg6LQLsyZxoZzt/_buildManifest.js',
          revision: 'd920bd5450ec9124a62587c855a1de83',
        },
        {
          url: '/_next/static/xq4Dhrvhg6LQLsyZxoZzt/_ssgManifest.js',
