if (!self.define) {
  ...
  self.define = (a, t) => {
    ...
    s[i] = Promise.all(a.map((e) => u[e] || r(e))).then((e) => (t(...e), n));
  };
}
  ...
  importScripts(),
    ...
    e.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/U4UJWjTPcuQYjUMOYrEex/_buildManifest.js',
          revision: 'd7064ac4f5b31c9924ee042fbaec00da',
        },
        {
          url: '/_next/static/U4UJWjTPcuQYjUMOYrEex/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'U4UJWjTPcuQYjUMOYrEex',
        },
        {
