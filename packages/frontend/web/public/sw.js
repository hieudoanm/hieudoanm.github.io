if (!self.define) {
  ...
  self.define = (i, a) => {
    ...
    n[t] = Promise.all(i.map((s) => r[s] || o(s))).then((s) => (a(...s), c));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/nothing/_next/static/TXMvqNs-3viYRKknGJEVa/_buildManifest.js',
          revision: 'f18a6d39d7775627b6473706ab7a3367',
        },
        {
          url: '/nothing/_next/static/TXMvqNs-3viYRKknGJEVa/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'TXMvqNs-3viYRKknGJEVa',
        },
        {
