if (!self.define) {
  ...
  self.define = (a, t) => {
    ...
    e[c] = Promise.all(a.map((s) => r[s] || u(s))).then((s) => (t(...s), n));
  };
}
    ...
    s.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: 'ds4gjyuGEFiS6Dzw7ULYu',
        },
        {
        ...
        {
          url: '/_next/static/ds4gjyuGEFiS6Dzw7ULYu/_buildManifest.js',
          revision: 'd920bd5450ec9124a62587c855a1de83',
        },
        {
          url: '/_next/static/ds4gjyuGEFiS6Dzw7ULYu/_ssgManifest.js',
