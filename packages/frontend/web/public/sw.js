if (!self.define) {
  ...
  self.define = (t, c) => {
    ...
    e[i] = Promise.all(t.map((s) => o[s] || r(s))).then((s) => (c(...s), n));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/XsabKWoSRrLJGsm5tEucB/_buildManifest.js',
          revision: 'b70dff949e328c36d515000467fbaf60',
        },
        {
          url: '/_next/static/XsabKWoSRrLJGsm5tEucB/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'XsabKWoSRrLJGsm5tEucB',
        },
        {
