if (!self.define) {
  ...
  self.define = (c, a) => {
    ...
    e[i] = Promise.all(c.map((s) => r[s] || u(s))).then((s) => (a(...s), n));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/HHuDxWJx-0ZHtP7cu7UG8/_buildManifest.js',
          revision: 'c68b9c5a6f2adb2e24a27eaf20be0f36',
        },
        {
          url: '/_next/static/HHuDxWJx-0ZHtP7cu7UG8/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/1314-5582cba5ae032e4d.js',
          revision: 'HHuDxWJx-0ZHtP7cu7UG8',
        },
        {
