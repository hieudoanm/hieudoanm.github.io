if (!self.define) {
  ...
  self.define = (i, c) => {
    ...
    e[t] = Promise.all(i.map((s) => o[s] || r(s))).then((s) => (c(...s), n));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/8RPUS4aPSwRi5--cbr_jY/_buildManifest.js',
          revision: '1a00b521a621f3d590c8537e6416ba08',
        },
        {
          url: '/_next/static/8RPUS4aPSwRi5--cbr_jY/_ssgManifest.js',
