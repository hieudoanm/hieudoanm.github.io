if (!self.define) {
  ...
  self.define = (t, i) => {
    ...
    e[c] = Promise.all(t.map((s) => d[s] || r(s))).then((s) => (i(...s), n));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/TrxJPd_PXBvUh5p5JAwkj/_buildManifest.js',
          revision: 'be7ddf91dcb9f405045eeb5ea929180f',
        },
        {
          url: '/_next/static/TrxJPd_PXBvUh5p5JAwkj/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'TrxJPd_PXBvUh5p5JAwkj',
        },
        {
