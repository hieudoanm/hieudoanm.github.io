if (!self.define) {
  ...
  self.define = (a, r) => {
    ...
    let i = {};
    const n = (s) => c(s, t),
      o = { module: { uri: t }, exports: i, require: n };
    e[t] = Promise.all(a.map((s) => o[s] || n(s))).then((s) => (r(...s), i));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/CMEprEoyrJqsXjF-Qcuf4/_buildManifest.js',
          revision: 'd7064ac4f5b31c9924ee042fbaec00da',
        },
        {
          url: '/_next/static/CMEprEoyrJqsXjF-Qcuf4/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'CMEprEoyrJqsXjF-Qcuf4',
        },
        {
        ...
        {
          url: '/_next/static/chunks/pages/_app-29b295d0040ff36f.js',
          revision: 'CMEprEoyrJqsXjF-Qcuf4',
        },
        {
        ...
        {
          url: '/_next/static/chunks/pages/posts-7ac3b401f05d7cb6.js',
          revision: 'CMEprEoyrJqsXjF-Qcuf4',
        },
        {
          url: '/_next/static/chunks/pages/posts/%5Bid%5D-5aaab48acf157f73.js',
          revision: 'CMEprEoyrJqsXjF-Qcuf4',
        },
        {
