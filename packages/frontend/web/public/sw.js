if (!self.define) {
  ...
  self.define = (c, t) => {
    ...
    e[i] = Promise.all(c.map((s) => r[s] || o(s))).then((s) => (t(...s), n));
  };
}
    ...
    s.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: 'qfg1oxE-_h1Eba3QHcPx2',
        },
        {
        ...
        {
          url: '/_next/static/qfg1oxE-_h1Eba3QHcPx2/_buildManifest.js',
          revision: '817f9a3c4c0cf4ccc686afd76ce9e852',
        },
        {
          url: '/_next/static/qfg1oxE-_h1Eba3QHcPx2/_ssgManifest.js',
