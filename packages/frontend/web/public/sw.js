if (!self.define) {
  ...
  self.define = (n, a) => {
    ...
    s[r] = Promise.all(n.map((t) => o[t] || c(t))).then((t) => (a(...t), i));
  };
}
define(['./workbox-46b0bab3'], function (t) {
  'use strict';
  importScripts(),
    self.skipWaiting(),
    t.clientsClaim(),
    t.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: 'r05r6kluzJqWBrat5tFPy',
        },
        {
        ...
        {
          url: '/nothing/_next/static/r05r6kluzJqWBrat5tFPy/_buildManifest.js',
          revision: '6257ed3c4af95fdb14dddee0fadece11',
        },
        {
          url: '/nothing/_next/static/r05r6kluzJqWBrat5tFPy/_ssgManifest.js',
