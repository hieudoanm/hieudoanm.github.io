if (!self.define) {
  ...
  self.define = (a, t) => {
    ...
    e[c] = Promise.all(a.map((s) => r[s] || f(s))).then((s) => (t(...s), n));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/VDfxZEFXiqLjIZKxXNfGz/_buildManifest.js',
          revision: 'd920bd5450ec9124a62587c855a1de83',
        },
        {
          url: '/_next/static/VDfxZEFXiqLjIZKxXNfGz/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/1314-5582cba5ae032e4d.js',
          revision: 'VDfxZEFXiqLjIZKxXNfGz',
        },
        {
