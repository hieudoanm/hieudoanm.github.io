if (!self.define) {
  ...
  self.define = (t, i) => {
    ...
    s[a] = Promise.all(t.map((e) => o[e] || g(e))).then((e) => (i(...e), c));
  };
}
  ...
  importScripts(),
    ...
    e.precacheAndRoute(
      [
        ...
        {
          url: '/nothing/_next/static/XOwygBFRsCeK8lgjkhWpe/_buildManifest.js',
          revision: '6257ed3c4af95fdb14dddee0fadece11',
        },
        {
          url: '/nothing/_next/static/XOwygBFRsCeK8lgjkhWpe/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'XOwygBFRsCeK8lgjkhWpe',
        },
        {
