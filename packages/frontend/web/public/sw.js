if (!self.define) {
  ...
  self.define = (a, t) => {
    ...
    s[i] = Promise.all(a.map((e) => o[e] || r(e))).then((e) => (t(...e), n));
  };
}
    ...
    e.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: 'ocQe3ijFV7ay3chntPZRr',
        },
        {
        ...
        {
          url: '/_next/static/ocQe3ijFV7ay3chntPZRr/_buildManifest.js',
          revision: '772768ef9c2c20ee36180103137e4d5e',
        },
        {
          url: '/_next/static/ocQe3ijFV7ay3chntPZRr/_ssgManifest.js',
