if (!self.define) {
  ...
  self.define = (t, a) => {
    ...
    s[i] = Promise.all(t.map((e) => o[e] || r(e))).then((e) => (a(...e), n));
  };
}
  ...
  importScripts(),
    ...
    e.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/4cDP_qjCeojtXrJcjQpFL/_buildManifest.js',
          revision: '1a00b521a621f3d590c8537e6416ba08',
        },
        {
          url: '/_next/static/4cDP_qjCeojtXrJcjQpFL/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: '4cDP_qjCeojtXrJcjQpFL',
        },
        {
