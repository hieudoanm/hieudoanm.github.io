if (!self.define) {
  ...
  self.define = (i, a) => {
    ...
    s[c] = Promise.all(i.map((e) => u[e] || r(e))).then((e) => (a(...e), n));
  };
}
  ...
  importScripts(),
    ...
    e.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/Qg_bt6ruZJlweCVyI7iPA/_buildManifest.js',
          revision: 'b70dff949e328c36d515000467fbaf60',
        },
        {
          url: '/_next/static/Qg_bt6ruZJlweCVyI7iPA/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'Qg_bt6ruZJlweCVyI7iPA',
        },
        {
