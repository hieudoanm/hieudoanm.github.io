if (!self.define) {
  ...
  self.define = (t, i) => {
    ...
    e[c] = Promise.all(t.map((s) => u[s] || r(s))).then((s) => (i(...s), n));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/5FJMh0kYbUBh51ASYudPl/_buildManifest.js',
          revision: 'd920bd5450ec9124a62587c855a1de83',
        },
        {
          url: '/_next/static/5FJMh0kYbUBh51ASYudPl/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/1314-5582cba5ae032e4d.js',
          revision: '5FJMh0kYbUBh51ASYudPl',
        },
        {
