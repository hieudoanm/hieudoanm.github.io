if (!self.define) {
  ...
  self.define = (a, t) => {
    ...
    let c = {};
    const r = (s) => n(s, i),
      p = { module: { uri: i }, exports: c, require: r };
    e[i] = Promise.all(a.map((s) => p[s] || r(s))).then((s) => (t(...s), c));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/B8p4nbfJk0vjrW9pVlhwm/_buildManifest.js',
          revision: 'd7064ac4f5b31c9924ee042fbaec00da',
        },
        {
          url: '/_next/static/B8p4nbfJk0vjrW9pVlhwm/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'B8p4nbfJk0vjrW9pVlhwm',
        },
        {
