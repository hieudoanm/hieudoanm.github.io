if (!self.define) {
    ...
    i[s] ||
      new Promise((i) => {
        if ('document' in self) {
          ...
          (n.src = s), (n.onload = i), document.head.appendChild(n);
        } else (n = s), importScripts(s), i();
      }).then(() => {
        let n = i[s];
  ...
  self.define = (e, t) => {
    ...
    i[a] = Promise.all(e.map((n) => r[n] || o(n))).then((n) => (t(...n), c));
  };
}
  ...
  importScripts(),
    ...
    n.precacheAndRoute(
      [
        ...
        {
          url: '/nothing/_next/static/XiI8dx2GPWDIiQmnE9_IG/_buildManifest.js',
          revision: '6257ed3c4af95fdb14dddee0fadece11',
        },
        {
          url: '/nothing/_next/static/XiI8dx2GPWDIiQmnE9_IG/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'XiI8dx2GPWDIiQmnE9_IG',
        },
        {
