if (!self.define) {
  ...
  self.define = (c, a) => {
    ...
    e[i] = Promise.all(c.map((s) => f[s] || r(s))).then((s) => (a(...s), n));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/P-f9tVKcm_RXOTFTy-RQy/_buildManifest.js',
          revision: 'b70dff949e328c36d515000467fbaf60',
        },
        {
          url: '/_next/static/P-f9tVKcm_RXOTFTy-RQy/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'P-f9tVKcm_RXOTFTy-RQy',
        },
        {
