if (!self.define) {
  ...
  self.define = (t, i) => {
    ...
    e[c] = Promise.all(t.map((s) => o[s] || r(s))).then((s) => (i(...s), n));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/L3CC7-xJIQR261-zzF5NK/_buildManifest.js',
          revision: '83e3cac646b87a03035fe8ea32265db5',
        },
        {
          url: '/_next/static/L3CC7-xJIQR261-zzF5NK/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'L3CC7-xJIQR261-zzF5NK',
        },
        {
