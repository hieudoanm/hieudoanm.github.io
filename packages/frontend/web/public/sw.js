if (!self.define) {
  ...
  self.define = (n, a) => {
    ...
    e[t] = Promise.all(n.map((s) => o[s] || r(s))).then((s) => (a(...s), i));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/Ls2nDrhSmQMWJN35cwRj_/_buildManifest.js',
          revision: '91a7e827377f35459686594bcdafef79',
        },
        {
          url: '/_next/static/Ls2nDrhSmQMWJN35cwRj_/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'Ls2nDrhSmQMWJN35cwRj_',
        },
        {
        ...
        {
          url: '/_next/static/chunks/pages/apps/ocr-c6768f2307b030a7.js',
          revision: 'Ls2nDrhSmQMWJN35cwRj_',
        },
        {
