if (!self.define) {
  ...
  self.define = (n, a) => {
    ...
    let t = {};
    const p = (s) => c(s, r),
      i = { module: { uri: r }, exports: t, require: p };
    e[r] = Promise.all(n.map((s) => i[s] || p(s))).then((s) => (a(...s), t));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/GpKp0dNpDrPZz2ocKTnr5/_buildManifest.js',
          revision: 'd7064ac4f5b31c9924ee042fbaec00da',
        },
        {
          url: '/_next/static/GpKp0dNpDrPZz2ocKTnr5/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'GpKp0dNpDrPZz2ocKTnr5',
        },
        {
