if (!self.define) {
  ...
  self.define = (t, i) => {
    ...
    e[r] = Promise.all(t.map((s) => o[s] || n(s))).then((s) => (i(...s), c));
  };
}
    ...
    s.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: 'fm3rGtgO_HrGhoJOsVmia',
        },
        {
        ...
        {
          url: '/_next/static/fm3rGtgO_HrGhoJOsVmia/_buildManifest.js',
          revision: 'b70dff949e328c36d515000467fbaf60',
        },
        {
          url: '/_next/static/fm3rGtgO_HrGhoJOsVmia/_ssgManifest.js',
