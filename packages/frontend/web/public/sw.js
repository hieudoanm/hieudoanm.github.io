if (!self.define) {
  ...
  self.define = (t, i) => {
    ...
    e[c] = Promise.all(t.map((s) => f[s] || r(s))).then((s) => (i(...s), n));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/URxGjH7DBafCVz2RQaTqt/_buildManifest.js',
          revision: 'c68b9c5a6f2adb2e24a27eaf20be0f36',
        },
        {
          url: '/_next/static/URxGjH7DBafCVz2RQaTqt/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/1314-5582cba5ae032e4d.js',
          revision: 'URxGjH7DBafCVz2RQaTqt',
        },
        {
