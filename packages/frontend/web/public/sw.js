if (!self.define) {
  ...
  self.define = (a, t) => {
    ...
    let c = {};
    const r = (s) => n(s, i),
      E = { module: { uri: i }, exports: c, require: r };
    e[i] = Promise.all(a.map((s) => E[s] || r(s))).then((s) => (t(...s), c));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/LsEnWbWQw9Y3XEETlreXN/_buildManifest.js',
          revision: 'd7064ac4f5b31c9924ee042fbaec00da',
        },
        {
          url: '/_next/static/LsEnWbWQw9Y3XEETlreXN/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'LsEnWbWQw9Y3XEETlreXN',
        },
        {
