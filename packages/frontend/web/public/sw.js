if (!self.define) {
  ...
  self.define = (t, c) => {
    ...
    let i = {};
    const g = (s) => a(s, n),
      r = { module: { uri: n }, exports: i, require: g };
    e[n] = Promise.all(t.map((s) => r[s] || g(s))).then((s) => (c(...s), i));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/azCAz1UWgq20nbU4cUtgm/_buildManifest.js',
          revision: '027ac262914bc23fcbb7dd81e12f25e3',
        },
        {
          url: '/_next/static/azCAz1UWgq20nbU4cUtgm/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'azCAz1UWgq20nbU4cUtgm',
        },
        {
