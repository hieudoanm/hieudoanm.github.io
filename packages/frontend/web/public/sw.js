if (!self.define) {
  ...
  self.define = (a, i) => {
    ...
    e[c] = Promise.all(a.map((s) => u[s] || r(s))).then((s) => (i(...s), n));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/QMONtXA2XCuF24SB5OFHN/_buildManifest.js',
          revision: 'f429919391341575e24ee1f462e50203',
        },
        {
          url: '/_next/static/QMONtXA2XCuF24SB5OFHN/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'QMONtXA2XCuF24SB5OFHN',
        },
        {
