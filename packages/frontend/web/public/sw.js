if (!self.define) {
  ...
  self.define = (c, a) => {
    ...
    let n = {};
    const g = (s) => i(s, t),
      o = { module: { uri: t }, exports: n, require: g };
    e[t] = Promise.all(c.map((s) => o[s] || g(s))).then((s) => (a(...s), n));
  };
}
    ...
    s.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: 'pu5ggH8djVciDHOgGoVYJ',
        },
        {
        ...
        {
          url: '/_next/static/pu5ggH8djVciDHOgGoVYJ/_buildManifest.js',
          revision: '7d5ed95f4eee2d6c383952f97d04cb14',
        },
        {
          url: '/_next/static/pu5ggH8djVciDHOgGoVYJ/_ssgManifest.js',
