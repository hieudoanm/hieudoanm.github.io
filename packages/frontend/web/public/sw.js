if (!self.define) {
  ...
  self.define = (t, a) => {
    ...
    e[i] = Promise.all(t.map((s) => u[s] || r(s))).then((s) => (a(...s), n));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/4UB8ZmcdTbRZxu4tHpwrc/_buildManifest.js',
          revision: '817f9a3c4c0cf4ccc686afd76ce9e852',
        },
        {
          url: '/_next/static/4UB8ZmcdTbRZxu4tHpwrc/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/1314-5582cba5ae032e4d.js',
          revision: '4UB8ZmcdTbRZxu4tHpwrc',
        },
        {
