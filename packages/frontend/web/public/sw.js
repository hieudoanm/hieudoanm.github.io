if (!self.define) {
  ...
  self.define = (t, i) => {
    ...
    n[a] = Promise.all(t.map((s) => d[s] || r(s))).then((s) => (i(...s), c));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/5yxnETLtJJnd-xBnki5Mq/_buildManifest.js',
          revision: '548969db45f33736cdb7e6e7d045af3d',
        },
        {
          url: '/_next/static/5yxnETLtJJnd-xBnki5Mq/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: '5yxnETLtJJnd-xBnki5Mq',
        },
        {
