if (!self.define) {
  ...
  self.define = (a, t) => {
    ...
    s[i] = Promise.all(a.map((n) => o[n] || r(n))).then((n) => (t(...n), c));
  };
}
  ...
  importScripts(),
    ...
    n.precacheAndRoute(
      [
        ...
        {
          url: '/nothing/_next/static/ar30VSWExPfPmmROmqnpq/_buildManifest.js',
          revision: '6257ed3c4af95fdb14dddee0fadece11',
        },
        {
          url: '/nothing/_next/static/ar30VSWExPfPmmROmqnpq/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'ar30VSWExPfPmmROmqnpq',
        },
        {
