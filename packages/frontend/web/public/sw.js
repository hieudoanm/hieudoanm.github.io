if (!self.define) {
  ...
  self.define = (a, t) => {
    ...
    c[i] = Promise.all(a.map((s) => d[s] || r(s))).then((s) => (t(...s), n));
  };
}
    ...
    s.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: 'd-F-3jWCz7wF4HcEcc6lZ',
        },
        {
        ...
        {
          url: '/_next/static/d-F-3jWCz7wF4HcEcc6lZ/_buildManifest.js',
          revision: '772768ef9c2c20ee36180103137e4d5e',
        },
        {
          url: '/_next/static/d-F-3jWCz7wF4HcEcc6lZ/_ssgManifest.js',
