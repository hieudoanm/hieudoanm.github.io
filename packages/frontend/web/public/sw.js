if (!self.define) {
  ...
  self.define = (t, i) => {
    ...
    e[c] = Promise.all(t.map((s) => r[s] || d(s))).then((s) => (i(...s), n));
  };
}
    ...
    s.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: 'mseQVFaWdqR-dHXq5TSl8',
        },
        {
        ...
        {
          url: '/_next/static/mseQVFaWdqR-dHXq5TSl8/_buildManifest.js',
          revision: '0a13ec666c7f92aa13ed512494879d4a',
        },
        {
          url: '/_next/static/mseQVFaWdqR-dHXq5TSl8/_ssgManifest.js',
