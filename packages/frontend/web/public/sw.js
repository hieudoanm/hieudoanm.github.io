if (!self.define) {
  ...
  self.define = (t, c) => {
    ...
    e[n] = Promise.all(t.map((s) => f[s] || r(s))).then((s) => (c(...s), i));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/D9LTcFRnxVwhmafjjtsFZ/_buildManifest.js',
          revision: '0a13ec666c7f92aa13ed512494879d4a',
        },
        {
          url: '/_next/static/D9LTcFRnxVwhmafjjtsFZ/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/1314-5582cba5ae032e4d.js',
          revision: 'D9LTcFRnxVwhmafjjtsFZ',
        },
        {
