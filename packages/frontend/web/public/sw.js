if (!self.define) {
  ...
  self.define = (t, i) => {
    ...
    s[c] = Promise.all(t.map((n) => g[n] || o(n))).then((n) => (i(...n), a));
  };
}
  ...
  importScripts(),
    ...
    n.precacheAndRoute(
      [
        ...
        {
          url: '/nothing/_next/static/YGnTc5du4OSSgQIKZ_-Bt/_buildManifest.js',
          revision: '6257ed3c4af95fdb14dddee0fadece11',
        },
        {
          url: '/nothing/_next/static/YGnTc5du4OSSgQIKZ_-Bt/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'YGnTc5du4OSSgQIKZ_-Bt',
        },
        {
        ...
        {
          url: '/nothing/_next/static/chunks/pages/_app-10eb807dde21a2bc.js',
          revision: 'YGnTc5du4OSSgQIKZ_-Bt',
        },
        {
        ...
        {
          url: '/nothing/_next/static/css/c0fa5b9f92cd2f08.css',
          revision: 'c0fa5b9f92cd2f08',
        },
        {
