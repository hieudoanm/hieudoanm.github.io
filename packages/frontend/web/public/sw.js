if (!self.define) {
  ...
  self.define = (a, i) => {
    ...
    let n = {};
    const l = (s) => t(s, c),
      r = { module: { uri: c }, exports: n, require: l };
    e[c] = Promise.all(a.map((s) => r[s] || l(s))).then((s) => (i(...s), n));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/E0P6ZhBzM-vPIt2zqllD_/_buildManifest.js',
          revision: 'd7064ac4f5b31c9924ee042fbaec00da',
        },
        {
          url: '/_next/static/E0P6ZhBzM-vPIt2zqllD_/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'E0P6ZhBzM-vPIt2zqllD_',
        },
        {
