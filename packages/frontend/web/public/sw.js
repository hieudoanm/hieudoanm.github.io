if (!self.define) {
  ...
  self.define = (n, t) => {
    ...
    e[i] = Promise.all(n.map((s) => o[s] || r(s))).then((s) => (t(...s), c));
  };
}
    ...
    s.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: 'nJAb1Ax1rKRq44QTFvJQa',
        },
        {
        ...
        {
          url: '/_next/static/nJAb1Ax1rKRq44QTFvJQa/_buildManifest.js',
          revision: 'cf5958b9ff84bdde6d41bafac097dd47',
        },
        {
          url: '/_next/static/nJAb1Ax1rKRq44QTFvJQa/_ssgManifest.js',
