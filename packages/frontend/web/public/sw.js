if (!self.define) {
  ...
  self.define = (i, a) => {
    ...
    let n = {};
    const p = (s) => c(s, t),
      r = { module: { uri: t }, exports: n, require: p };
    e[t] = Promise.all(i.map((s) => r[s] || p(s))).then((s) => (a(...s), n));
  };
}
    ...
    s.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: 'p1p1wcksdiO2q-45XzIcO',
        },
        {
        ...
        {
          url: '/_next/static/p1p1wcksdiO2q-45XzIcO/_buildManifest.js',
          revision: 'b70dff949e328c36d515000467fbaf60',
        },
        {
          url: '/_next/static/p1p1wcksdiO2q-45XzIcO/_ssgManifest.js',
