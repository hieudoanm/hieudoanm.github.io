if (!self.define) {
  ...
  self.define = (a, t) => {
    ...
    e[c] = Promise.all(a.map((s) => u[s] || r(s))).then((s) => (t(...s), n));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/4xhw2m22r5NG86hRTiwui/_buildManifest.js',
          revision: 'd7064ac4f5b31c9924ee042fbaec00da',
        },
        {
          url: '/_next/static/4xhw2m22r5NG86hRTiwui/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: '4xhw2m22r5NG86hRTiwui',
        },
        {
