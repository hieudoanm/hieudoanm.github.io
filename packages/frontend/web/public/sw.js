if (!self.define) {
  ...
  self.define = (n, a) => {
    ...
    c[t] = Promise.all(n.map((s) => o[s] || r(s))).then((s) => (a(...s), i));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/cFyL2b1knA2O_zcUYGEBc/_buildManifest.js',
          revision: '772768ef9c2c20ee36180103137e4d5e',
        },
        {
          url: '/_next/static/cFyL2b1knA2O_zcUYGEBc/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/1314-5582cba5ae032e4d.js',
          revision: 'cFyL2b1knA2O_zcUYGEBc',
        },
        {
