if (!self.define) {
  ...
  self.define = (a, t) => {
    ...
    e[c] = Promise.all(a.map((s) => o[s] || r(s))).then((s) => (t(...s), n));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/4U34OiX45WXi6DwGWAUZz/_buildManifest.js',
          revision: 'b70dff949e328c36d515000467fbaf60',
        },
        {
          url: '/_next/static/4U34OiX45WXi6DwGWAUZz/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: '4U34OiX45WXi6DwGWAUZz',
        },
        {
