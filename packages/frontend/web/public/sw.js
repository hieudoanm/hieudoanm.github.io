if (!self.define) {
  ...
  self.define = (a, t) => {
    ...
    let c = {};
    const n = (s) => r(s, i),
      E = { module: { uri: i }, exports: c, require: n };
    e[i] = Promise.all(a.map((s) => E[s] || n(s))).then((s) => (t(...s), c));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/EC0QrrXLEOJG11_M4jvEW/_buildManifest.js',
          revision: '75a57568e6c414542828b364b7e298f4',
        },
        {
          url: '/_next/static/EC0QrrXLEOJG11_M4jvEW/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/1314-5582cba5ae032e4d.js',
          revision: 'EC0QrrXLEOJG11_M4jvEW',
        },
        {
        ...
        {
          url: '/_next/static/chunks/b1c2b7dc-5761b8532c6c87a0.js',
          revision: 'EC0QrrXLEOJG11_M4jvEW',
        },
        {
        ...
        {
          url: '/_next/static/chunks/pages/apps/chess/books/chess960-327e888a1376075e.js',
          revision: 'EC0QrrXLEOJG11_M4jvEW',
        },
        {
          url: '/_next/static/chunks/pages/apps/chess/books/openings-952bb3f215304bfe.js',
          revision: 'EC0QrrXLEOJG11_M4jvEW',
        },
        {
          url: '/_next/static/chunks/pages/apps/chess/converter/fen2png-9d0d80d0f413bbb8.js',
          revision: 'EC0QrrXLEOJG11_M4jvEW',
        },
        {
          url: '/_next/static/chunks/pages/apps/chess/converter/pgn2gif-801813064e21d4bf.js',
          revision: 'EC0QrrXLEOJG11_M4jvEW',
        },
        {
