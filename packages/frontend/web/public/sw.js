if (!self.define) {
  ...
  self.define = (t, i) => {
    ...
    let n = {};
    const r = (s) => a(s, c),
      l = { module: { uri: c }, exports: n, require: r };
    e[c] = Promise.all(t.map((s) => l[s] || r(s))).then((s) => (i(...s), n));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/5arFVB4Qh6lyakS6KdXlY/_buildManifest.js',
          revision: '817f9a3c4c0cf4ccc686afd76ce9e852',
        },
        {
          url: '/_next/static/5arFVB4Qh6lyakS6KdXlY/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/1314-5582cba5ae032e4d.js',
          revision: '5arFVB4Qh6lyakS6KdXlY',
        },
        {
