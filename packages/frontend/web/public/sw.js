if (!self.define) {
  ...
  self.define = (c, a) => {
    ...
    e[t] = Promise.all(c.map((s) => o[s] || r(s))).then((s) => (a(...s), n));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/RMZm4bi7RCPPW257z9c-7/_buildManifest.js',
          revision: '7d5ed95f4eee2d6c383952f97d04cb14',
        },
        {
          url: '/_next/static/RMZm4bi7RCPPW257z9c-7/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'RMZm4bi7RCPPW257z9c-7',
        },
        {
