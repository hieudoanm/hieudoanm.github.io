if (!self.define) {
  ...
  self.define = (t, i) => {
    ...
    e[c] = Promise.all(t.map((s) => r[s] || f(s))).then((s) => (i(...s), n));
  };
}
  ...
  importScripts(),
    ...
    s.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/VVd6Ch7PUTfNgZh1FfJEK/_buildManifest.js',
          revision: 'bab8979de24ffdfb930afdf5c3b3f34d',
        },
        {
          url: '/_next/static/VVd6Ch7PUTfNgZh1FfJEK/_ssgManifest.js',
        ...
        },
        {
          ...
          revision: 'VVd6Ch7PUTfNgZh1FfJEK',
        },
        {
        ...
        {
          url: '/_next/static/chunks/pages/apps/chess/books/chess960-3fe7e3bbcffb1c97.js',
          revision: 'VVd6Ch7PUTfNgZh1FfJEK',
        },
        {
