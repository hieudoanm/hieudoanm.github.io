if (!self.define) {
  ...
  self.define = (a, t) => {
    ...
    e[c] = Promise.all(a.map((s) => d[s] || r(s))).then((s) => (t(...s), n));
  };
}
    ...
    s.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: 'yB_lp33WiYmKm3PrMKdLE',
        },
        {
        ...
        {
          url: '/_next/static/yB_lp33WiYmKm3PrMKdLE/_buildManifest.js',
          revision: 'd7064ac4f5b31c9924ee042fbaec00da',
        },
        {
          url: '/_next/static/yB_lp33WiYmKm3PrMKdLE/_ssgManifest.js',
