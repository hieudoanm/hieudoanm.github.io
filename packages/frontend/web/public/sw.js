if (!self.define) {
  ...
  self.define = (t, i) => {
    ...
    let n = {};
    const r = (s) => a(s, c),
      p = { module: { uri: c }, exports: n, require: r };
    e[c] = Promise.all(t.map((s) => p[s] || r(s))).then((s) => (i(...s), n));
  };
}
    ...
    s.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: 'r6YGXGZ5p1yQhSayjHRDL',
        },
        {
        ...
        {
          url: '/_next/static/r6YGXGZ5p1yQhSayjHRDL/_buildManifest.js',
          revision: '5be0dc3dc04a3af9733f927c935c6e05',
        },
        {
          url: '/_next/static/r6YGXGZ5p1yQhSayjHRDL/_ssgManifest.js',
