...
5. 📦 [manifest.json][manifest.json] - [GitHub][manifest.json-gh]
...
[manifest.json-gh]: https://github.com/hieudoanm/manifest.json
...
2. 🗂️ [Flashcards][flashcards] - [GitHub][flashcards-gh]
