...
func TestNewClipboardCmd_RunE(t *testing.T) {
	orig := runClipboardWatcherFn
	runClipboardWatcherFn = func() {}
	defer func() { runClipboardWatcherFn = orig }()
...
func TestNewClipboardCmd_Use(t *testing.T) {
	cmd := newClipboardCmd()
