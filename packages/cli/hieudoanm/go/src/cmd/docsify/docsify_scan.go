...
import (
	...
	"github.com/hieudoanm/hieudoanm/src/services/docsify"
)
...
var docsifyScanCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		// Walk the codebase
		files, err := docsify.Walk(absDir, excludeSet)
		if err != nil {
		...
		// Write GraphML
		if err := docsify.Write(graph, out); err != nil {
