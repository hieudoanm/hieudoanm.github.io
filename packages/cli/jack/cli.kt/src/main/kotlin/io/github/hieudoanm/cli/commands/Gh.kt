...
class GhLanguages : CliktCommand(name = "languages", help = "Show repository language breakdown") {
    ...
    override fun run() {
        ...
        val result = Requests.get(url, mapOf("Accept" to "application/json", "User-Agent" to "jack-cli"))
        if (result.isFailure) {
...
class GhLicenseCmd : CliktCommand(name = "license", help = "Fetch a license template from GitHub") {
    ...
    override fun run() {
        val result = Requests.get("https://api.github.com/licenses", mapOf("Accept" to "application/json", "User-Agent" to "jack-cli"))
        if (result.isFailure) {
        ...
        val detailResult = Requests.get(detailUrl, mapOf("Accept" to "application/json", "User-Agent" to "jack-cli"))
...
class GhCoc : CliktCommand(name = "coc", help = "Fetch a GitHub Code of Conduct") {
    ...
    override fun run() {
        val result = Requests.get("https://api.github.com/codes_of_conduct", mapOf("Accept" to "application/json", "User-Agent" to "jack-cli"))
        if (result.isFailure) {
...
class GhIgnore : CliktCommand(name = "ignore", help = "Fetch a .gitignore template from GitHub") {
    ...
    override fun run() {
        val result = Requests.get("https://api.github.com/gitignore/templates", mapOf("Accept" to "application/json", "User-Agent" to "jack-cli"))
        if (result.isFailure) {
...
class GhOg : CliktCommand(name = "og", help = "Generate an Open Graph SVG for a GitHub repository") {
    ...
    override fun run() {
        ...
        val result = Requests.get(apiUrl, mapOf("Accept" to "application/json", "User-Agent" to "jack-cli"))
        if (result.isFailure) {
