...
fn image_info_shows_metadata() {
    let path = "/tmp/jack_image_info_test.png";
...
#[test]
fn image_info_json() {
    let path = "/tmp/jack_image_info_json_test.png";
    create_test_png(path);
...
fn image_convert_to_png() {
    let src = "/tmp/jack_convert_src.png";
    let dst = "/tmp/jack_convert_dst.png";
    create_test_png(src);
...
fn image_dominant_shows_colors() {
    let path = "/tmp/jack_dominant_test.png";
    create_test_png(path);
...
fn image_dominant_json() {
    let path = "/tmp/jack_dominant_json_test.png";
    create_test_png(path);
