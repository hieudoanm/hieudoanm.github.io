...
import (
	...
	"github.com/hieudoanm/hieudoanm/src/services/openrouter"
...
func init() {
	aiStatusCmd.Flags().StringVarP(&statusSearch, "search", "s", "", "Filter models by name or ID before probing")
	aiStatusCmd.Flags().IntVarP(&statusWorkers, "workers", "w", 6, "Parallel probe workers")
