...
import (
	...
	"github.com/hieudoanm/hieudoanm/src/services/shopify"

	"github.com/spf13/cobra"
)

var shopifyDetectCmd = &cobra.Command{
	Use:   "detect [url]",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		isShopify, isPlus, signals, err := shopify.CheckShopify(url)
		if err != nil {
...
func init() {
	shopifyCmd.AddCommand(shopifyDetectCmd)

	shopifyDetectCmd.Flags().BoolVarP(
		&verbose,
		"verbose",
		"v",
		false,
