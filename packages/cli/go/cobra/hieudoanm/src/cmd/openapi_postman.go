...
var openapi2postmanCmd = &cobra.Command{
	Use:   "openapi2postman",
...
func init() {
	openapiCmd.AddCommand(openapi2postmanCmd)

	openapi2postmanCmd.Flags().StringVarP(&inputFile, "input", "i", "", "OpenAPI file (json/yaml)")
	openapi2postmanCmd.Flags().StringVarP(&outputFile, "output", "o", "", "Output Postman file")
}
