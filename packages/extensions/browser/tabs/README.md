...
- **New Tab redirect** — new-tab / home / private-browsing tabs are redirected
  to the hieudoanm home page (toggleable from the popup).
...
Load as an unpacked extension in Chrome/Edge/Firefox from `dist/v3` (or `dist/v2`).
