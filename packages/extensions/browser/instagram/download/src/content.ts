...
import { isInstagramCdn } from './lib/utils';
...
function processImage(img: HTMLImageElement): void {
  ...
  // Ensure the container is positioned so the overlay can anchor to it
...
// Watch for Instagram's SPA navigation adding new images
