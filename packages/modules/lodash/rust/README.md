...
| --- | ---------- | --------------------- | ---------------------- | ---------- |
| 1   | Array      | `_.chunk`             | `chunk`                |            |
| 2   | Array      | `_.compact`           | `compact`              |            |
| 3   | Array      | `_.concat`            | `concat`               |            |
| 4   | Array      | `_.difference`        | `difference`           |            |
| 5   | Array      | `_.differenceBy`      | `difference_by`        |            |
| 6   | Array      | `_.differenceWith`    | `difference_with`      |            |
| 7   | Array      | `_.drop`              | `drop`                 |            |
| 8   | Array      | `_.dropRight`         | `drop_right`           |            |
| 9   | Array      | `_.dropRightWhile`    | `drop_right_while`     |            |
| 10  | Array      | `_.dropWhile`         | `drop_while`           |            |
| 11  | Array      | `_.fill`              | `fill`                 |            |
| 12  | Array      | `_.findIndex`         | `find_index`           |            |
| 13  | Array      | `_.findLastIndex`     | `find_last_index`      |            |
...
| 18  | Array      | `_.head`              | `head`                 |            |
| 19  | Array      | `_.indexOf`           | `index_of`             |            |
| 20  | Array      | `_.initial`           | `initial`              |            |
| 21  | Array      | `_.intersection`      | `intersection`         |            |
| 22  | Array      | `_.intersectionBy`    | `intersection_by`      |            |
| 23  | Array      | `_.intersectionWith`  | `intersection_with`    |            |
| 24  | Array      | `_.join`              | `join`                 |            |
| 25  | Array      | `_.last`              | `last`                 |            |
| 26  | Array      | `_.lastIndexOf`       | `last_index_of`        |            |
| 27  | Array      | `_.nth`               | `nth`                  |            |
...
| 34  | Array      | `_.reverse`           | `reverse`              |            |
| 35  | Array      | `_.slice`             | `slice`                |            |
| 36  | Array      | `_.sortedIndex`       | `sorted_index`         |            |
| 37  | Array      | `_.sortedIndexBy`     | `sorted_index_by`      |            |
| 38  | Array      | `_.sortedIndexOf`     | `sorted_index_of`      |            |
| 39  | Array      | `_.sortedLastIndex`   | `sorted_last_index`    |            |
| 40  | Array      | `_.sortedLastIndexBy` | `sorted_last_index_by` |            |
| 41  | Array      | `_.sortedLastIndexOf` | `sorted_last_index_of` |            |
| 42  | Array      | `_.sortedUniq`        | `sorted_uniq`          |            |
| 43  | Array      | `_.sortedUniqBy`      | `sorted_uniq_by`       |            |
| 44  | Array      | `_.tail`              | `tail`                 |            |
| 45  | Array      | `_.take`              | `take`                 |            |
| 46  | Array      | `_.takeRight`         | `take_right`           |            |
| 47  | Array      | `_.takeRightWhile`    | `take_right_while`     |            |
| 48  | Array      | `_.takeWhile`         | `take_while`           |            |
| 49  | Array      | `_.union`             | `union`                |            |
| 50  | Array      | `_.unionBy`           | `union_by`             |            |
| 51  | Array      | `_.unionWith`         | `union_with`           |            |
| 52  | Array      | `_.uniq`              | `uniq`                 |            |
| 53  | Array      | `_.uniqBy`            | `uniq_by`              |            |
| 54  | Array      | `_.uniqWith`          | `uniq_with`            |            |
| 55  | Array      | `_.unzip`             | `unzip`                |            |
| 56  | Array      | `_.unzipWith`         | `unzip_with`           |            |
| 57  | Array      | `_.without`           | `without`              |            |
| 58  | Array      | `_.xor`               | `xor`                  |            |
| 59  | Array      | `_.xorBy`             | `xor_by`               |            |
| 60  | Array      | `_.xorWith`           | `xor_with`             |            |
| 61  | Array      | `_.zip`               | `zip`                  |            |
...
| 66  | Collection | `_.every`             | `every`                |            |
| 67  | Collection | `_.filter`            | `filter`               |            |
| 68  | Collection | `_.find`              | `find`                 |            |
| 69  | Collection | `_.findLast`          | `find_last`            |            |
| 70  | Collection | `_.flatMap`           | `flat_map`             |            |
| 71  | Collection | `_.flatMapDeep`       | `flat_map_deep`        |            |
| 72  | Collection | `_.flatMapDepth`      | `flat_map_depth`       |            |
| 73  | Collection | `_.forEach`           | `for_each`             |            |
| 74  | Collection | `_.forEachRight`      | `for_each_right`       |            |
| 75  | Collection | `_.groupBy`           | `group_by`             |            |
| 76  | Collection | `_.includes`          | `includes`             |            |
| 77  | Collection | `_.invokeMap`         | `invoke_map`           |            |
| 78  | Collection | `_.keyBy`             | `key_by`               |            |
| 79  | Collection | `_.map`               | `map`                  |            |
| 80  | Collection | `_.orderBy`           | `order_by`             |            |
| 81  | Collection | `_.partition`         | `partition`            |            |
| 82  | Collection | `_.reduce`            | `reduce`               |            |
| 83  | Collection | `_.reduceRight`       | `reduce_right`         |            |
| 84  | Collection | `_.reject`            | `reject`               |            |
| 85  | Collection | `_.sample`            | `sample`               |            |
| 86  | Collection | `_.sampleSize`        | `sample_size`          |            |
| 87  | Collection | `_.shuffle`           | `shuffle`              |            |
| 88  | Collection | `_.size`              | `size`                 |            |
| 89  | Collection | `_.some`              | `some`                 |            |
| 90  | Collection | `_.sortBy`            | `sort_by`              |            |
| 91  | Date       | `_.now`               | `now`                  | `now`      |
| 92  | Function   | `_.after`             | `after`                |            |
| 93  | Function   | `_.ary`               | `ary`                  |            |
| 94  | Function   | `_.before`            | `before`               |            |
| 95  | Function   | `_.bind`              |                        |            |
...
| 161 | Lang       | `_.lt`                | `lt`                   |            |
| 162 | Lang       | `_.lte`               | `lte`                  |            |
| 163 | Lang       | `_.toArray`           | `to_array`             |            |
| 164 | Lang       | `_.toFinite`          | `to_finite`            |            |
| 165 | Lang       | `_.toInteger`         | `to_integer`           |            |
| 166 | Lang       | `_.toLength`          | `to_length`            |            |
| 167 | Lang       | `_.toNumber`          | `to_number`            |            |
| 168 | Lang       | `_.toPlainObject`     | `to_plain_object`      |            |
| 169 | Lang       | `_.toSafeInteger`     | `to_safe_integer`      |            |
| 170 | Lang       | `_.toString`          | `to_string`            |            |
...
| 176 | Math       | `_.maxBy`             | `max_by`               | `max_by`   |
| 177 | Math       | `_.mean`              | `mean`                 | `mean`     |
| 178 | Math       | `_.meanBy`            | `mean_by`              | `mean_by`  |
| 179 | Math       | `_.min`               | `min`                  | `min`      |
| 180 | Math       | `_.minBy`             | `min_by`               | `min_by`   |
...
| 185 | Math       | `_.sumBy`             | `sum_by`               | `sum_by`   |
| 186 | Number     | `_.clamp`             | `clamp`                | `clamp`    |
| 187 | Number     | `_.inRange`           | `in_range`             | `in_range` |
...
| 230 | Object     | `_.values`            | `values`               |            |
| 231 | Object     | `_.valuesIn`          | `values_in`            |            |
| 232 | Seq        | `_.chain`             | `chain`                |            |
| 233 | Seq        | `_.tap`               | `tap`                  |            |
| 234 | Seq        | `_.thru`              | `thru`                 |            |
| 235 | String     | `_.camelCase`         | `camel_case`           |            |
| 236 | String     | `_.capitalize`        | `capitalize`           |            |
| 237 | String     | `_.deburr`            | `deburr`               |            |
| 238 | String     | `_.endsWith`          |                        |            |
| 239 | String     | `_.escape`            | `escape`               |            |
| 240 | String     | `_.escapeRegExp`      | `escape_regexp`        |            |
| 241 | String     | `_.kebabCase`         | `kebab_case`           |            |
| 242 | String     | `_.lowerCase`         | `lower_case`           |            |
| 243 | String     | `_.lowerFirst`        | `lower_first`          |            |
| 244 | String     | `_.pad`               | `pad`                  |            |
| 245 | String     | `_.padEnd`            | `pad_end`              |            |
| 246 | String     | `_.padStart`          | `pad_start`            |            |
| 247 | String     | `_.parseInt`          | `parse_int`            |            |
| 248 | String     | `_.repeat`            | `repeat`               |            |
| 249 | String     | `_.replace`           | `replace`              |            |
| 250 | String     | `_.snakeCase`         | `snake_case`           |            |
| 251 | String     | `_.split`             | `split`                |            |
| 252 | String     | `_.startCase`         | `start_case`           |            |
| 253 | String     | `_.startsWith`        |                        |            |
| 254 | String     | `_.template`          | `template`             |            |
| 255 | String     | `_.toLower`           | `to_lower`             |            |
| 256 | String     | `_.toUpper`           | `to_upper`             |            |
| 257 | String     | `_.trim`              |                        |            |
| 258 | String     | `_.trimEnd`           |                        |            |
| 259 | String     | `_.trimStart`         |                        |            |
| 260 | String     | `_.truncate`          | `truncate`             |            |
| 261 | String     | `_.unescape`          | `unescape`             |            |
| 262 | String     | `_.upperCase`         | `upper_case`           |            |
| 263 | String     | `_.upperFirst`        | `upper_first`          |            |
| 264 | String     | `_.words`             | `words`                |            |
| 265 | Util       | `_.attempt`           | `attempt`              |            |
| 266 | Util       | `_.bindAll`           |                        |            |
| 267 | Util       | `_.cond`              | `cond`                 |            |
| 268 | Util       | `_.conforms`          | `conforms`             |            |
| 269 | Util       | `_.constant`          | `constant`             |            |
| 270 | Util       | `_.defaultTo`         | `default_to`           |            |
| 271 | Util       | `_.flow`              | `flow`                 |            |
| 272 | Util       | `_.flowRight`         | `flow_right`           |            |
| 273 | Util       | `_.identity`          | `identity`             |            |
...
| 288 | Util       | `_.range`             | `range`                |            |
| 289 | Util       | `_.rangeRight`        | `range_right`          |            |
| 290 | Util       | `_.runInContext`      |                        |            |
| 291 | Util       | `_.stubArray`         | `stub_array`           |            |
| 292 | Util       | `_.stubFalse`         | `stub_false`           |            |
| 293 | Util       | `_.stubObject`        | `stub_object`          |            |
| 294 | Util       | `_.stubString`        | `stub_string`          |            |
| 295 | Util       | `_.stubTrue`          | `stub_true`            |            |
| 296 | Util       | `_.times`             | `times`                |            |
| 297 | Util       | `_.toPath`            | `to_path`              |            |
| 298 | Util       | `_.uniqueId`          | `unique_id`            |            |
