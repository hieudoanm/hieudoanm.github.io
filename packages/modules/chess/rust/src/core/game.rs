...
fn has_insufficient_material(board: &[Option<crate::types::Piece>; 64]) -> bool {
    let pieces: Vec<crate::types::Piece> = board.iter().filter_map(|&p| p).collect();
    ...
    if pieces.len() == 4 {
        let bishops: Vec<&crate::types::Piece> = pieces
            .iter()
...
fn update_castling_rights(
    ...
    mv: Move,
    board: &[Option<crate::types::Piece>; 64],
) -> CastlingRights {
