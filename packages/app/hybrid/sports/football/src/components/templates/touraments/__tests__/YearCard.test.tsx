...
const baseInfo: YearInfo = { year: 2014, host: 'Brazil', champion: 'Germany', runnerUp: 'Argentina', available: true };
...
describe('YearCard', () => {
  ...
  it('shows "Upcoming" when no champion but available', () => {
    const info: YearInfo = { year: 2026, host: 'US/Mexico/Canada', champion: null, runnerUp: null, available: true };
    render(<YearCard info={info} href="/wc/2026" />);
    expect(screen.getByText('Upcoming')).toBeInTheDocument();
  });

  it('does not show champion/runner-up when null', () => {
    const info: YearInfo = { year: 2026, host: 'US', champion: null, runnerUp: null, available: true };
    render(<YearCard info={info} href="/wc/2026" />);
  ...
  it('renders with available false', () => {
    const info: YearInfo = { year: 2030, host: 'TBD', champion: null, runnerUp: null, available: false };
