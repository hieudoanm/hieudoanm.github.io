...
describe('YearsTemplate', () => {
  it('renders world-cup years by default', () => {
    ...
    expect(screen.getAllByText('FIFA World Cup').length).toBeGreaterThanOrEqual(
      1
    );
    expect(
      screen.getByText(/Browse every edition of the FIFA World Cup/)
    ).toBeInTheDocument();
  });
  ...
  it('renders euro years', () => {
    ...
    expect(
      screen.getAllByText('UEFA European Championship').length
  ...
  it('renders copa-america years', () => {
    ...
    expect(
      screen.getAllByText('CONMEBOL Copa América').length
    ).toBeGreaterThanOrEqual(1);
  });
  ...
  it('renders afcon years', () => {
    ...
    expect(
      screen.getAllByText('Africa Cup of Nations').length
    ).toBeGreaterThanOrEqual(1);
  });

  it('renders afc years', () => {
    render(<YearsTemplate tournament="afc" />);
    expect(screen.getAllByText('AFC Asian Cup').length).toBeGreaterThanOrEqual(
      1
    );
  });
  ...
  it('renders concacaf years', () => {
    ...
    expect(
      screen.getAllByText('CONCACAF Gold Cup').length
    ).toBeGreaterThanOrEqual(1);
  });
  ...
  it('renders asean years', () => {
    ...
    expect(
      screen.getAllByText('ASEAN Championship').length
    ).toBeGreaterThanOrEqual(1);
  });
  ...
  it('renders premier-league years', () => {
    ...
    expect(
      screen.getAllByText('English Premier League').length
    ).toBeGreaterThanOrEqual(1);
  });
  ...
  it('renders la-liga years', () => {
    ...
    expect(
      screen.getAllByText('Spanish La Liga').length
    ).toBeGreaterThanOrEqual(1);
  });
  ...
  it('renders bundesliga years', () => {
    ...
    expect(
      screen.getAllByText('German Bundesliga').length
    ).toBeGreaterThanOrEqual(1);
  });
  ...
  it('renders champions-league years', () => {
    ...
    expect(
      screen.getAllByText('UEFA Champions League').length
    ).toBeGreaterThanOrEqual(1);
  });
