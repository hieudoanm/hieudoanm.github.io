...
const getInitialTheme = (): string => {
  if (typeof window === 'undefined') return 'chess-light';
  return localStorage.getItem(STORAGE_KEY) || 'chess-light';
};
...
export const Header: FC = () => {
  ...
  const toggleTheme = () =>
    setTheme((current) =>
      current === 'chess-light' ? 'chess-dark' : 'chess-light'
    );
