...
const getInitialTheme = (): string => {
  if (typeof window === 'undefined') return 'chat-light';
  return localStorage.getItem(STORAGE_KEY) || 'chat-light';
};
...
export const Header: FC = () => {
  ...
  const toggleTheme = () =>
    setTheme((current) =>
      current === 'chat-light' ? 'chat-dark' : 'chat-light'
    );
