# Chat — Packaging Checklist

Checklist for shipping Chat to users: macOS notarization, Windows code-signing,
Android/iOS store builds, and the Tauri updater pipeline.

App: `chat` (bundle identifier `io.github.hieudoanm.chat`, version 0.0.1).
...
- [ ] Endpoint to publish to:
      `https://github.com/hieudoanm/hieudoanm.github.io/releases/download/app-hybrid-chat-latest/latest.json`
...
- [ ] Signing team + provisioning profile set for the `chat` Xcode project under
      `src-tauri/gen/apple/`
