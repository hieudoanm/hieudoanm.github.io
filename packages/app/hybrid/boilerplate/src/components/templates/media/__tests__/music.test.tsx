...
import { AlbumDetailTemplate } from '../../media/AlbumDetailTemplate';
import { ArtistsTemplate } from '../../media/ArtistsTemplate';
import { ChartsTemplate } from '../../media/ChartsTemplate';
import { LyricsTemplate } from '../../media/LyricsTemplate';
import { MusicHomeTemplate } from '../../media/MusicHomeTemplate';
import { MusicSearchTemplate } from '../../media/MusicSearchTemplate';
import { NowPlayingTemplate } from '../../media/NowPlayingTemplate';
import { PlaylistTemplate } from '../../media/PlaylistTemplate';
