...
│   │   │   └── prisoners-dilemma/
│   │   │       ├── __tests__/
│   │   │       │   └── [page.test.tsx](./src/app/(games)/prisoners-dilemma/__tests__/page.test.tsx)
│   │   │       └── [page.tsx](./src/app/(games)/prisoners-dilemma/page.tsx)
│   │   ├── (info)/
│   │   │   ├── about/
│   │   │   │   ├── __tests__/
...
│   │   └── prisoners-dilemma/
│   │       ├── __tests__/
│   │       │   ├── [game.test.ts](./src/games/prisoners-dilemma/__tests__/game.test.ts)
│   │       │   └── [index.test.tsx](./src/games/prisoners-dilemma/__tests__/index.test.tsx)
│   │       ├── utils/
│   │       │   └── [game.ts](./src/games/prisoners-dilemma/utils/game.ts)
│   │       ├── [constants.ts](./src/games/prisoners-dilemma/constants.ts)
│   │       ├── [index.tsx](./src/games/prisoners-dilemma/index.tsx)
│   │       └── [types.ts](./src/games/prisoners-dilemma/types.ts)
│   ├── hooks/
│   │   ├── __tests__/
