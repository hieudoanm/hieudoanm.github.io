...
const getInitialTheme = (): string => {
  if (typeof window === 'undefined') return 'lingo-light';
  return localStorage.getItem(STORAGE_KEY) || 'lingo-light';
};
...
export const Header: FC = () => {
  ...
  const toggleTheme = () =>
    setTheme((current) =>
      current === 'lingo-light' ? 'lingo-dark' : 'lingo-light'
    );
