...
export const Wordle: FC<WordleProps> = ({ initialAnswer }) => {
  ...
  return (
    <div className="flex flex-col items-center gap-4 p-4">
      <div className="flex w-full items-center justify-between sm:w-2/3 md:w-1/2">
      ...
      <div
        className="grid w-full gap-1 sm:w-2/3 md:w-1/2"
      ...
      <div className="flex w-full flex-col items-center gap-1 sm:w-2/3 md:w-1/2">
