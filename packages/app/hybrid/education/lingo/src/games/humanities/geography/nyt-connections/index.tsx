...
export const Connections: FC<ConnectionsProps> = ({ dateKey }) => {
  ...
  return (
    <div className="flex flex-col items-center gap-4 p-4">
      <div className="flex w-full items-center justify-between sm:w-3/4 lg:w-2/3">
      ...
      <div
        className="flex w-full flex-col gap-2 sm:w-3/4 lg:w-2/3"
      ...
      <div
        className="grid w-full grid-cols-4 gap-1.5 sm:w-3/4 sm:gap-2 lg:w-2/3"
