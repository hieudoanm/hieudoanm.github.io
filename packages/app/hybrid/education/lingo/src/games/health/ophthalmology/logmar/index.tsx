...
import { LogMARChartLine, generateChart } from './utils';

export const LogMARChart: FC = () => {
  const [chart] = useState<LogMARChartLine[]>(generateChart);
...
LogMARChart.displayName = 'LogMARChart';
