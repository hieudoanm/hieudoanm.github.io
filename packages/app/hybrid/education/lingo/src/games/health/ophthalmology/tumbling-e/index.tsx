...
import { TumblingEChartLine, generateChart } from './utils';

export const TumblingEChart: FC = () => {
  const [chart] = useState<TumblingEChartLine[]>(generateChart);
        ...
        {line.count === 1 && !revealed && (
          <div className="flex flex-col items-center gap-3">
            ...
            <div className="grid w-32 grid-cols-3 gap-2">
              ...
              <div />
              <button
                onClick={() => setAnswers((a) => ({ ...a, [current]: 'left' }))}
              ...
              <div />
              <button
                onClick={() => setAnswers((a) => ({ ...a, [current]: 'down' }))}
...
TumblingEChart.displayName = 'TumblingEChart';
