...
import { mixColors, parseColor } from '../colors';
import { useClipboard } from '../shared/useClipboard';
import { CopyRow } from '../shared/CopyRow';
import { TheoryNote } from '../shared/TheoryNote';
  ...
  return (
    <div data-testid="color-mixer" className="flex flex-col gap-5">
      ...
      <TheoryNote title="Color Mixing">
        Mixing on screen is additive: the result averages the two colors&apos;
        RGB channels, weighted by the mix percentage, so at 50% the output is
