  ...
  return (
    <div data-testid="opacity-overlay" className="flex flex-col gap-6">
      ...
      <TheoryNote title="Opacity and Alpha Compositing">
        ...
        channel as <code>result = fg x alpha + bg x (1 - alpha)</code>. Lowering
        opacity never reveals a background by itself — it blends the color with
