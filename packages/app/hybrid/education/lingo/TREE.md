...
│   │   ├── (app)/
│   │   │   ├── english/
│   │   │   │   └── [page.tsx](./src/app/(app)/english/page.tsx)
│   │   │   ├── flashcards/
│   │   │   │   ├── __tests__/
│   │   │   │   │   └── [page.test.tsx](./src/app/(app)/flashcards/__tests__/page.test.tsx)
│   │   │   │   └── [page.tsx](./src/app/(app)/flashcards/page.tsx)
│   │   │   └── sign/
│   │   │       └── [page.tsx](./src/app/(app)/sign/page.tsx)
│   │   ├── (auth)/
│   │   │   ├── forget-password/
│   │   │   │   ├── __tests__/
...
│   │   │   ├── english/
│   │   │   │   ├── __tests__/
│   │   │   │   │   ├── [index.test.tsx](./src/components/features/english/__tests__/index.test.tsx)
│   │   │   │   │   └── [utils.test.ts](./src/components/features/english/__tests__/utils.test.ts)
│   │   │   │   ├── [index.tsx](./src/components/features/english/index.tsx)
│   │   │   │   └── [utils.ts](./src/components/features/english/utils.ts)
│   │   │   ├── flashcards/
│   │   │   │   ├── __tests__/
│   │   │   │   │   ├── [index.test.tsx](./src/components/features/flashcards/__tests__/index.test.tsx)
│   │   │   │   │   └── [utils.test.ts](./src/components/features/flashcards/__tests__/utils.test.ts)
│   │   │   │   ├── [index.tsx](./src/components/features/flashcards/index.tsx)
│   │   │   │   └── [utils.ts](./src/components/features/flashcards/utils.ts)
│   │   │   └── sign/
│   │   │       ├── __tests__/
│   │   │       │   ├── [index.test.tsx](./src/components/features/sign/__tests__/index.test.tsx)
│   │   │       │   └── [utils.test.ts](./src/components/features/sign/__tests__/utils.test.ts)
│   │   │       ├── [index.tsx](./src/components/features/sign/index.tsx)
│   │   │       └── [utils.ts](./src/components/features/sign/utils.ts)
│   │   └── templates/
│   │       ├── __tests__/
