...
│   │   ├── pitch/
│   │   │   ├── __tests__/
│   │   │   │   └── [page.test.tsx](./src/app/pitch/__tests__/page.test.tsx)
│   │   │   └── [page.tsx](./src/app/pitch/page.tsx)
...
│   │   │   └── pitch/
│   │   │       ├── __tests__/
│   │   │       │   ├── [index.test.tsx](./src/components/features/pitch/__tests__/index.test.tsx)
│   │   │       │   ├── [keyClasses.test.ts](./src/components/features/pitch/__tests__/keyClasses.test.ts)
│   │   │       │   ├── [useAudio.test.ts](./src/components/features/pitch/__tests__/useAudio.test.ts)
│   │   │       │   ├── [useGame.test.ts](./src/components/features/pitch/__tests__/useGame.test.ts)
│   │   │       │   └── [useSequence.test.ts](./src/components/features/pitch/__tests__/useSequence.test.ts)
│   │   │       ├── [constants.ts](./src/components/features/pitch/constants.ts)
│   │   │       ├── [index.tsx](./src/components/features/pitch/index.tsx)
│   │   │       ├── [keyClasses.ts](./src/components/features/pitch/keyClasses.ts)
│   │   │       ├── [useAudio.ts](./src/components/features/pitch/useAudio.ts)
│   │   │       ├── [useGame.ts](./src/components/features/pitch/useGame.ts)
│   │   │       ├── [usePitchGame.ts](./src/components/features/pitch/usePitchGame.ts)
│   │   │       └── [useSequence.ts](./src/components/features/pitch/useSequence.ts)
│   │   └── templates/
│   │       ├── __tests__/
