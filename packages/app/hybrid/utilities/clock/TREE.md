...
│   │   ├── molecules/
│   │   │   ├── __tests__/
│   │   │   │   ├── [CityCard.test.tsx](./src/components/molecules/__tests__/CityCard.test.tsx)
│   │   │   │   └── [WeatherBadge.test.tsx](./src/components/molecules/__tests__/WeatherBadge.test.tsx)
│   │   │   ├── [CityCard.tsx](./src/components/molecules/CityCard.tsx)
│   │   │   └── [WeatherBadge.tsx](./src/components/molecules/WeatherBadge.tsx)
│   │   ├── organisms/
│   │   │   ├── __tests__/
│   │   │   │   ├── [ClockTab.test.tsx](./src/components/organisms/__tests__/ClockTab.test.tsx)
│   │   │   │   ├── [Header.test.tsx](./src/components/organisms/__tests__/Header.test.tsx)
│   │   │   │   ├── [Pomodoro.test.tsx](./src/components/organisms/__tests__/Pomodoro.test.tsx)
│   │   │   │   ├── [Stopwatch.test.tsx](./src/components/organisms/__tests__/Stopwatch.test.tsx)
│   │   │   │   ├── [Timer.test.tsx](./src/components/organisms/__tests__/Timer.test.tsx)
│   │   │   │   ├── [Watchface.test.tsx](./src/components/organisms/__tests__/Watchface.test.tsx)
│   │   │   │   ├── [WorldClock.test.tsx](./src/components/organisms/__tests__/WorldClock.test.tsx)
│   │   │   │   ├── [pomodoro-utils.test.ts](./src/components/organisms/__tests__/pomodoro-utils.test.ts)
│   │   │   │   ├── [stopwatch-utils.test.ts](./src/components/organisms/__tests__/stopwatch-utils.test.ts)
│   │   │   │   └── [timer-utils.test.ts](./src/components/organisms/__tests__/timer-utils.test.ts)
│   │   │   ├── [ClockTab.tsx](./src/components/organisms/ClockTab.tsx)
│   │   │   ├── [Header.tsx](./src/components/organisms/Header.tsx)
│   │   │   ├── [Pomodoro.tsx](./src/components/organisms/Pomodoro.tsx)
│   │   │   ├── [Stopwatch.tsx](./src/components/organisms/Stopwatch.tsx)
│   │   │   ├── [Timer.tsx](./src/components/organisms/Timer.tsx)
│   │   │   ├── [WatchFaces.tsx](./src/components/organisms/WatchFaces.tsx)
│   │   │   └── [WorldClock.tsx](./src/components/organisms/WorldClock.tsx)
│   │   └── templates/
│   │       ├── __tests__/
│   │       │   ├── [AboutTemplate.test.tsx](./src/components/templates/__tests__/AboutTemplate.test.tsx)
│   │       │   ├── [ClockApp.test.tsx](./src/components/templates/__tests__/ClockApp.test.tsx)
...
│   │       ├── [ClockApp.tsx](./src/components/templates/ClockApp.tsx)
...
│   │   │   ├── [timezones.test.ts](./src/data/__tests__/timezones.test.ts)
│   │   │   └── [weather.test.ts](./src/data/__tests__/weather.test.ts)
...
│   │   ├── [stopwatch.ts](./src/lib/stopwatch.ts)
│   │   └── [timer.ts](./src/lib/timer.ts)
│   ├── providers/
│   │   ├── __tests__/
│   │   │   └── [TanStackQueryClientProvider.test.tsx](./src/providers/__tests__/TanStackQueryClientProvider.test.tsx)
│   │   └── [TanStackQueryClientProvider.tsx](./src/providers/TanStackQueryClientProvider.tsx)
│   └── styles/
