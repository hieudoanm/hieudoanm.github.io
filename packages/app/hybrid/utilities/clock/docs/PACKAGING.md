# Clock — Packaging Checklist

Checklist for shipping Clock to users: macOS notarization, Windows code-signing,
Android/iOS store builds, and the Tauri updater pipeline.

App: `clock` (bundle identifier `io.github.hieudoanm.clock`, version 0.0.1).
...
- [ ] Endpoint to publish to:
      `https://github.com/hieudoanm/hieudoanm.github.io/releases/download/app-hybrid-utilities-clock-latest/latest.json`
...
- [ ] Signing team + provisioning profile set for the `clock` Xcode project
