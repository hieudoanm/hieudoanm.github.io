...
Thanks for contributing to **Hieu Doan**, a hybrid app that ships as a web app
...
3. **Run this app**:
   ...
   ```bash
   pnpm dev --filter=@hieudoanm.github.io/app
   ```
...
| Task       | Command                                           |
| ---------- | ------------------------------------------------- |
| Dev server | `pnpm dev --filter=@hieudoanm.github.io/app`      |
| Build      | `pnpm build --filter=@hieudoanm.github.io/app`    |
| Lint       | `pnpm lint --filter=@hieudoanm.github.io/app`     |
| Format     | `pnpm format --filter=@hieudoanm.github.io/app`   |
| Unit tests | `pnpm test --filter=@hieudoanm.github.io/app`     |
| E2E tests  | `pnpm test:e2e --filter=@hieudoanm.github.io/app` |
...
- `organisms/` — complex sections (Header, Sidebar, AppCard)
...
1. `pnpm lint --filter=@hieudoanm.github.io/app`
2. `pnpm format --filter=@hieudoanm.github.io/app`
3. `pnpm test --filter=@hieudoanm.github.io/app`
4. `pnpm test:e2e --filter=@hieudoanm.github.io/app`
5. `pnpm build --filter=@hieudoanm.github.io/app`
