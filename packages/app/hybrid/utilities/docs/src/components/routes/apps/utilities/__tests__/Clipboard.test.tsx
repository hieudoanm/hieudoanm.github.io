...
jest.mock('../Clipboard/useClipboard', () => ({
  useClipboard: jest.fn(),
}));

const { useClipboard } = jest.requireMock('../Clipboard/useClipboard');
...
describe('Clipboard', () => {
  ...
  it('renders Capture button', () => {
    render(<Clipboard onClose={onClose} />);
  ...
  it('copies from preview and goes back', () => {
    ...
    const { unmount } = render(<Clipboard onClose={onClose} />);
