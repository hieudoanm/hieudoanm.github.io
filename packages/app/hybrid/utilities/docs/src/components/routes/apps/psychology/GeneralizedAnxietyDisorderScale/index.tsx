...
export const GeneralizedAnxietyDisorderScale: FC<{ onClose: () => void }> = ({
  onClose,
}) => {
...
GeneralizedAnxietyDisorderScale.displayName = 'GeneralizedAnxietyDisorderScale';
