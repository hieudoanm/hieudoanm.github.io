...
Thanks for contributing to **Wallet**, a hybrid app that ships as a web app
...
3. **Run this app**:
   ...
   ```bash
   pnpm dev --filter=@hieudoanm.github.io/wallet
   ```
...
| Task       | Command                                              |
| ---------- | ---------------------------------------------------- |
| Dev server | `pnpm dev --filter=@hieudoanm.github.io/wallet`      |
| Build      | `pnpm build --filter=@hieudoanm.github.io/wallet`    |
| Lint       | `pnpm lint --filter=@hieudoanm.github.io/wallet`     |
| Format     | `pnpm format --filter=@hieudoanm.github.io/wallet`   |
| Unit tests | `pnpm test --filter=@hieudoanm.github.io/wallet`     |
| E2E tests  | `pnpm test:e2e --filter=@hieudoanm.github.io/wallet` |
...
- `organisms/` — complex sections (Header, Sidebar, TransactionList)
- `templates/` — page-level layouts (HomeTemplate, SettingsTemplate)
...
1. `pnpm lint --filter=@hieudoanm.github.io/wallet`
2. `pnpm format --filter=@hieudoanm.github.io/wallet`
3. `pnpm test --filter=@hieudoanm.github.io/wallet`
4. `pnpm test:e2e --filter=@hieudoanm.github.io/wallet`
5. `pnpm build --filter=@hieudoanm.github.io/wallet`
