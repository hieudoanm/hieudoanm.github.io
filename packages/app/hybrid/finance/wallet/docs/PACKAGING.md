# Wallet — Packaging Checklist

Checklist for shipping Wallet to users: macOS notarization, Windows
code-signing, Android/iOS store builds, and the Tauri updater pipeline.

App: `wallet` (bundle identifier `io.github.hieudoanm.wallet`, version 0.0.1).
...
- [ ] Endpoint to publish to:
      `https://github.com/hieudoanm/hieudoanm.github.io/releases/download/app-hybrid-wallet-latest/latest.json`
...
- [ ] Signing team + provisioning profile set for the `wallet` Xcode project
