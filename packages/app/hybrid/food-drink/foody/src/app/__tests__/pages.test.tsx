...
import RandomizerPage from '@/app/randomizer/page';
...
describe('Tool pages', () => {
  it('Tool page renders the randomizer feature', () => {
    render(
      <Wrapper>
        <RandomizerPage />
      </Wrapper>
...
describe('Info pages', () => {
  ...
  it('downloads page lists installers', () => {
    ...
    expect(screen.getByRole('link', { name: 'Download .dmg' })).toHaveAttribute(
      'href',
      expect.stringContaining('foody_aarch64.dmg')
    );
  });
