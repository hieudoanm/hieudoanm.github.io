...
Thanks for contributing to **Boilerplate**, a hybrid app that ships as a web app
...
3. **Run this app**:
   ...
   ```bash
   pnpm dev --filter=@hieudoanm.github.io/next
   ```
...
| Task       | Command                                            |
| ---------- | -------------------------------------------------- |
| Dev server | `pnpm dev --filter=@hieudoanm.github.io/next`      |
| Build      | `pnpm build --filter=@hieudoanm.github.io/next`    |
| Lint       | `pnpm lint --filter=@hieudoanm.github.io/next`     |
| Format     | `pnpm format --filter=@hieudoanm.github.io/next`   |
| Unit tests | `pnpm test --filter=@hieudoanm.github.io/next`     |
| E2E tests  | `pnpm test:e2e --filter=@hieudoanm.github.io/next` |
...
- `organisms/` — complex sections (Header, Navbar)
...
1. `pnpm lint --filter=@hieudoanm.github.io/next`
2. `pnpm format --filter=@hieudoanm.github.io/next`
3. `pnpm test --filter=@hieudoanm.github.io/next`
4. `pnpm test:e2e --filter=@hieudoanm.github.io/next`
5. `pnpm build --filter=@hieudoanm.github.io/next`
