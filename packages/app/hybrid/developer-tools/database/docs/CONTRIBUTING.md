...
Thanks for contributing to **Database**, a hybrid app that ships as a web app
...
3. **Run this app**:
   ...
   ```bash
   pnpm dev --filter=@hieudoanm.github.io/database
   ```
...
| Task       | Command                                                |
| ---------- | ------------------------------------------------------ |
| Dev server | `pnpm dev --filter=@hieudoanm.github.io/database`      |
| Build      | `pnpm build --filter=@hieudoanm.github.io/database`    |
| Lint       | `pnpm lint --filter=@hieudoanm.github.io/database`     |
| Format     | `pnpm format --filter=@hieudoanm.github.io/database`   |
| Unit tests | `pnpm test --filter=@hieudoanm.github.io/database`     |
| E2E tests  | `pnpm test:e2e --filter=@hieudoanm.github.io/database` |
...
- `organisms/` — complex sections (Header, Sidebar, TableGrid)
- `templates/` — page-level layouts (SchemaTemplate, SettingsTemplate)
...
1. `pnpm lint --filter=@hieudoanm.github.io/database`
2. `pnpm format --filter=@hieudoanm.github.io/database`
3. `pnpm test --filter=@hieudoanm.github.io/database`
4. `pnpm test:e2e --filter=@hieudoanm.github.io/database`
5. `pnpm build --filter=@hieudoanm.github.io/database`
