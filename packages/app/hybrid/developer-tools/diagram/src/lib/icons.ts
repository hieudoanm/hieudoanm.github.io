...
export const GLYPH_PATTERN = /^[A-Za-z0-9.,+\- ]+$/;

export const ICON_BODY: Record<IconName, string> = {
  alert:
    '<polygon points="10.29 3.86 1.82 18 22.18 18 13.71 3.86 12 1 10.29 3.86"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/>',
  archive:
  ...
  cache: '<polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/>',
  camera:
