# Diagram — Minimal Diagram Editor
...
| `docs/DIAGRAMS.md`     | Diagram-type tour with copy-paste DSL examples               |
| `docs/SYNTAX.md`       | Full DSL language reference — title, nodes, edges, subgraphs |
...
- DSL is parsed line by line in pure functions — no DOM types in parsers; every
  non-empty line must match a syntax form or it is a parse error
