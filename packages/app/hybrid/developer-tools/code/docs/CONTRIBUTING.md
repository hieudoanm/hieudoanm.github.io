...
Thanks for contributing to **Code**, a hybrid app that ships as a web app
...
3. **Run this app**:
   ...
   ```bash
   pnpm dev --filter=@hieudoanm.github.io/code
   ```
...
| Task       | Command                                            |
| ---------- | -------------------------------------------------- |
| Dev server | `pnpm dev --filter=@hieudoanm.github.io/code`      |
| Build      | `pnpm build --filter=@hieudoanm.github.io/code`    |
| Lint       | `pnpm lint --filter=@hieudoanm.github.io/code`     |
| Format     | `pnpm format --filter=@hieudoanm.github.io/code`   |
| Unit tests | `pnpm test --filter=@hieudoanm.github.io/code`     |
| E2E tests  | `pnpm test:e2e --filter=@hieudoanm.github.io/code` |
...
- `organisms/` — complex sections (Header, Sidebar, EditorPane)
...
1. `pnpm lint --filter=@hieudoanm.github.io/code`
2. `pnpm format --filter=@hieudoanm.github.io/code`
3. `pnpm test --filter=@hieudoanm.github.io/code`
4. `pnpm test:e2e --filter=@hieudoanm.github.io/code`
5. `pnpm build --filter=@hieudoanm.github.io/code`
