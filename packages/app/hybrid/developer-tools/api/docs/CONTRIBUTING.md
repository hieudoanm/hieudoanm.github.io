...
Thanks for contributing to **API Client**, a hybrid app that ships as a web app
...
3. **Run this app**:
   ...
   ```bash
   pnpm dev --filter=@hieudoanm.github.io/api
   ```
...
| Task       | Command                                           |
| ---------- | ------------------------------------------------- |
| Dev server | `pnpm dev --filter=@hieudoanm.github.io/api`      |
| Build      | `pnpm build --filter=@hieudoanm.github.io/api`    |
| Lint       | `pnpm lint --filter=@hieudoanm.github.io/api`     |
| Format     | `pnpm format --filter=@hieudoanm.github.io/api`   |
| Unit tests | `pnpm test --filter=@hieudoanm.github.io/api`     |
| E2E tests  | `pnpm test:e2e --filter=@hieudoanm.github.io/api` |
...
- `organisms/` — complex sections (Header, Sidebar, ResponsePanel)
- `templates/` — page-level layouts (AboutTemplate, SettingsTemplate)
...
1. `pnpm lint --filter=@hieudoanm.github.io/api`
2. `pnpm format --filter=@hieudoanm.github.io/api`
3. `pnpm test --filter=@hieudoanm.github.io/api`
4. `pnpm test:e2e --filter=@hieudoanm.github.io/api`
5. `pnpm build --filter=@hieudoanm.github.io/api`
