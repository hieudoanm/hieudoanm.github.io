...
const STORAGE_KEY = 'api-theme';

const getInitialTheme = (): string => {
  if (typeof window === 'undefined') return 'api-light';
  return localStorage.getItem(STORAGE_KEY) || 'api-light';
};
...
export const Header: FC = () => {
  ...
  const toggleTheme = () =>
    setTheme((current) => (current === 'api-light' ? 'api-dark' : 'api-light'));
