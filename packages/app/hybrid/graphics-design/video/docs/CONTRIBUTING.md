...
Thanks for contributing to **Video**, a hybrid app that ships as a web app
...
3. **Run this app**:
   ...
   ```bash
   pnpm dev --filter=@hieudoanm.github.io/video
   ```
...
| Task       | Command                                             |
| ---------- | --------------------------------------------------- |
| Dev server | `pnpm dev --filter=@hieudoanm.github.io/video`      |
| Build      | `pnpm build --filter=@hieudoanm.github.io/video`    |
| Lint       | `pnpm lint --filter=@hieudoanm.github.io/video`     |
| Format     | `pnpm format --filter=@hieudoanm.github.io/video`   |
| Unit tests | `pnpm test --filter=@hieudoanm.github.io/video`     |
| E2E tests  | `pnpm test:e2e --filter=@hieudoanm.github.io/video` |
...
- `organisms/` — complex sections (Header, Sidebar, Player)
- `templates/` — page-level layouts (WatchTemplate, SettingsTemplate)
...
1. `pnpm lint --filter=@hieudoanm.github.io/video`
2. `pnpm format --filter=@hieudoanm.github.io/video`
3. `pnpm test --filter=@hieudoanm.github.io/video`
4. `pnpm test:e2e --filter=@hieudoanm.github.io/video`
5. `pnpm build --filter=@hieudoanm.github.io/video`
