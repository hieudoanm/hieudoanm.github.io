# Video — Packaging Checklist

Checklist for shipping Video to users: macOS notarization, Windows code-signing,
Android/iOS store builds, and the Tauri updater pipeline.

App: `video` (bundle identifier `io.github.hieudoanm.video`, version 0.0.1).
...
- [ ] Endpoint to publish to:
      `https://github.com/hieudoanm/hieudoanm.github.io/releases/download/app-hybrid-video-latest/latest.json`
...
- [ ] Signing team + provisioning profile set for the `video` Xcode project
