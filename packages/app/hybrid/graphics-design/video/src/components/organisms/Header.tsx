...
const STORAGE_KEY = 'video-theme';

const getInitialTheme = (): string => {
  if (typeof window === 'undefined') return 'video-light';
  return localStorage.getItem(STORAGE_KEY) || 'video-light';
};
...
export const Header: FC = () => {
  ...
  const toggleTheme = () =>
    setTheme((current) =>
      current === 'video-light' ? 'video-dark' : 'video-light'
    );
