...
Thanks for contributing to **SVG**, a hybrid app that ships as a web app
...
3. **Run this app**:
   ...
   ```bash
   pnpm dev --filter=@hieudoanm.github.io/svg
   ```
...
| Task       | Command                                           |
| ---------- | ------------------------------------------------- |
| Dev server | `pnpm dev --filter=@hieudoanm.github.io/svg`      |
| Build      | `pnpm build --filter=@hieudoanm.github.io/svg`    |
| Lint       | `pnpm lint --filter=@hieudoanm.github.io/svg`     |
| Format     | `pnpm format --filter=@hieudoanm.github.io/svg`   |
| Unit tests | `pnpm test --filter=@hieudoanm.github.io/svg`     |
| E2E tests  | `pnpm test:e2e --filter=@hieudoanm.github.io/svg` |
...
- `organisms/` — complex sections (Header, Sidebar, Canvas)
...
1. `pnpm lint --filter=@hieudoanm.github.io/svg`
2. `pnpm format --filter=@hieudoanm.github.io/svg`
3. `pnpm test --filter=@hieudoanm.github.io/svg`
4. `pnpm test:e2e --filter=@hieudoanm.github.io/svg`
5. `pnpm build --filter=@hieudoanm.github.io/svg`
