...
│   ├── [canvas-editor.spec.ts](./e2e/canvas-editor.spec.ts)
│   ├── [code-editor.spec.ts](./e2e/code-editor.spec.ts)
...
│   │   ├── edit/
│   │   │   ├── code/
│   │   │   │   └── [page.tsx](./src/app/edit/code/page.tsx)
...
│   ├── components/
│   │   ├── atoms/
│   │   │   └── [FileDropzone.tsx](./src/components/atoms/FileDropzone.tsx)
│   │   ├── organisms/
│   │   │   ├── __tests__/
│   │   │   │   ├── [IconGenerator.test.tsx](./src/components/organisms/__tests__/IconGenerator.test.tsx)
│   │   │   │   └── [IconWorkbench.test.tsx](./src/components/organisms/__tests__/IconWorkbench.test.tsx)
│   │   │   ├── [IconGenerator.tsx](./src/components/organisms/IconGenerator.tsx)
│   │   │   ├── [IconWorkbench.tsx](./src/components/organisms/IconWorkbench.tsx)
...
│   ├── data/
│   │   ├── [iconPresets.ts](./src/data/iconPresets.ts)
...
│   └── utils/
│       ├── __tests__/
│       │   ├── [iconGenerator.test.ts](./src/utils/__tests__/iconGenerator.test.ts)
│       │   └── [svgToCanvas.test.ts](./src/utils/__tests__/svgToCanvas.test.ts)
│       ├── [format.ts](./src/utils/format.ts)
│       ├── [iconGenerator.ts](./src/utils/iconGenerator.ts)
│       └── [svgToCanvas.ts](./src/utils/svgToCanvas.ts)
├── src-tauri/
│   ├── capabilities/
