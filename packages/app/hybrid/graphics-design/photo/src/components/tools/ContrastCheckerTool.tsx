...
const getLevels = (fg: string, bg: string): Level[] => {
...
export const ContrastCheckerTool: FC<{ config: ImageToolConfig }> = ({
  config,
}) => {
...
ContrastCheckerTool.displayName = 'ContrastCheckerTool';
