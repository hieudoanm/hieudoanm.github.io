...
describe('QRCodeTool', () => {
  ...
  it('generates QR code for valid input', async () => {
    ...
    await waitFor(() =>
      expect(screen.getByRole('button', { name: /Download JPG/ })).toBeTruthy()
    );
  });
});
