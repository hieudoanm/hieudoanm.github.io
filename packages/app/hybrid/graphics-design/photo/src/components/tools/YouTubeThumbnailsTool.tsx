...
const QUALITIES = [
  { id: 'maxresdefault', label: 'Max Resolution', resolution: '1280×720' },
  { id: 'hqdefault', label: 'High Quality', resolution: '480×360' },
  { id: 'sddefault', label: 'Standard', resolution: '640×480' },
  { id: 'mqdefault', label: 'Medium Quality', resolution: '320×180' },
  { id: 'default', label: 'Default', resolution: '120×90' },
];
...
export const YouTubeThumbnailsTool: FC<{ config: ImageToolConfig }> = ({
  config,
}) => {
...
YouTubeThumbnailsTool.displayName = 'YouTubeThumbnailsTool';
