...
const PLATFORMS: PlatformDef[] = [
  { id: 'linkedin', label: 'LinkedIn', desc: '400×400', size: 400 },
  { id: 'twitter', label: 'X (Twitter)', desc: '400×400', size: 400 },
  { id: 'github', label: 'GitHub', desc: '460×460', size: 460 },
  { id: 'facebook', label: 'Facebook', desc: '360×360', size: 360 },
  { id: 'instagram', label: 'Instagram', desc: '320×320', size: 320 },
];

export const ImageProfileTool: FC<{ config: ImageToolConfig }> = ({
  config,
}) => {
  ...
  return (
    <div className="flex flex-col gap-4">
      <ImageFileUpload accept="image/*" onFile={(f) => setFile(f)} />
...
ImageProfileTool.displayName = 'ImageProfileTool';
