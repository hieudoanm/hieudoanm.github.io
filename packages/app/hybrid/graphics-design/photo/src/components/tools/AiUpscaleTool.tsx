...
const nearestNeighbor = (src: ImageData, dst: ImageData) => {
  const sw = src.width,
    sh = src.height;
  const dw = dst.width,
    dh = dst.height;
...
const bilinear = (src: ImageData, dst: ImageData) => {
  const sw = src.width,
    sh = src.height;
  const dw = dst.width,
    dh = dst.height;
...
export const AiUpscaleTool: FC<{ config: ImageToolConfig }> = ({ config }) => {
...
AiUpscaleTool.displayName = 'AiUpscaleTool';
