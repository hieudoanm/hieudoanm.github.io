...
describe('ImageSharpenTool', () => {
  it('renders without throwing', () => {
    const { container } = render(
      <ImageSharpenTool config={makeCfg('ImageSharpenTool')} />
    );
    expect(container.firstChild).toBeTruthy();
  });

  it('processes after upload and downloads', async () => {
    const { container } = render(
      <ImageSharpenTool config={makeCfg('ImageSharpenTool')} />
    );
  ...
  it('does not throw before upload', () => {
    render(<ImageSharpenTool config={makeCfg('ImageSharpenTool')} />);
  });
