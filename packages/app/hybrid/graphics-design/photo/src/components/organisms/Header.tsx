...
const STORAGE_KEY = 'photo-theme';

const getInitialTheme = (): string => {
  if (typeof window === 'undefined') return 'photo-light';
  return localStorage.getItem(STORAGE_KEY) || 'photo-light';
};
...
export const Header: FC = () => {
  ...
  const toggleTheme = () =>
    setTheme((current) =>
      current === 'photo-light' ? 'photo-dark' : 'photo-light'
    );
