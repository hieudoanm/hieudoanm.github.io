# Photo — Packaging Checklist

Checklist for shipping Photo to users: macOS notarization, Windows code-signing,
Android/iOS store builds, and the Tauri updater pipeline.

App: `photo` (bundle identifier `io.github.hieudoanm.photo`, version 0.0.1).
...
- [ ] Endpoint to publish to:
      `https://github.com/hieudoanm/hieudoanm.github.io/releases/download/app-hybrid-photo-latest/latest.json`
...
- [ ] Signing team + provisioning profile set for the `photo` Xcode project
