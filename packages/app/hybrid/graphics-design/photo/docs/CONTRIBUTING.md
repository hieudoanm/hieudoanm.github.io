...
Thanks for contributing to **Photo**, a hybrid app that ships as a web app
...
3. **Run this app**:
   ...
   ```bash
   pnpm dev --filter=@hieudoanm.github.io/photo
   ```
...
| Task       | Command                                             |
| ---------- | --------------------------------------------------- |
| Dev server | `pnpm dev --filter=@hieudoanm.github.io/photo`      |
| Build      | `pnpm build --filter=@hieudoanm.github.io/photo`    |
| Lint       | `pnpm lint --filter=@hieudoanm.github.io/photo`     |
| Format     | `pnpm format --filter=@hieudoanm.github.io/photo`   |
| Unit tests | `pnpm test --filter=@hieudoanm.github.io/photo`     |
| E2E tests  | `pnpm test:e2e --filter=@hieudoanm.github.io/photo` |
...
- `organisms/` — complex sections (Header, Sidebar, PhotoGrid)
- `templates/` — page-level layouts (GalleryTemplate, SettingsTemplate)
...
1. `pnpm lint --filter=@hieudoanm.github.io/photo`
2. `pnpm format --filter=@hieudoanm.github.io/photo`
3. `pnpm test --filter=@hieudoanm.github.io/photo`
4. `pnpm test:e2e --filter=@hieudoanm.github.io/photo`
5. `pnpm build --filter=@hieudoanm.github.io/photo`
