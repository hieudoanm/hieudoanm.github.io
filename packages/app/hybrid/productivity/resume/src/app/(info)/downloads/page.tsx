...
const RELEASE =
  'https://github.com/hieudoanm/hieudoanm.github.io/releases/download/app-hybrid-resume-latest';
  ...
  <DownloadsTemplate
    ...
    items={[
      ...
      },
      {
        ...
        label: '.AppImage',
        href: `${RELEASE}/resume_0.0.1_amd64.AppImage`,
      },
      {
        platform: 'Linux (Debian)',
        requirements: 'Ubuntu 22.04.+',
        label: '.deb',
        href: `${RELEASE}/resume_0.0.1_amd64.deb`,
      },
      {
        platform: 'macOS',
        requirements: 'macOS 13.+',
        label: '.dmg',
        href: `${RELEASE}/resume_0.0.1_arm64.dmg`,
      },
    ]}
  />
);
