...
export const SaffronTemplate: FC<TemplateProps> = ({ data }) => {
  const {
    personal,
    summary,
    experience,
  ...
  return (
    <div
      ...
      <header
        ...
        <div style={{ fontSize: 12, color: '#fef3c7', marginBottom: 10 }}>
          {personal.jobTitle}
        </div>
        <ContactList
          items={collectContact(data)}
          style={{ fontSize: 9.5, color: '#fef9c3' }}
        />
      </header>
...
SaffronTemplate.displayName = 'SaffronTemplate';
