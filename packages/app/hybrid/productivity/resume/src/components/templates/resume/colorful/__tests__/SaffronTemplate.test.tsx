...
import { SaffronTemplate } from '../SaffronTemplate';

describe('SaffronTemplate', () => {
  it('renders with seed data', () => {
    render(<SaffronTemplate data={seedResumeData} />);
    expect(
  ...
  it('renders empty sections gracefully', () => {
    ...
    const { container } = render(<SaffronTemplate data={data} />);
