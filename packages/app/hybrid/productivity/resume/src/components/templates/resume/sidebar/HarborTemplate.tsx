...
export const HarborTemplate: FC<TemplateProps> = ({ data }) => {
  const {
    personal,
    summary,
    experience,
    ...
    <div
      ...
      <header
        ...
        <ContactList
          ...
          style={{ fontSize: 9.5, color: '#cbd5e1' }}
        />
      </header>
              ...
              <div key={item.id} style={{ marginBottom: 12 }}>
                <HeaderRow
                  ...
                  right={[item.startDate, item.endDate]
                    .filter(Boolean)
                    .join(' – ')}
                  primaryStyle={{ fontSize: 12.5, color: navy }}
...
HarborTemplate.displayName = 'HarborTemplate';
