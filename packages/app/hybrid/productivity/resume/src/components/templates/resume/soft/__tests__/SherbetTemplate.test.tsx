...
import { SherbetTemplate } from '../SherbetTemplate';

describe('SherbetTemplate', () => {
  it('renders with seed data', () => {
    render(<SherbetTemplate data={seedResumeData} />);
    expect(
  ...
  it('renders empty sections gracefully', () => {
    ...
    const { container } = render(<SherbetTemplate data={data} />);
