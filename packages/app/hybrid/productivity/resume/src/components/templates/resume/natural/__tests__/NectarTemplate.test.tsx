...
import { NectarTemplate } from '../NectarTemplate';

describe('NectarTemplate', () => {
  it('renders with seed data', () => {
    render(<NectarTemplate data={seedResumeData} />);
    expect(
  ...
  it('renders empty sections gracefully', () => {
    ...
    const { container } = render(<NectarTemplate data={data} />);
