...
const STORAGE_KEY = 'csv-theme';

const getInitialTheme = (): string => {
  if (typeof window === 'undefined') return 'csv-light';
  return localStorage.getItem(STORAGE_KEY) || 'csv-light';
};
...
export const Header: FC = () => {
  ...
  const toggleTheme = () =>
    setTheme((current) => (current === 'csv-light' ? 'csv-dark' : 'csv-light'));
