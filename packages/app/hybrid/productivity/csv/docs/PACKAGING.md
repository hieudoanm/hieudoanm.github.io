...
- [ ] Endpoint to publish to:
      `https://github.com/hieudoanm/hieudoanm.github.io/releases/download/app-hybrid-csv-latest/latest.json`
...
- [ ] Signing team + provisioning profile set for the `csv` Xcode project under
      `src-tauri/gen/apple/`
