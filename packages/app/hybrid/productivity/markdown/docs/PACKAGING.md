# Markdown — Packaging Checklist

Checklist for shipping Markdown to users: macOS notarization, Windows
code-signing, Android/iOS store builds, and the Tauri updater pipeline.

App: `markdown` (bundle identifier `io.github.hieudoanm.markdown`, version
0.0.1).
...
- [ ] Endpoint to publish to:
      `https://github.com/hieudoanm/hieudoanm.github.io/releases/download/app-hybrid-markdown-latest/latest.json`
...
- [ ] Signing team + provisioning profile set for the `markdown` Xcode project
