...
Thanks for contributing to **Markdown**, a hybrid app that ships as a web app
...
3. **Run this app**:
   ...
   ```bash
   pnpm dev --filter=@hieudoanm.github.io/markdown
   ```
...
| Task       | Command                                                |
| ---------- | ------------------------------------------------------ |
| Dev server | `pnpm dev --filter=@hieudoanm.github.io/markdown`      |
| Build      | `pnpm build --filter=@hieudoanm.github.io/markdown`    |
| Lint       | `pnpm lint --filter=@hieudoanm.github.io/markdown`     |
| Format     | `pnpm format --filter=@hieudoanm.github.io/markdown`   |
| Unit tests | `pnpm test --filter=@hieudoanm.github.io/markdown`     |
| E2E tests  | `pnpm test:e2e --filter=@hieudoanm.github.io/markdown` |
...
- `organisms/` — complex sections (Header, Sidebar, NoteList)
- `templates/` — page-level layouts (EditorTemplate, SettingsTemplate)
...
1. `pnpm lint --filter=@hieudoanm.github.io/markdown`
2. `pnpm format --filter=@hieudoanm.github.io/markdown`
3. `pnpm test --filter=@hieudoanm.github.io/markdown`
4. `pnpm test:e2e --filter=@hieudoanm.github.io/markdown`
5. `pnpm build --filter=@hieudoanm.github.io/markdown`
