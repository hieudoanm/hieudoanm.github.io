...
> Foundation: editor, preview, vault navigation

- [x] CodeMirror markdown editor
- [x] Live preview pane (split view)
- [x] Vault sidebar with note tree
- [x] Markdown formatting toolbar
- [x] File operations (new, rename, save, delete)
- [x] Word/character/line stats bar
- [x] Table of contents sidebar
- [x] Seeded vault with categorized notes

## Phase 2 — Notes & Linking

> Structure: wikilinks, search, organization
...
> Insight: graph view, command palette, outlines

- [x] Graph view of note links
...
- [ ] AI-assisted writing (mock summarization, completion)
