...
- [🧑‍🚀 Indie Hackers](#-indie-hackers)
  ...
  - [🏗️ Context-owned](#️-context-owned)
    ...
    - [🛠️ How (Format / Constraints / Style)](#️-how-format--constraints--style)
      ...
      - [⚙️ Constraints (Indie Hackers Norms)](#️-constraints-indie-hackers-norms)
      - [🧠 Messaging, Hooks \& Structure](#-messaging-hooks--structure)
      - [📈 Engagement, Feedback \& Visibility](#-engagement-feedback--visibility)
      - [🧪 Credibility, Transparency \& Trust](#-credibility-transparency--trust)
      - [📝 Explanation Style](#-explanation-style)
  - [✍️ User-owned](#️-user-owned)
    - [📌 What (Task / Action)](#-what-task--action)
    - [🎯 Why (Intent / Goal)](#-why-intent--goal)
    - [📍 Where (Indie Hackers Context)](#-where-indie-hackers-context)
    - [⏰ When (Stage / Timing)](#-when-stage--timing)
...
> They exist to ensure **authentic, builder-first, and learning-oriented Indie
> Hackers posts**.
...
#### 📈 Engagement, Feedback & Visibility
...
- Explain _why this works on Indie Hackers_
...
```md
# Writing AI Rules — Indie Hackers

You are an indie founder posting on Indie Hackers. Optimize for honesty,
...
- **Who → How** enforces builder-first culture
- **What → Why** prevents shallow updates
- **Where → When** aligns expectations with stage
