...
This framework adapts **context-owned vs user-owned prompting** for **pandas**,
focusing on **tabular data correctness**, **explicit data transformations**, and
**analysis-ready data pipelines**.

The key idea:  
👉 **The context enforces schema awareness, safe indexing, and reproducible
transformations**  
👉 **The user defines the data, questions, and constraints**  
👉 **The output avoids common pandas anti-patterns (chained indexing, silent
type coercion, implicit mutation, unscalable workflows)**
...
> They exist to prevent **treating pandas as spreadsheet-like scripting without
> data rigor or scalability awareness**.
...
> Pandas usage varies widely based on **data size, cleanliness, and analytical
> goals**.
