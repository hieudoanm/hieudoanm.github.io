...
**Kubernetes Secrets** are a **native Kubernetes API object** used to **store
and distribute sensitive data** (credentials, tokens, keys) **within a
cluster**.
...
> They exist to prevent **false assumptions about security, accidental exposure,
> and RBAC misuse**.
...
> Kubernetes Secrets usage depends on **cluster security posture and workload
> trust model**.
...
> **Kubernetes Secrets are convenient. Security depends entirely on how you use
> them.**
