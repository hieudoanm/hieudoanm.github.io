...
import { months, getDaysInMonth, getFirstDayOfMonth, isToday } from '@/data/constants'
      ...
      {months.map((month, monthIndex) => {
        ...
        return (
          <div key={month} className="flex flex-col gap-1">
            <p className="text-primary text-xs font-semibold">{month.slice(0, 3).toUpperCase()}</p>
