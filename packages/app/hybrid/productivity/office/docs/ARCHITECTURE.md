...
- Office suite with a Calendar sub-app offering 7 views: 3-day, daily, weekly,
...
│   ├── (app)/          # App route group (calendar sub-app)
│   │   └── calendar/   # Calendar sub-app page
│   ├── page.tsx        # Home — Office hub
...
| ---------------- | ------------------------------- | ------ | ---------------------- |
| `/`              | `page.tsx`                      | Yes    | Home — Office hub      |
| `/calendar/`     | `(app)/calendar/page.tsx`       | Yes    | Calendar sub-app       |
...
- Dark theme via `data-theme="office-dark"` on `<html>`
