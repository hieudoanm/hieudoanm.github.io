...
- [💰 Acquire.com](#-acquirecom)
  ...
  - [🏗️ Context-owned](#️-context-owned)
    ...
    - [🛠️ How (Format / Constraints / Style)](#️-how-format--constraints--style)
      ...
      - [⚙️ Constraints (Acquire.com Best Practices)](#️-constraints-acquirecom-best-practices)
      - [🧠 Messaging, Positioning \& Structure](#-messaging-positioning--structure)
      - [📈 Buyer Interest, Signals \& Conversion](#-buyer-interest-signals--conversion)
      - [🧪 Credibility, Due Diligence \& Trust](#-credibility-due-diligence--trust)
      - [📝 Explanation Style](#-explanation-style)
  - [✍️ User-owned](#️-user-owned)
    - [📌 What (Task / Action)](#-what-task--action)
    - [🎯 Why (Intent / Goal)](#-why-intent--goal)
    - [📍 Where (Listing Context)](#-where-listing-context)
    - [⏰ When (Sale Timing)](#-when-sale-timing)
...
> They exist to ensure **credible, buyer-focused, and high-conversion
...
#### ⚙️ Constraints (Acquire.com Best Practices)

- No hype language
- No exaggerated TAM claims
- Avoid emotional storytelling
- Avoid vague “huge upside” statements
...
#### 📈 Buyer Interest, Signals & Conversion
...
#### 🧪 Credibility, Due Diligence & Trust
...
```md
# Writing AI Rules — Acquire.com

You are a founder selling a startup on Acquire.com. Optimize for buyer clarity,
trust, and diligence-readiness.
...
- **Who → How** enforces investor-grade clarity
- **What → Why** removes vague positioning
- **Where → When** aligns valuation with reality

> Acquire.com rewards honesty, not storytelling.  
> Context turns listings into closed deals 💰📊

---

Happy Selling / Acquiring 💰
