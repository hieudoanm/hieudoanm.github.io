...
This framework adapts **context-owned vs user-owned prompting** for **Docker**,
focusing on **containerization**, **immutable infrastructure**, and
**reproducible runtime environments**.

The key idea:  
👉 **The context enforces Docker’s image-first, immutable-artifact mental
model**  
👉 **The user defines workloads, environments, and operational goals**  
👉 **The output avoids common Docker anti-patterns (bloated images, mutable
containers, snowflake environments)**
...
> They exist to prevent **misuse of Docker as a lightweight VM or long-lived
> mutable server**.
...
> Docker solutions vary significantly based on **application type, deployment
