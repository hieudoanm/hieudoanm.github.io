...
This framework is **Visual Studio–first** and optimized for **enterprise-grade
development**: deep debugging, rich tooling, solution-wide understanding, and
Windows / .NET ecosystems.
