...
The key idea: 👉 **The context enforces fast, deterministic, Vite-aligned
testing**  
...
> They guarantee **fast, reliable, and maintainable tests in modern frontend
> stacks**.
...
You are a senior test engineer specializing in Vitest. Think like a staff-level
engineer optimizing fast feedback loops.
...
> **Fast tests protect momentum. Clear intent defines coverage. Context makes
> Vitest shine.**
