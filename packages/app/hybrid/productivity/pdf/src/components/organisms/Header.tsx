...
const getInitialTheme = (): string => {
  if (typeof window === 'undefined') return 'pdf-light';
  return localStorage.getItem(STORAGE_KEY) || 'pdf-light';
};
...
export const Header: FC = () => {
  ...
  const toggleTheme = () =>
    setTheme((current) => (current === 'pdf-light' ? 'pdf-dark' : 'pdf-light'));
