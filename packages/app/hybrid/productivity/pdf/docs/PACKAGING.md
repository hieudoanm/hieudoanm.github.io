# PDF — Packaging Checklist

Checklist for shipping PDF to users: macOS notarization, Windows code-signing,
Android/iOS store builds, and the Tauri updater pipeline.

App: `pdf` (bundle identifier `io.github.hieudoanm.pdf`, version 0.0.1).
...
- [ ] Endpoint to publish to:
      `https://github.com/hieudoanm/hieudoanm.github.io/releases/download/app-hybrid-pdf-latest/latest.json`
...
- [ ] Signing team + provisioning profile set for the `pdf` Xcode project under
      `src-tauri/gen/apple/`
