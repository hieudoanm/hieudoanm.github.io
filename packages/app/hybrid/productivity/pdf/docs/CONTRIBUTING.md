...
Thanks for contributing to **PDF**, a hybrid app that ships as a web app
...
3. **Run this app**:
   ...
   ```bash
   pnpm dev --filter=@hieudoanm.github.io/pdf
   ```
...
| Task       | Command                                           |
| ---------- | ------------------------------------------------- |
| Dev server | `pnpm dev --filter=@hieudoanm.github.io/pdf`      |
| Build      | `pnpm build --filter=@hieudoanm.github.io/pdf`    |
| Lint       | `pnpm lint --filter=@hieudoanm.github.io/pdf`     |
| Format     | `pnpm format --filter=@hieudoanm.github.io/pdf`   |
| Unit tests | `pnpm test --filter=@hieudoanm.github.io/pdf`     |
| E2E tests  | `pnpm test:e2e --filter=@hieudoanm.github.io/pdf` |
...
- `organisms/` — complex sections (Header, Sidebar, PdfViewer)
- `templates/` — page-level layouts (ViewerTemplate, SettingsTemplate)
...
1. `pnpm lint --filter=@hieudoanm.github.io/pdf`
2. `pnpm format --filter=@hieudoanm.github.io/pdf`
3. `pnpm test --filter=@hieudoanm.github.io/pdf`
4. `pnpm test:e2e --filter=@hieudoanm.github.io/pdf`
5. `pnpm build --filter=@hieudoanm.github.io/pdf`
