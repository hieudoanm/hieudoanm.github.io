...
Thanks for contributing to **Projects**, a hybrid app that ships as a web app
...
3. **Run this app**:
   ...
   ```bash
   pnpm dev --filter=@hieudoanm.github.io/projects
   ```
...
| Task       | Command                                                |
| ---------- | ------------------------------------------------------ |
| Dev server | `pnpm dev --filter=@hieudoanm.github.io/projects`      |
| Build      | `pnpm build --filter=@hieudoanm.github.io/projects`    |
| Lint       | `pnpm lint --filter=@hieudoanm.github.io/projects`     |
| Format     | `pnpm format --filter=@hieudoanm.github.io/projects`   |
| Unit tests | `pnpm test --filter=@hieudoanm.github.io/projects`     |
| E2E tests  | `pnpm test:e2e --filter=@hieudoanm.github.io/projects` |
...
1. `pnpm lint --filter=@hieudoanm.github.io/projects`
2. `pnpm format --filter=@hieudoanm.github.io/projects`
3. `pnpm test --filter=@hieudoanm.github.io/projects`
4. `pnpm test:e2e --filter=@hieudoanm.github.io/projects`
5. `pnpm build --filter=@hieudoanm.github.io/projects`
