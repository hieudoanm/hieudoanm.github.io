# Projects — Packaging Checklist

Checklist for shipping Projects to users: macOS notarization, Windows
code-signing, Android/iOS store builds, and the Tauri updater pipeline.

App: `projects` (bundle identifier `io.github.hieudoanm.projects`, version
0.0.1).
...
- [ ] Endpoint to publish to:
      `https://github.com/hieudoanm/hieudoanm.github.io/releases/download/app-hybrid-projects-latest/latest.json`
...
- [ ] Signing team + provisioning profile set for the `projects` Xcode project
