...
test.describe('About Page', () => {
  ...
  test('displays app description', async ({ page }) => {
    await page.goto('/about');
    await expect(page.locator('text=Web-based code editor')).toBeVisible();
  });
  ...
  test('displays editor info', async ({ page }) => {
    await page.goto('/about');
    await expect(page.locator('text=CodeMirror 6')).toBeVisible();
  });
