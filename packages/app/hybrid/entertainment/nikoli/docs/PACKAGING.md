# Nikoli — Packaging Checklist

Checklist for shipping Nikoli to users: macOS notarization, Windows
code-signing, Android/iOS store builds, and the Tauri updater pipeline.

App: `nikoli` (bundle identifier `io.github.hieudoanm.nikoli`, version 0.0.1).
...
- [ ] Endpoint to publish to:
      `https://github.com/hieudoanm/hieudoanm.github.io/releases/download/app-hybrid-nikoli-latest/latest.json`
...
- [ ] Signing team + provisioning profile set for the `nikoli` Xcode project
