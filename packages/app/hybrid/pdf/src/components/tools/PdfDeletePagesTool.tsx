...
import { parsePageRange, downloadBlob } from '@/lib/pdf-tools';

export const PdfDeletePagesTool: FC = () => {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <label className="flex flex-col gap-1">
        <span className="text-sm">Pages to delete (e.g. 1,3-5):</span>
        <input
          type="text"
      ...
      <button
        ...
        {loading ? 'Deleting...' : 'Delete & Download'}
      </button>
    </div>
  );
};
