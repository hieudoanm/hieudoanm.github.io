...
const APP_NAME: string = 'Psychology';
const THEME_KEY: string = 'psychology-theme';
const THEME_DARK: string = 'psychology-dark';
const THEME_LIGHT: string = 'psychology-light';
