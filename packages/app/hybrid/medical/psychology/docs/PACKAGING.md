...
Checklist for shipping Psychology to users: macOS notarization, Linux artifacts,
and the Tauri updater pipeline. (Windows and mobile builds are not shipped yet —
see `docs/ROADMAP.md`.)
...
- [ ] Upload artifacts to the `app-hybrid-psychology-latest` release tag with
      ...
      (`psychology_amd64.AppImage`, `psychology_amd64.deb`,
      `psychology_aarch64.dmg`)
