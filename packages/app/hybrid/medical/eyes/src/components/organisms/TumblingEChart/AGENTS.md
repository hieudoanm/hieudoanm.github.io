...
```text
TumblingEChart/
  index.tsx            # Entry — fullscreen chart + direction quiz
...
Fullscreen Tumbling E visual acuity chart. Ten lines from 20/200 to 20/10 show a
random number of E optotypes, each rotated to point right, down, left, or up.
For single-E lines the user picks a direction and is graded correct/incorrect.
...
```tsx
// src/app/(app)/tumbling-e/page.tsx — fullscreen chart
```
