...
const STORAGE_KEY = 'mri-theme';

const getInitialTheme = (): string => {
  if (typeof window === 'undefined') return 'mri-light';
  return localStorage.getItem(STORAGE_KEY) || 'mri-light';
};
...
export const Header: FC = () => {
  ...
  const toggleTheme = () =>
    setTheme((current) => (current === 'mri-light' ? 'mri-dark' : 'mri-light'));
