jest.mock('../Palindrome/utils/puzzle', () => ({
...
jest.mock('../Palindrome/constants', () => ({
  PUZZLES: [
    {
...
describe('Palindrome', () => {
  ...
  it('should render correctly', () => {
    const { container } = render(<Palindrome onClose={jest.fn()} />);
    expect(container).toMatchSnapshot();
  });

  it('shows letters in bank', () => {
    render(<Palindrome onClose={jest.fn()} />);
  ...
  it('Escape key closes', () => {
    ...
    render(<Palindrome onClose={onClose} />);
