import { manifest as pwaManifest } from '@hieudoanm.github.io/components/pages/app/editors/data/manifest/pwa';
import { manifest as extensionManifest } from '@hieudoanm.github.io/components/pages/app/editors/data/manifest/extension';
import { FC, useState } from 'react';
import { FullScreen } from '@hieudoanm.github.io/components/atoms/FullScreen';
import { ManifestType } from './utils';

export const Manifest: FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  return (
    <FullScreen onClose={onClose} title="Manifest Editor">
      {/* Type tabs */}
