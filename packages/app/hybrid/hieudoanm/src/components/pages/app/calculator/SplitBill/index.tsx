...
export const SplitBill: FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  return (
    <FullScreen onClose={onClose} title="Split Bill">
            ...
            <>
              ...
              <div className="form-control">
                ...
                <input
                  ...
                  step={0.5}
                  onChange={(e) =>
                    setTip(Number.parseFloat(e.target.value) || 0)
                  }
                />
              </div>
              <div className="form-control">
                  ...
                  <div key={i} className="flex items-center gap-1.5">
                    ...
                    {splitEqually ? (
                      ...
                      <input
                        ...
                        step={0.01}
                        onChange={(e) =>
                          updatePerson(i, 'owes', e.target.value)
                        }
                      />
                    )}
                    <button
                ...
                <div className="bg-base-200 mt-2 flex flex-col space-y-2 gap-y-2 rounded-xl p-3">
                  ...
                  {settlements.map((s, i) => (
                    <div
                      ...
                      <span className="text-sm font-normal">
                        {s.from}{' '}
                        <span className="text-xs opacity-50">pays</span> {s.to}
                      </span>
                      <span className="text-sm font-normal">
