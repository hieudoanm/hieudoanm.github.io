...
import { TumblingEChart } from '../TumblingEChart';

jest.mock('../TumblingEChart/utils/chart', () => ({
...
describe('TumblingEChart', () => {
  it('should render the chart component', () => {
    render(<TumblingEChart onClose={jest.fn()} />);
  ...
  it('should call onClose when close button clicked', () => {
    ...
    render(<TumblingEChart onClose={onClose} />);
