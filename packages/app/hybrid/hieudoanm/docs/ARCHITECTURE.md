...
- **SQLite seed files** (`public/db/*.db`) generated by Prisma schema and
  served as static assets
- **ONNX models** (`public/models/*.onnx`) loaded via web workers for local
  ML inference (invoice parsing, signatures)
