# Memory Games — Packaging Checklist

Checklist for shipping Memory Games to users: macOS notarization, Windows
code-signing, Android/iOS store builds, and the Tauri updater pipeline.

App: `memory` (bundle identifier `io.github.hieudoanm.memory`, version 0.0.1).
...
- [ ] Endpoint to publish to:
      `https://github.com/hieudoanm/hieudoanm.github.io/releases/download/app-hybrid-games-memory-latest/latest.json`
...
- [ ] Signing team + provisioning profile set for the `memory` Xcode project
