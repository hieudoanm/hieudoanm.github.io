...
> experience that runs on your phone, tablet, laptop, and desktop. Zero
> internet needed.
...
- **Linux AppImage:** `chmod +x casino_amd64.AppImage && ./casino_amd64.AppImage`
...
Full-scale casino games — Baccarat, card-counting trainer, poker-odds calculator,
slots, roulette, craps, war, keno, and Hi-Lo. Every game runs offline with
pure logic and injectable randomness.
