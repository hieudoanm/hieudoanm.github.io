...
const APP_NAME: string = 'Tic-Tac-Toe';
const THEME_KEY: string = 'tic-tac-toe-theme';
const THEME_DARK: string = 'tic-tac-toe-dark';
const THEME_LIGHT: string = 'tic-tac-toe-light';
