...
Thanks for contributing to **Chat**, a hybrid app that ships as a web app
...
3. **Run this app**:
   ...
   ```bash
   pnpm dev --filter=@hieudoanm.github.io/chat
   ```
...
| Task       | Command                                            |
| ---------- | -------------------------------------------------- |
| Dev server | `pnpm dev --filter=@hieudoanm.github.io/chat`      |
| Build      | `pnpm build --filter=@hieudoanm.github.io/chat`    |
| Lint       | `pnpm lint --filter=@hieudoanm.github.io/chat`     |
| Format     | `pnpm format --filter=@hieudoanm.github.io/chat`   |
| Unit tests | `pnpm test --filter=@hieudoanm.github.io/chat`     |
| E2E tests  | `pnpm test:e2e --filter=@hieudoanm.github.io/chat` |
...
- `organisms/` — complex sections (Header, Sidebar, ConversationList)
- `templates/` — page-level layouts (ChatTemplate, SettingsTemplate)
...
1. `pnpm lint --filter=@hieudoanm.github.io/chat`
2. `pnpm format --filter=@hieudoanm.github.io/chat`
3. `pnpm test --filter=@hieudoanm.github.io/chat`
4. `pnpm test:e2e --filter=@hieudoanm.github.io/chat`
5. `pnpm build --filter=@hieudoanm.github.io/chat`
