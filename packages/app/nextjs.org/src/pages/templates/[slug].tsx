...
const DownloadsTemplate = dynamic(
  () =>
    import('@hieudoanm.github.io/components/templates/app/DownloadsTemplate').then(
...
const LandingTemplate = dynamic(
  () =>
    import('@hieudoanm.github.io/components/templates/app/LandingTemplate').then(
...
import type { BlogMeta, BlogPost } from '@hieudoanm.github.io/data/blog';
...
const TemplatePage: NextPage<PageProps> = ({ slug }) => {
...
export const getStaticPaths: GetStaticPaths = () => ({
  paths: Object.keys(slugMap).map((slug) => ({ params: { slug } })),
  fallback: false,
});
