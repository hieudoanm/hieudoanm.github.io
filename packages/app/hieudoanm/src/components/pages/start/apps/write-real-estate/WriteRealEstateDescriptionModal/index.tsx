...
export const WriteRealEstateDescriptionModal: FC<{ onClose: () => void }> = ({
  onClose,
}) => {
  ...
  return (
    <FullScreen onClose={onClose} title="Property Description">
      <div className="flex flex-col gap-4">
        <textarea
          className="textarea textarea-bordered h-32 font-mono text-sm"
          placeholder="Enter property details for a full description..."
          value={input}
...
WriteRealEstateDescriptionModal.displayName = 'WriteRealEstateDescriptionModal';
