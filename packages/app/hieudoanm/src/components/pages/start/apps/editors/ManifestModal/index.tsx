import { manifest as pwaManifest } from '@hieudoanm.github.io/components/pages/start/apps/editors/data/manifest/pwa';
import { manifest as extensionManifest } from '@hieudoanm.github.io/components/pages/start/apps/editors/data/manifest/extension';
