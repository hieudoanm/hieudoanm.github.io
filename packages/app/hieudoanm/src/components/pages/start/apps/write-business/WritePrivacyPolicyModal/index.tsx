...
export const WritePrivacyPolicyModal: FC<{ onClose: () => void }> = ({
  onClose,
}) => {
  ...
  return (
    <FullScreen onClose={onClose} title="Privacy Policy">
...
WritePrivacyPolicyModal.displayName = 'WritePrivacyPolicyModal';
