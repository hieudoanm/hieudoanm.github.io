...
export const VideoMovToAviModal: FC<{ onClose: () => void }> = ({
  ...
  const handleConvert = useCallback(async () => {
    ...
    try {
      ...
      const mime = 'video/x-matroska;codecs=vp8,opus';
  ...
  return (
    <FullScreen centered onClose={onClose} title="MOV to AVI">
      <div className="rounded-box border-base-300 bg-base-200 border p-4">
        <div className="flex flex-col gap-4">
          <p className="text-sm">
            Convert MOV videos to AVI format (browser outputs MKV as closest
            supported format).
          </p>
