...
export const VideoMkvToMp4Modal: FC<{ onClose: () => void }> = ({
  ...
  return (
    <FullScreen centered onClose={onClose} title="MKV to MP4">
      <div className="rounded-box border-base-300 bg-base-200 border p-4">
        <div className="flex flex-col gap-4">
          <p className="text-sm">
            Convert MKV files to MP4 format using browser APIs.
          </p>
          <Dropzone accept=".mkv,video/x-matroska" onFile={setFile} />
