...
export const FlagGuesserModal: FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Flag Guesser" size="max-w-sm">
      <div
        tabIndex={0}
        onKeyDown={onKeyDown}
...
FlagGuesserModal.displayName = 'FlagGuesserModal';
