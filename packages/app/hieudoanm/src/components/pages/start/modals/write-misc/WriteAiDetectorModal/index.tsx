...
export const WriteAiDetectorModal: FC<{ onClose: () => void }> = ({
  onClose,
}) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="AI Detector" size="max-w-2xl">
...
WriteAiDetectorModal.displayName = 'WriteAiDetectorModal';
