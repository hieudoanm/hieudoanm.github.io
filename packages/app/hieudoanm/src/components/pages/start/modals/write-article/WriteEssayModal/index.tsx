...
export const WriteEssayModal: FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Essay" size="max-w-2xl">
...
WriteEssayModal.displayName = 'WriteEssayModal';
