...
export const WriteParagraphModal: FC<{ onClose: () => void }> = ({
  onClose,
}) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Paragraph" size="max-w-2xl">
...
WriteParagraphModal.displayName = 'WriteParagraphModal';
