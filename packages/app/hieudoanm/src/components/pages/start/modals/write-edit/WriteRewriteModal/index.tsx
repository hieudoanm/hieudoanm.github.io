...
export const WriteRewriteModal: FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Rewrite" size="max-w-2xl">
...
WriteRewriteModal.displayName = 'WriteRewriteModal';
