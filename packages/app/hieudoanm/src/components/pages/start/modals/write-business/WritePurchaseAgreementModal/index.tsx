...
export const WritePurchaseAgreementModal: FC<{ onClose: () => void }> = ({
  onClose,
}) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Purchase Agreement" size="max-w-2xl">
      <div className="flex flex-col gap-4">
        <textarea
          className="textarea textarea-bordered h-32 font-mono text-sm"
          placeholder="Describe the purchase details (item, price, parties, terms)..."
          value={input}
...
WritePurchaseAgreementModal.displayName = 'WritePurchaseAgreementModal';
