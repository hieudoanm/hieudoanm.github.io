...
const loadImageConvertTiffToJpg = () =>
  import('@hieudoanm.github.io/components/pages/start/apps/image-convert-tiff/ImageConvertTiffToJpgModal').then(
    (m) => ({ default: m.ImageConvertTiffToJpgModal })
  );

const loadImageConvertTiffToPng = () =>
  import('@hieudoanm.github.io/components/pages/start/apps/image-convert-tiff/ImageConvertTiffToPngModal').then(
