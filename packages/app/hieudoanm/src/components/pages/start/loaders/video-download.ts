...
const loadVideoFacebook = () =>
  import('@hieudoanm.github.io/components/pages/start/apps/video-download/VideoFacebookModal').then(
    (m) => ({ default: m.VideoFacebookModal })
  );

const loadVideoInstagram = () =>
  import('@hieudoanm.github.io/components/pages/start/apps/video-download/VideoInstagramModal').then(
    (m) => ({ default: m.VideoInstagramModal })
  );

const loadVideoTikTok = () =>
  import('@hieudoanm.github.io/components/pages/start/apps/video-download/VideoTikTokModal').then(
    (m) => ({ default: m.VideoTikTokModal })
  );

const loadVideoTwitter = () =>
  import('@hieudoanm.github.io/components/pages/start/apps/video-download/VideoTwitterModal').then(
    (m) => ({ default: m.VideoTwitterModal })
  );

const loadVideoYoutubeText = () =>
  import('@hieudoanm.github.io/components/pages/start/apps/video-download/VideoYoutubeTextModal').then(
    (m) => ({ default: m.VideoYoutubeTextModal })
  );

const loadVideoYoutubeTranscript = () =>
  import('@hieudoanm.github.io/components/pages/start/apps/video-download/VideoYoutubeTranscriptModal').then(
