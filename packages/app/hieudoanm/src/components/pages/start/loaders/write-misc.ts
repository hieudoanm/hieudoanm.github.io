...
const loadWriteAiDetector = () =>
  import('@hieudoanm.github.io/components/pages/start/apps/write-misc/WriteAiDetectorModal').then(
    (m) => ({ default: m.WriteAiDetectorModal })
  );

const loadWriteExplain = () =>
  import('@hieudoanm.github.io/components/pages/start/apps/write-misc/WriteExplainModal').then(
    (m) => ({ default: m.WriteExplainModal })
  );

const loadWriteSummarizePodcast = () =>
  import('@hieudoanm.github.io/components/pages/start/apps/write-misc/WriteSummarizePodcastModal').then(
    (m) => ({ default: m.WriteSummarizePodcastModal })
  );

const loadWriteSummarizeYoutube = () =>
  import('@hieudoanm.github.io/components/pages/start/apps/write-misc/WriteSummarizeYoutubeModal').then(
    (m) => ({ default: m.WriteSummarizeYoutubeModal })
  );

const loadWriteTitle = () =>
  import('@hieudoanm.github.io/components/pages/start/apps/write-misc/WriteTitleModal').then(
