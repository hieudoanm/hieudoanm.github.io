...
const loadImageConvertPsdToJpg = () =>
  import('@hieudoanm.github.io/components/pages/start/apps/image-convert-psd/ImageConvertPsdToJpgModal').then(
    (m) => ({ default: m.ImageConvertPsdToJpgModal })
  );

const loadImageConvertPsdToPng = () =>
  import('@hieudoanm.github.io/components/pages/start/apps/image-convert-psd/ImageConvertPsdToPngModal').then(
