      ...
      <div className="flex flex-1 flex-col gap-1.5">
        {tiers.map((tier, i) => (
          <div key={i} className="flex flex-1 items-stretch gap-2">
            <div
              className="flex w-10 items-center justify-center rounded text-sm font-black text-white"
              style={{ backgroundColor: tier.color }}>
              {tier.label}
            </div>
            <div className="border-base-300 flex flex-1 flex-wrap items-center justify-center gap-1.5 rounded border px-3 py-1.5">
