...
export const WriteHeadlineModal: FC<{ onClose: () => void }> = ({
  onClose,
}) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Headline" size="max-w-2xl">
      <div className="flex flex-col gap-4">
        <textarea
          className="textarea textarea-bordered h-32 font-mono text-sm"
          placeholder="Describe your topic or product..."
          value={input}
...
WriteHeadlineModal.displayName = 'WriteHeadlineModal';
