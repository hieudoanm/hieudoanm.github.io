...
export const WriteLandingPageModal: FC<{ onClose: () => void }> = ({
  onClose,
}) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Landing Page">
...
WriteLandingPageModal.displayName = 'WriteLandingPageModal';
