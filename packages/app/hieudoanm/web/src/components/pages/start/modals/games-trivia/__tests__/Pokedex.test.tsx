jest.mock('@hieudoanm.github.io/data/pokedex', () => ({
  pokedex: [
    { id: 1, name: 'bulbasaur', type: 'grass', hp: 45, attack: 49, speed: 45 },
    { id: 4, name: 'charmander', type: 'fire', hp: 39, attack: 52, speed: 65 },
