...
export const WriteTwitterGeneratorModal: FC<{ onClose: () => void }> = ({
  onClose,
}) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Twitter Generator" size="max-w-2xl">
...
WriteTwitterGeneratorModal.displayName = 'WriteTwitterGeneratorModal';
