...
export const WriteShortenModal: FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Shorten" size="max-w-2xl">
...
WriteShortenModal.displayName = 'WriteShortenModal';
