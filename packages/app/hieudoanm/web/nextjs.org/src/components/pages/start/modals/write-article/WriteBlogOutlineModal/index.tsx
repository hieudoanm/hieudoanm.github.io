...
export const WriteBlogOutlineModal: FC<{ onClose: () => void }> = ({
  onClose,
}) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Blog Outline" size="max-w-2xl">
...
WriteBlogOutlineModal.displayName = 'WriteBlogOutlineModal';
