...
export const WriteCaptionModal: FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Caption" size="max-w-2xl">
      <div className="flex flex-col gap-4">
        <textarea
          className="textarea textarea-bordered h-32 font-mono text-sm"
          placeholder="Describe your photo or topic..."
          value={input}
...
WriteCaptionModal.displayName = 'WriteCaptionModal';
