...
export const WriteContentBriefModal: FC<{ onClose: () => void }> = ({
  onClose,
}) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Content Brief">
...
WriteContentBriefModal.displayName = 'WriteContentBriefModal';
