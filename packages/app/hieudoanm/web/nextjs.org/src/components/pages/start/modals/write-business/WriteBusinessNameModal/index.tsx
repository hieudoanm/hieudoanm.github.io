...
export const WriteBusinessNameModal: FC<{ onClose: () => void }> = ({
  onClose,
}) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Business Name" size="max-w-2xl">
...
WriteBusinessNameModal.displayName = 'WriteBusinessNameModal';
