...
export const WriteTitleModal: FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Title" size="max-w-2xl">
...
WriteTitleModal.displayName = 'WriteTitleModal';
