...
export const WritePodcastScriptModal: FC<{ onClose: () => void }> = ({
  onClose,
}) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Podcast Script">
...
WritePodcastScriptModal.displayName = 'WritePodcastScriptModal';
