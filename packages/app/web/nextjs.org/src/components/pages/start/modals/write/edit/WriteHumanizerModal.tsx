...
export const WriteHumanizerModal: FC<{ onClose: () => void }> = ({
  onClose,
}) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Humanizer" size="max-w-2xl">
...
WriteHumanizerModal.displayName = 'WriteHumanizerModal';
