...
export const WriteSummarizeModal: FC<{ onClose: () => void }> = ({
  onClose,
}) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Summarize" size="max-w-2xl">
...
WriteSummarizeModal.displayName = 'WriteSummarizeModal';
