...
export const WriteContentPlannerModal: FC<{ onClose: () => void }> = ({
  onClose,
}) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Content Planner">
...
WriteContentPlannerModal.displayName = 'WriteContentPlannerModal';
