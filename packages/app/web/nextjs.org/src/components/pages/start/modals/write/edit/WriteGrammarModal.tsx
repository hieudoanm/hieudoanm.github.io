...
export const WriteGrammarModal: FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Grammar" size="max-w-2xl">
      <div className="flex flex-col gap-4">
        <textarea
          className="textarea textarea-bordered h-32 font-mono text-sm"
          placeholder="Enter text with grammar errors..."
          value={input}
...
WriteGrammarModal.displayName = 'WriteGrammarModal';
