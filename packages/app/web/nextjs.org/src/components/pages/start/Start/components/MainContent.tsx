...
export const MainContent: FC<MainContentProps> = memo(
  ({ today, query, onQueryChange, toolSections }) => {
    ...
    const {
      ...
      'image-convert-plus': imageConvertPlus,
      'image-convert-pro': imageConvertPro,
      ...
      'video-convert-audio': videoConvertAudio,
      'video-convert-misc': videoConvertMisc,
    ...
    const toolSectionDefs = useMemo(
      () => [
        ...
        { label: 'Image Convert', items: imageConvert },
        { label: 'Image Convert+', items: imageConvertPlus },
        { label: 'Image Convert Pro', items: imageConvertPro },
        ...
        { label: 'Video Convert', items: videoConvert },
        { label: 'Video Convert Audio', items: videoConvertAudio },
        { label: 'Video Convert Misc', items: videoConvertMisc },
        ...
        { label: 'Data XML/JSON', items: dataXmlJson },
