...
export const WriteExplainModal: FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Explain" size="max-w-2xl">
...
WriteExplainModal.displayName = 'WriteExplainModal';
