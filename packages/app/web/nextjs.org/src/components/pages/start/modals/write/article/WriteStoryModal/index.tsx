...
export const WriteStoryModal: FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Story" size="max-w-2xl">
...
WriteStoryModal.displayName = 'WriteStoryModal';
