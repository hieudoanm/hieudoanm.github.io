...
export const WriteTikTokScriptModal: FC<{ onClose: () => void }> = ({
  onClose,
}) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="TikTok Script" size="max-w-2xl">
      <div className="flex flex-col gap-4">
        <textarea
          className="textarea textarea-bordered h-32 font-mono text-sm"
          placeholder="Describe your TikTok video topic or idea..."
          value={input}
...
WriteTikTokScriptModal.displayName = 'WriteTikTokScriptModal';
