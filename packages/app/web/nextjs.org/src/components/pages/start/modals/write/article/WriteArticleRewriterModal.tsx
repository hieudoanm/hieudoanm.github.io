...
export const WriteArticleRewriterModal: FC<{ onClose: () => void }> = ({
  onClose,
}) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Article Rewriter">
...
WriteArticleRewriterModal.displayName = 'WriteArticleRewriterModal';
