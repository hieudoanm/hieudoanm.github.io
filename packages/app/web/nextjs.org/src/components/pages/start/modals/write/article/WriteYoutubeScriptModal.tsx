...
export const WriteYoutubeScriptModal: FC<{ onClose: () => void }> = ({
  onClose,
}) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="YouTube Script" size="max-w-2xl">
...
WriteYoutubeScriptModal.displayName = 'WriteYoutubeScriptModal';
