...
export const WriteMetaDescriptionModal: FC<{ onClose: () => void }> = ({
  onClose,
}) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Meta Description">
...
WriteMetaDescriptionModal.displayName = 'WriteMetaDescriptionModal';
