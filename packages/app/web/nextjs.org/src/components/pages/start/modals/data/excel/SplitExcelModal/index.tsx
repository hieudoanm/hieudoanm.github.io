...
export const SplitExcelModal: FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Split Excel" size="max-w-lg">
...
SplitExcelModal.displayName = 'SplitExcelModal';
