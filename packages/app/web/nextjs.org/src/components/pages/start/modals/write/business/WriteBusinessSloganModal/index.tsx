...
export const WriteBusinessSloganModal: FC<{ onClose: () => void }> = ({
  onClose,
}) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Business Slogan">
...
WriteBusinessSloganModal.displayName = 'WriteBusinessSloganModal';
