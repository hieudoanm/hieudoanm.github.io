...
const SYSTEM_PROMPT =
  'Improve the following text to make it more engaging, clear, and professional. Enhance vocabulary and sentence structure.';

export const WriteImproveTextModal: FC<{ onClose: () => void }> = ({
  onClose,
}) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Improve Text" size="max-w-2xl">
...
WriteImproveTextModal.displayName = 'WriteImproveTextModal';
