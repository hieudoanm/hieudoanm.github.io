...
export const WriteRealEstateListingModal: FC<{ onClose: () => void }> = ({
  onClose,
}) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Property Listing" size="max-w-2xl">
      <div className="flex flex-col gap-4">
        <textarea
          className="textarea textarea-bordered h-32 font-mono text-sm"
          placeholder="Describe the property (location, bedrooms, amenities)..."
          value={input}
...
WriteRealEstateListingModal.displayName = 'WriteRealEstateListingModal';
