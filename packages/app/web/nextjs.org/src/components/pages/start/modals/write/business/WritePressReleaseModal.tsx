...
export const WritePressReleaseModal: FC<{ onClose: () => void }> = ({
  onClose,
}) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Press Release">
...
WritePressReleaseModal.displayName = 'WritePressReleaseModal';
