...
export const WriteLinkedInPostModal: FC<{ onClose: () => void }> = ({
  onClose,
}) => {
  ...
  return (
    <ModalWrapper onClose={onClose} title="LinkedIn Post" size="max-w-2xl">
...
WriteLinkedInPostModal.displayName = 'WriteLinkedInPostModal';
