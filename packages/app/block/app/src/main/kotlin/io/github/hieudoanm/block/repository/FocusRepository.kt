...
class FocusRepository @Inject constructor(
    ...
    val blockingEnabled: Flow<Boolean> = settingsDataStore.blockingEnabled
    val darkMode: Flow<Boolean> = settingsDataStore.darkMode
    val accessibilityEnabled: Flow<Boolean> = settingsDataStore.accessibilityEnabled
    val ignoreSystemApps: Flow<Boolean> = settingsDataStore.ignoreSystemApps
    val launchOnBoot: Flow<Boolean> = settingsDataStore.launchOnBoot
    val firstLaunch: Flow<Boolean> = settingsDataStore.firstLaunch
    val lastBlockedTime: Flow<Long> = settingsDataStore.lastBlockedTime
