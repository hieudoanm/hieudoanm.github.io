...
export const FrequentlyAskedQuestions = () => (
  <section class="mx-auto max-w-3xl px-12 py-24">
    ...
    <p class="text-base-content/60 mx-auto mb-12 max-w-xl text-center text-base leading-relaxed">
      Everything you need to know about Forma.
    </p>
    <div class="border-base-300 overflow-hidden rounded-2xl border">
      {faqs.map(({ q, a }, i) => (
        <div
          key={i}
          class="collapse-arrow border-base-300 collapse border-b bg-transparent last:border-b-0">
          ...
          <div class="collapse-content px-5">
            <p class="text-base-content/50 pb-2 text-sm leading-relaxed">{a}</p>
          </div>
        </div>
      ))}
    </div>
