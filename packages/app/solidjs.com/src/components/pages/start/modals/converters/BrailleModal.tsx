...
export const BrailleModal = ({ onClose }: { onClose: () => void }) => {
  ...
  return (
    <ModalWrapper
      ...
      <div class="flex flex-col gap-2">
        ...
        <textarea
          class="textarea textarea-bordered h-24 w-full resize-none text-sm leading-relaxed"
      ...
      <div class="flex flex-col gap-2">
        ...
        <div class="bg-base-200 border-base-300 min-h-[64px] overflow-auto rounded-xl border p-4">
          {output().trim() ? (
            <p class="text-primary font-mono text-2xl leading-loose tracking-widest break-all">
              {output()}
            </p>
          ) : (
          ...
          <table class="table-sm table w-full text-sm">
            <thead class="bg-base-200">
              <tr>
                ...
                <th class="text-base-content/40 font-medium">Braille</th>
              ...
              {uniqueChars().map((ch) => {
                ...
                return (
                  <tr key={ch} class="border-base-300 border-t">
                    ...
                    <td class="text-primary font-mono text-xl">
                      {entry.character}
                    </td>
