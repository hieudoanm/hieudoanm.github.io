      ...
      <div className="modal-box w-full max-w-xl">
          ...
          <>
              ...
              {QUALITIES.map((q) => {
                ...
                return (
                  <div
                    ...
                    {/* Checkbox indicator */}
                    <div
                      className={`absolute top-1.5 left-1.5 z-10 flex h-5 w-5 items-center justify-center rounded-full text-xs ${
                        isSelected
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                onClick={() =>
                  setSelected(new Set(QUALITIES.map((q) => q.id)))
                }>
                All
              </button>
              <button
        ...
        {!videoId && !error && (
          <p className="py-4 text-center text-xs opacity-30">
            Supports youtube.com/watch, youtu.be, /embed, /shorts, or raw video
            ID
          </p>
        )}
