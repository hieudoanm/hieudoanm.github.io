...
/// Converts between screen-relative pixel rectangles (bottom-left origin,
/// matching CGWindow bounds and NSScreen frames) and normalized rectangles
/// (top-left origin, 0...1 space).
