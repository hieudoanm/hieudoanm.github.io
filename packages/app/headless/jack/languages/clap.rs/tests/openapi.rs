...
fn openapi_validate_valid_yaml() {
    let path = "/tmp/jack_openapi_valid.yaml";
...
fn openapi_validate_valid_json() {
    let path = "/tmp/jack_openapi_valid_json.yaml";
...
fn openapi_validate_invalid() {
    let path = "/tmp/jack_openapi_invalid.yaml";
...
fn openapi_convert_to_postman() {
    let path = "/tmp/jack_openapi_convert.yaml";
    let out = "/tmp/jack_openapi_postman.json";
    fs::write(path, valid_openapi_yaml()).unwrap();
