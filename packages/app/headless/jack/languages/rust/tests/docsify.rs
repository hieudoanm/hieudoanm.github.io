...
fn docsify_tree_generates_output() {
    let dir = "/tmp/jack_docsify_tree_test";
    let out = "/tmp/jack_docsify_tree_out.md";
...
fn docsify_cobra_generates_output() {
    let dir = "/tmp/jack_cobra_test";
    let out = "/tmp/jack_cobra_out.md";
...
fn docsify_scan_generates_graph() {
    let dir = "/tmp/jack_scan_test";
    let out = "/tmp/jack_scan_out.graphml";
    let _ = fs::create_dir_all(dir);
    fs::write(
        format!("{dir}/main.rs"),
        "fn hello() {}\nfn main() { hello(); }",
...
fn docsify_obsidian_generates_dot_output() {
    let dir = "/tmp/jack_obsidian_test";
    let out = "/tmp/jack_obsidian_out.dot";
    let _ = fs::create_dir_all(dir);
...
fn docsify_obsidian_json_format() {
    let dir = "/tmp/jack_obsidian_json_test";
    let out = "/tmp/jack_obsidian_out.json";
    let _ = fs::create_dir_all(dir);
