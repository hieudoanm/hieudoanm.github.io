...
class McpCommandTest {
    ...
    fun testJsonToCliArgsNull() {
        ...
        assertEquals(listOf("jack", "test", "cmd"), args)
    }

    @Test
    fun testJsonToCliArgsEmptyObject() {
        val args = jsonToCliArgs("test", JsonObject())
        assertEquals(listOf("jack", "test"), args)
    }
    ...
    fun testJsonToCliArgsBooleanTrue() {
        ...
        assertEquals(listOf("jack", "test", "--verbose"), args)
    }
    ...
    fun testJsonToCliArgsString() {
        ...
        val args = jsonToCliArgs("test", obj)
        assertEquals(listOf("jack", "test", "--name", "hello"), args)
    }
    ...
    fun testJsonToCliArgsNumber() {
        ...
        val args = jsonToCliArgs("test", obj)
        assertEquals(listOf("jack", "test", "--count", "42"), args)
    }
    ...
    fun testJsonToCliArgsArray() {
        ...
        val args = jsonToCliArgs("test", obj)
        assertEquals(listOf("jack", "test", "--tags", "a", "--tags", "b"), args)
    }
    ...
    fun testJsonToCliArgsArgsArray() {
        ...
        val args = jsonToCliArgs("test", obj)
        assertEquals(listOf("jack", "test", "arg1", "arg2"), args)
    }
    ...
    fun testJsonToCliArgsMixed() {
        ...
        val args = jsonToCliArgs("test", obj)
        assertEquals(listOf("jack", "test", "--verbose", "--name", "test", "--count", "7", "a", "b"), args)
    }
    ...
    fun testJsonToCliArgsNestedTool() {
        ...
        assertEquals(listOf("jack", "tools", "calc", "bmi"), args)
    }
