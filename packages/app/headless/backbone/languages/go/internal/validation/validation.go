// Package validation validates record data against a collection schema.
package validation
...
// ValidateData checks data against the given schema, returning an error listing every violation.
