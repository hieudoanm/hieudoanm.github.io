  ...
  ${e.mainStart()}
    ...
    ${i.setByOffset("global_idx",r.getByIndices("aIndices"))}
       ...
       `,{name:n,shaderCache:{hint:`${s};${y}`,inputDependencies:["type"]},getShaderSource:e=>`
        ...
        }`,getRunData:()=>({outputs:[{dims:d,dataType:l}],dispatchGroup:{x:h},programUniforms:[{type:12,data:f}]})}),{inputs:[x]})},tQ=(e,r)=>{tX(e,"ReduceMeanShared",r,"mean")},tY=(e,r)=>{tX(e,"ReduceL1Shared",r,"l1")},tJ=(e,r)=>{tX(e,"ReduceL2Shared",r,"l2")},t0=(e,r)=>{tX(e,"ReduceLogSumExpShared",r,"logSumExp")},t1=(e,r)=>{tX(e,"ReduceMaxShared",r,"max")},t2=(e,r)=>{tX(e,"ReduceMinShared",r,"min")},t3=(e,r)=>{tX(e,"ReduceProdShared",r,"prod")},t4=(e,r)=>{tX(e,"ReduceSumShared",r,"sum")},t6=(e,r)=>{tX(e,"ReduceSumSquareShared",r,"sumSquare")},t8=(e,r)=>{tX(e,"ReduceLogSumShared",r,"logSum")}}),nC=G(()=>{ny(),n$(),nT(),nI(),nz(),t5=e=>{if(!e||0===e.length||e.length>2)throw Error("Reduce op requires 1 or 2 inputs.");if(2===e.length&&1!==e[1].dims.length)throw Error("Invalid axes input dims.")},t7=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],t9=(e,r,i,a,n,s,o=!1,u=!1)=>{let l=[],d=i[0].dims,p=d.length,c=e8.normalizeAxes(n,p),h=!u&&0===c.length;d.forEach((e,r)=>{h||c.indexOf(r)>=0?o&&l.push(1):l.push(e)});let f=l.length,m=e8.size(l);return{name:e,shaderCache:r,getShaderSource:e=>{let r=[],n=tM("_A",i[0].dataType,p),u=tD("output",s,f),l=a(n,u,c),m=l[2];for(let e=0,i=0;e<p;e++)h||c.indexOf(e)>=0?(o&&i++,m=`for(var j${e}: u32 = 0; j${e} < ${d[e]}; j${e}++) {
...
var best_index : i32 = 0;`,`if (${e.getByIndices("input_indices")} ${r.selectLastIndex>0?">=":">"} value) {
    ...
    `,r_=(e,r,i,a,n,s,o,u,l,d,p,c)=>{var h,f,m,g,y,_,b,$,v,w,x,S,k,T,I,E,z,C,A,O,R,B,N,M,D;let P,U,q,L,W,V,G,H,F,j,K,Z,X,Q,Y,J,ee,et,er,ei,ea,en,es,eo,eu,el,ed,ep,ec,eh,ef,em,eg,ey=Math.min(e.outputCount,1+ +!!o+ +!!u),e_=ey>1?o:void 0,eb=ey>1?u:void 0,e$=ey>1?d.pastSequenceLength:0,ev=e$+d.kvSequenceLength,ew=l&&e8.size(l.dims)>0?l:void 0,ex=[r,i];e_&&e8.size(e_.dims)>0&&ex.push(e_),ew&&ex.push(ew),p&&ex.push(p),c&&ex.push(c);let eS=e.compute((h=ey,f=r,m=i,g=e_,y=ew,_=d,b=e$,$=p,v=c,P=b+_.kvSequenceLength,U=[_.batchSize,_.numHeads,_.sequenceLength,P],q=h>1&&g,L=_.kvNumHeads?_.kvNumHeads:_.numHeads,W=q?[_.batchSize,L,P,_.headSize]:void 0,V=_.nReps?_.nReps:1,G=0===_.scale?1/Math.sqrt(_.headSize):_.scale,H=tC(_.headSize),F=_.headSize/H,j={x:Math.ceil(P/12),y:Math.ceil(_.sequenceLength/12),z:_.batchSize*_.numHeads},K=[{type:12,data:_.sequenceLength},{type:12,data:F},{type:12,data:P},{type:12,data:_.numHeads},{type:12,data:_.headSize},{type:1,data:G},{type:12,data:b},{type:12,data:_.kvSequenceLength},{type:12,data:V}],Z=q&&g&&e8.size(g.dims)>0,X=["type","type"],Z&&X.push("type"),y&&X.push("type"),$&&X.push("type"),v&&X.push("type"),Q=[{dims:U,dataType:f.dataType,gpuDataType:0}],q&&Q.push({dims:W,dataType:f.dataType,gpuDataType:0}),{name:"AttentionProbs",shaderCache:{hint:`${H};${void 0!==y};${void 0!==g};${h}`,inputDependencies:X},getRunData:()=>({outputs:Q,dispatchGroup:j,programUniforms:K}),getShaderSource:e=>{let r=tM("q",f.dataType,f.dims,H),i=[r,tM("key",m.dataType,m.dims,H)];if(Z){let e=tM("past_key",g.dataType,g.dims,H);i.push(e)}y&&i.push(tM("attention_bias",y.dataType,y.dims));let a=$?tM("seq_lens",$.dataType,$.dims):void 0;a&&i.push(a);let n=v?tM("total_sequence_length_input",v.dataType,v.dims):void 0;n&&i.push(n);let s=tD("output",f.dataType,U),o=[s];q&&o.push(tD("present_key",f.dataType,W,H));let u=tE(1,H);return`
  const TILE_SIZE = 12u;
  ...
  }`},getRunData:()=>({outputs:[],dispatchGroup:{x:1,y:T,z:x*S},programUniforms:et})}),{inputs:p&&c?[eS,p,c]:[eS],outputs:[]});let ek=[eS,a];eb&&e8.size(eb.dims)>0&&ek.push(eb),p&&ek.push(p),c&&ek.push(c),e.compute((C=ey,A=eS,O=a,R=eb,B=d,N=e$,M=p,D=c,en=N+B.kvSequenceLength,es=B.nReps?B.nReps:1,eo=B.vHiddenSize*es,eu=C>1&&R,el=B.kvNumHeads?B.kvNumHeads:B.numHeads,ed=eu?[B.batchSize,el,en,B.headSize]:void 0,ep=[B.batchSize,B.sequenceLength,eo],ec={x:Math.ceil(B.vHeadSize/12),y:Math.ceil(B.sequenceLength/12),z:B.batchSize*B.numHeads},eh=[{type:12,data:B.sequenceLength},{type:12,data:en},{type:12,data:B.vHeadSize},{type:12,data:B.numHeads},{type:12,data:B.headSize},{type:12,data:eo},{type:12,data:N},{type:12,data:B.kvSequenceLength},{type:12,data:es}],ef=eu&&R&&e8.size(R.dims)>0,em=["type","type"],ef&&em.push("type"),M&&em.push("type"),D&&em.push("type"),eg=[{dims:ep,dataType:A.dataType,gpuDataType:0}],eu&&eg.push({dims:ed,dataType:A.dataType,gpuDataType:0}),{name:"AttentionScore",shaderCache:{hint:`${void 0!==R};${C}`,inputDependencies:em},getRunData:()=>({outputs:eg,dispatchGroup:ec,programUniforms:eh}),getShaderSource:e=>{let r=tM("probs",A.dataType,A.dims),i=[r,tM("v",O.dataType,O.dims)];ef&&i.push(tM("past_value",R.dataType,R.dims));let a=M?tM("seq_lens",M.dataType,M.dims):void 0;M&&i.push(a);let n=D?tM("total_sequence_length_input",D.dataType,D.dims):void 0;D&&i.push(n);let s=[tD("output",A.dataType,ep)];return eu&&s.push(tD("present_value",A.dataType,ed)),`
  const TILE_SIZE = 12u;
...
}`,rU=e=>{let r=tE(e.inputs[0].dataType);e.compute(rw(e.inputs[0],"Erf",e=>`erf_vf32(${e})`,rP(r)))},rq=e=>{e.compute(rw(e.inputs[0],"Exp","exp"))},rL=e=>{e.compute(rw(e.inputs[0],"Floor","floor"))},rW=e=>{let r=tE(e.inputs[0].dataType);e.compute(rw(e.inputs[0],"Gelu",e=>`0.5 * ${e} * (1.0 + erf_vf32(${e} * 0.7071067811865475))`,rP(r)))},rV=(e,r)=>{let i=tE(e.inputs[0].dataType);e.compute(rw(e.inputs[0],"LeakyRelu",e=>`select(leaky_relu_alpha_ * ${e}, ${e}, ${e} >= vec4<${i}>(0.0))`,`const leaky_relu_alpha_ = ${i}(${r.alpha});`,r.cacheKey))},rG=e=>{e.compute(rw(e.inputs[0],"Not",e=>`!${e}`))},rH=e=>{e.compute(rw(e.inputs[0],"Neg",e=>`-${e}`))},rF=e=>{e.compute(rw(e.inputs[0],"Reciprocal",e=>`1.0/${e}`))},rj=e=>{let r=tE(e.inputs[0].dataType);e.compute(rw(e.inputs[0],"Relu",e=>`select(vec4<${r}>(0.0), ${e}, ${e} > vec4<${r}>(0.0))`))},rK=e=>{e.compute(rw(e.inputs[0],"Sigmoid",e=>`(1.0 / (1.0 + exp(-${e})))`))},rZ=e=>tS(e),rX=(e,r)=>{let i=tE(e.inputs[0].dataType);e.compute(rw(e.inputs[0],"HardSigmoid",e=>`max(vec4<${i}>(0.0), min(vec4<${i}>(1.0), ${r.alpha} * ${e} + vec4<${i}>(${r.beta})))`,void 0,r.cacheKey))},rQ=e=>{e.compute(rw(e.inputs[0],"Sin","sin"))},rY=e=>{e.compute(rw(e.inputs[0],"Sinh","sinh"))},rJ=e=>{e.compute(rw(e.inputs[0],"Sqrt","sqrt"))},r0=e=>{e.compute(rw(e.inputs[0],"Tan","tan"))},r1=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,r2=e=>{e.compute(rw(e.inputs[0],"Tanh",r1))},r3=(e="f32")=>`
...
`),r.cacheKey,e.inputs[0].dataType))}}),nM=G(()=>{n$(),nI(),nN(),ie=e=>{var r;let i,a,n,s,o,u;(e=>{if(3!==e[0].dims.length)throw Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw Error("hidden state should be 2560, 5120 or 10240");if(1!==e[1].dims.length)throw Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw Error("last dimension of input and bias are not the same")})(e.inputs),e.compute(((i=(r=e.inputs)[0].dims.slice())[2]=i[2]/2,a=tM("input",r[0].dataType,r[0].dims,4),n=tM("bias",r[0].dataType,[r[0].dims[2]],4),s=tD("output",r[0].dataType,i,4),o=e8.size(i)/4,u=tI(r[0].dataType),{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:i,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)}}),getShaderSource:e=>`
  ...
  ${e.mainStart()}
    ...
    fn pow_vector_custom(a : vec4<${r}>, b : vec4<${r}>) -> vec4<${r}> {
      ...
      `)},iu=e=>{it(e,"Sub",(e,r)=>`${e}-${r}`)},il=e=>{it(e,"Greater",{scalar:(e,r)=>`u32(${e}>${r})`,vector:(e,r)=>`vec4<u32>(${e}>${r})`},void 0,void 0,9)},id=e=>{it(e,"Less",{scalar:(e,r)=>`u32(${e}<${r})`,vector:(e,r)=>`vec4<u32>(${e}<${r})`},void 0,void 0,9)},ip=e=>{it(e,"GreaterOrEqual",{scalar:(e,r)=>`u32(${e}>=${r})`,vector:(e,r)=>`vec4<u32>(${e}>=${r})`},void 0,void 0,9)},ic=e=>{it(e,"LessOrEqual",{scalar:(e,r)=>`u32(${e}<=${r})`,vector:(e,r)=>`vec4<u32>(${e}<=${r})`},void 0,void 0,9)}}),nP=G(()=>{ny(),n$(),nT(),nI(),ih=(e,r)=>{let i=e.inputs,a=i[0].dims,n=e8.normalizeAxis(r.axis,a.length);var s=i,o=n;if(!s||s.length<1)throw Error("too few inputs");let u=s[0],l=u.dataType,d=u.dims.length;s.forEach((e,r)=>{if(0!==r){if(e.dataType!==l)throw Error("input tensors should be one type");if(e.dims.length!==d)throw Error("input tensors should have the same shape");e.dims.forEach((e,r)=>{if(r!==o&&e!==u.dims[r])throw Error("non concat dimensions must match")})}});let p=a.slice();p[n]=i.reduce((e,r)=>e+(r.dims.length>n?r.dims[n]:0),0);let c=i.filter(e=>e8.size(e.dims)>0);e.compute(((e,r,i,a)=>{let n=e8.size(i),s=Array(e.length),o=Array(e.length),u=0,l=[],d=[],p=[{type:12,data:n}];for(let i=0;i<e.length;++i)u+=e[i].dims[r],s[i]=u,d.push(e[i].dims.length),o[i]=tM(`input${i}`,a,d[i]),l.push("rank"),p.push({type:12,data:s[i]});for(let r=0;r<e.length;++r)p.push(...tz(e[r].dims));p.push(...tz(i));let c=tD("output",a,i.length),h=c.indicesGet("indices",r),f=Array.from(Array(s.length).keys()).map(e=>`uniforms.sizeInConcatAxis${e}`).join(",");return{name:"Concat",shaderCache:{hint:`${r}`,inputDependencies:l},getRunData:()=>({outputs:[{dims:i,dataType:a}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:p}),getShaderSource:r=>{let i,a;return`
...
`)})(o,c)}
  }`}}})(c,n,p,i[0].dataType),{inputs:c})},im=e=>tS({axis:e.axis})}),nU=G(()=>{ny(),n$(),ig=(e,r,i="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${r}(0.0));`;case"Sigmoid":return`value = (${r}(1.0) / (${r}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${r}(${i}(uniforms.clip_min)), ${r}(${i}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${r}(0.0), min(${r}(1.0), ${i}(uniforms.alpha) * value + ${i}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${i}(uniforms.alpha) * value, value, value >= ${r}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case"":return"";default:throw Error(`Unsupported activation ${e.activation}`)}},iy=(e,r)=>{"Clip"===e.activation?r.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):"HardSigmoid"===e.activation?r.push({type:1,data:e.alpha},{type:1,data:e.beta}):"LeakyRelu"===e.activation&&r.push({type:1,data:e.alpha})},i_=(e,r)=>{"Clip"===e.activation?r.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):"HardSigmoid"===e.activation?r.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):"LeakyRelu"===e.activation&&r.push({name:"alpha",type:"f32"})},ib=e=>{let r=e?.activation||"";if("HardSigmoid"===r){let[i,a]=e?.activation_params||[.2,.5];return{activation:r,alpha:i,beta:a}}if("Clip"===r){let[i,a]=e?.activation_params||[e9,te];return{activation:r,clipMax:a,clipMin:i}}if("LeakyRelu"===r){let[i]=e?.activation_params||[.01];return{activation:r,alpha:i}}return{activation:r}}}),nq=G(()=>{i$=(e,r)=>{switch(e){case 1:return r;case 2:return`vec2<${r}>`;case 3:return`vec3<${r}>`;case 4:return`vec4<${r}>`;default:throw Error(`${e}-component is not supported.`)}},iv=e=>`
...
`}),nW=G(()=>{ny(),n$(),nI(),nU(),ix=(e,r,i,a,n)=>{let s=a-i;return`
...
`}return e})()}
  ...
  `}}}}),nV=G(()=>{ny(),n$(),nI(),nU(),nW(),nq(),ik=(e,r,i="f32",a,n=!1,s=32,o=!1,u=32)=>{let l,d,p,c,h=r[1]*e[1],f=r[0]*e[0],m=n?h:s,g=n?s:h,y=m/r[0],_=s/r[1];if(!((n&&4===y&&4===e[1]||!n&&(3===y||4===y))&&m%r[0]==0&&s%r[1]==0&&4===e[0]))throw Error(`If transposeA ${n} is true, innerElementSize ${y} and workPerThread[1] ${e[1]} must be 4.
...
`)};
    ...
    ${e.mainStart()}
    ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
    ${a}`},getRunData:()=>({outputs:[{dims:s,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:c})}),{inputs:[0]})}}),n0=G(()=>{ny(),n$(),nI(),nN(),i9=e=>{var r;let i,a,n,s;e.inputs.length<2||0===e8.size(e.inputs[1].dims)?r6(e):e.compute((i=(r=e.inputs)[0].dataType,a=e8.size(r[0].dims),s=(n=e8.size(r[1].dims))%4==0,{name:"FastGeluWithBias",shaderCache:{hint:`${s}`,inputDependencies:["type","type"]},getShaderSource:e=>{let r=tM("x",i,[1],4),a=tM("bias",i,[1],4),n=tD("y",i,[1],4),o=e=>`
  ...
  ${e.mainStart()}
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
  }`}},{inputs:[a],outputs:[-1]})[0]),x=r.batchDims+m;if(x>c.length)throw Error("last dimension of indices must not be larger than rank of input tensor");let S=f.slice(0,-1).concat(c.slice(x)),k=e8.size(S),T=[{type:12,data:k},{type:12,data:y},...tz(p[0].dims,w.dims,S)];e.compute({name:"GatherND",shaderCache:{hint:r.cacheKey,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:S,dataType:h}],dispatchGroup:{x:Math.ceil(k/64)},programUniforms:T}),getShaderSource:e=>{let r=tM("data",p[0].dataType,p[0].dims.length),i=tM("slice_offsets",12,w.dims.length),a=tD("output",p[0].dataType,S.length);return`
      ...
      ${g.setByOffset("global_idx","value")};
  }`}))}}),n6=G(()=>{ny(),n$(),nI(),au=e=>({transA:e.transA,transB:e.transB,alpha:e.alpha,beta:e.beta,cacheKey:`${e.transA};${e.transB};${1===e.alpha}`}),al=(e,r)=>{(e=>{if(!e)throw Error("Input is missing");if(e.length<2||e.length>3)throw Error("Invaid input number.");if(3===e.length&&e[2].dims.length>2)throw Error("Invalid input shape of C");if(e[0].dataType!==e[1].dataType||3===e.length&&e[0].dataType!==e[2].dataType)throw Error("Input types are mismatched")})(e.inputs),e.compute(((e,r)=>{let i=e[0].dims.slice(),a=e[1].dims.slice(),[n,s,o]=e7.getShapeOfGemmResult(i,r.transA,a,r.transB,3===e.length?e[2].dims:void 0),u=[n,s],l=Math.ceil(s/16),d=Math.ceil(n/16),p=(e8.size(u),[{type:12,data:l},{type:12,data:n},{type:12,data:s},{type:12,data:o},{type:1,data:r.alpha},{type:1,data:r.beta}]),c=["type","type"];return 3===e.length&&(p.push(...tz(e[2].dims)),c.push("rank")),p.push(...tz(u)),{name:"GemmShared",shaderCache:{hint:`${r.cacheKey}`,inputDependencies:c},getRunData:()=>({outputs:[{dims:u,dataType:e[0].dataType}],dispatchGroup:{x:l*d},programUniforms:p}),getShaderSource:i=>{let a=tM("a",e[0].dataType,e[0].dims),n=tM("b",e[1].dataType,e[1].dims),s=null,o=[a,n];3===e.length&&(s=tM("c",e[2].dataType,e[2].dims.length),o.push(s));let l=tD("output",e[0].dataType,u.length);o.push(l);let d="",p="";r.transA&&r.transB?(p=`
...
`)}
  ...
  ${r.mainStart()}
    ...
    ${_?"inv_std_output[global_idx] = inv_std_dev":""};
  }`}}})(e.inputs,r,e.outputCount))}}),si=G(()=>{n$(),nW(),nV(),aR=e=>{var r=e.inputs;if(!r||2!==r.length)throw Error("MatMul requires 2 inputs.");if(r[0].dims[r[0].dims.length-1]!==r[1].dims[r[1].dims.length-2])throw Error("shared dimension does not match.");let i=e6.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!i)throw Error("Can't use matmul on the given tensors");let a=i[i.length-1],n=e.inputs[0].dims[e.inputs[0].dims.length-1];if(a<8&&n<8)e.compute(iS(e.inputs,{activation:""},i));else{let r=i[i.length-2],s=e8.size(e.inputs[0].dims.slice(0,-2)),o=e8.size(e.inputs[1].dims.slice(0,-2));if(1!==s&&1===r&&1===o){let r=e.inputs[0].reshape([1,s,n]),o=e.inputs[1].reshape([1,n,a]),u=[1,s,a],l=[r,o];e.compute(iE(l,{activation:""},i,u),{inputs:l})}else e.compute(iE(e.inputs,{activation:""},i))}}}),sa=G(()=>{ny(),n$(),nT(),nI(),aB=(e,r)=>{var i,a,n,s;let o,u,l,d,p,c,h,f,m,g,y,_,b,$,v,w,x,S,k,T,I,E,z,C,A,O,R,B,N,M,D,P,U,q,L,W,V,G,H,F,j,K;((e,r)=>{if(e.length<3||e.length>4)throw Error("MatMulNBits requires 3 or 4 inputs");let i=e[0],a=i.dims.length;if(i.dims[a-1]!==r.k)throw Error("The last dim of input shape does not match the k value");let n=Math.floor((r.k+r.blockSize-1)/r.blockSize),s=r.blockSize/8*r.bits,o=e[1];if(!e8.areEqual(o.dims,[r.n,n,s]))throw Error("The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize");let u=e[2].dims;if(e8.size(u)!==r.n*n)throw Error("scales input size error.");if(4===e.length){let i=e[3].dims,a=r.n*(8===r.bits?n:Math.floor((n*r.bits+7)/8));if(e8.size(i)!==a)throw Error("zeroPoints input size error.")}})(e.inputs,r),32===r.blockSize&&e.adapterInfo.isVendor("intel")&&e.adapterInfo.isArchitecture("gen-12lp")?e.compute((i=e.inputs,a=r,u=(o=i[0].dims).length,l=o[u-2],d=a.k,p=a.n,c=o.slice(0,u-2),h=e8.size(c),f=i[1].dims[2]/4,m=i[0].dataType,g=tC(a.k),y=tC(f),_=c.concat([l,p]),$=128/(b=p%8==0?8:p%4==0?4:1),x=(w=$*y*(v=Math.floor(32/a.bits)))/g,S=w/a.blockSize,k=e8.size(_)/b,T=[],I=[h,l,d/g],(E=e8.convertShape(i[1].dims).slice()).splice(-1,1,f/y),T.push(...tz(I)),T.push(...tz(E)),T.push(...tz(i[2].dims)),4===i.length&&T.push(...tz(e8.convertShape(i[3].dims))),z=[h,l,p],T.push(...tz(z)),{name:"BlockwiseMatMulNBits32",shaderCache:{hint:`${a.blockSize};${g};${y};${$};${b}`,inputDependencies:Array(i.length).fill("rank")},getRunData:()=>({outputs:[{dims:_,dataType:m}],dispatchGroup:{x:k},programUniforms:T}),getShaderSource:e=>{let r=I.length,n=tM("a",i[0].dataType,r,g),s=tM("b",12,E.length,y),o=tM("scales",i[2].dataType,i[2].dims.length),u=[n,s,o],l=4===i.length?tM("zero_points",12,i[3].dims.length):void 0;l&&u.push(l);let d=z.length,p=tD("output",i[0].dataType,d),c=tI(i[0].dataType),h=()=>{switch(g){case 1:return`
        ...
        }`}})):e.compute((n=e.inputs,s=r,A=(C=n[0].dims).length,O=C[A-2],R=s.k,B=s.n,N=C.slice(0,A-2),M=e8.size(N),D=n[1].dims[2]/4,P=n[0].dataType,U=tC(s.k),q=tC(D),L=tC(B),W=N.concat([O,B]),V=O>1&&B/L%2==0?2:1,G=e8.size(W)/L/V,H=[],F=[M,O,R/U],(j=e8.convertShape(n[1].dims).slice()).splice(-1,1,D/q),H.push(...tz(F)),H.push(...tz(j)),H.push(...tz(n[2].dims)),4===n.length&&H.push(...tz(e8.convertShape(n[3].dims))),K=[M,O,B/L],H.push(...tz(K)),{name:"MatMulNBits",shaderCache:{hint:`${s.blockSize};${s.bits};${U};${q};${L};${V};64`,inputDependencies:Array(n.length).fill("rank")},getRunData:()=>({outputs:[{dims:W,dataType:P}],dispatchGroup:{x:G},programUniforms:H}),getShaderSource:e=>{let r=F.length,i=tM("a",n[0].dataType,r,U),a=tM("b",12,j.length,q),o=tM("scales",n[2].dataType,n[2].dims.length),u=[i,a,o],l=4===n.length?tM("zero_points",12,n[3].dims.length):void 0;l&&u.push(l);let d=K.length,p=tD("output",n[0].dataType,d,L),c=tI(n[0].dataType),h=(()=>{switch(U){case 1:return`array<${c}, 8>`;case 2:return`mat4x2<${c}>`;case 4:return`mat2x4<${c}>`;default:throw Error(`${U}-component is not supported.`)}})(),f=Math.floor(32/s.bits),m=Math.floor(f/8);return`
...
`}
      ...
      }`}},{inputs:[p],outputs:[d?-1:0]})[0],d&&i.compute(tV(x,c),{inputs:[x]})},nn=e=>tS({axis:e.axis})}),sf=G(()=>{ny(),n$(),nI(),ns=e=>Array.from(e.getBigInt64Array(),Number),no=e=>{var r;let i,a,n,s,o,u,l;(e=>{if(!e||2!==e.length)throw Error("Tile requires 2 inputs.");if(1!==e[0].dataType&&10!==e[0].dataType&&6!==e[0].dataType&&12!==e[0].dataType)throw Error("Tile only support float, float16, int32, and uint32 data types");if(7!==e[1].dataType)throw Error("Tile `repeats` input should be of int64 data type");if(1!==e[1].dims.length)throw Error("Tile `repeats` input should be 1-D");if(ns(e[1]).length!==e[0].dims.length)throw Error("Tile `repeats` input should have same number of elements as rank of input data tensor")})(e.inputs),e.compute((i=(r=e.inputs)[0].dims,n=((e,r)=>{let i=[];for(let a=0;a<e.length;++a)i.push(e[a]*r[a]);return i})(i,a=(void 0)??ns(r[1])),s=e8.size(n),o=r[0].dataType,u=tM("input",o,i.length),l=tD("output",o,n.length),{name:"Tile",shaderCache:{hint:`${a}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:n,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:[{type:12,data:s},...tz(r[0].dims,n)]}),getShaderSource:e=>`
