...
edge update -> cdn: fetch`}];var ei=e.i(6204);let et=e=>Math.min(4,Math.max(.25,e)),er={rect:"Rectangle",round:"Rounded",ellipse:"Ellipse",diamond:"Diamond",cylinder:"Cylinder",hexagon:"Hexagon",parallelogram:"Parallelogram",cloud:"Cloud",note:"Note",actor:"Actor"};function ed(e){return et(e+.25)}function es(e){return et(e-.25)}e.s(["default",0,()=>{let e,t,r,d,s,c,l,g,u,p,h,y,m,w,b,v,f,k,x,S,H,q,D,C,A,P,j,I,N,R,B,E,T,M,W=(0,n.c)(103),{text:z,setText:F,parsed:Q,reset:V,importText:J,undo:K,redo:et,canUndo:ec,canRedo:el}=(()=>{let e,o,i,t,r,d,s,c,l,g,u,p,h=(0,n.c)(18),[y,m]=(0,a.useState)(ee),w=(0,a.useRef)(y);h[0]===Symbol.for("react.memo_cache_sentinel")?(e=[],h[0]=e):e=h[0];let b=(0,a.useRef)(e);h[1]===Symbol.for("react.memo_cache_sentinel")?(o=[],h[1]=o):o=h[1];let v=(0,a.useRef)(o),[f,k]=(0,a.useState)(!1),[x,S]=(0,a.useState)(!1);h[2]!==y?(i=()=>{try{window.localStorage.setItem(X,y)}catch{}},t=[y],h[2]=y,h[3]=i,h[4]=t):(i=h[3],t=h[4]),(0,a.useEffect)(i,t),h[5]!==y?(r=(0,Y.parseDiagram)(y),h[5]=y,h[6]=r):r=h[6];let H=r;h[7]===Symbol.for("react.memo_cache_sentinel")?(d=()=>{k(b.current.length>0),S(v.current.length>0)},h[7]=d):d=h[7];let q=d;h[8]===Symbol.for("react.memo_cache_sentinel")?(s=e=>{let o=w.current;e===o||(!(b.current.length>0&&e.startsWith(o))&&(b.current.push(o),b.current.length>100&&b.current.shift()),v.current=[],w.current=e,m(e),q())},h[8]=s):s=h[8];let D=s;h[9]===Symbol.for("react.memo_cache_sentinel")?(c=()=>{let e=b.current.pop();void 0!==e&&(v.current.push(w.current),w.current=e,m(e),q())},h[9]=c):c=h[9];let C=c;h[10]===Symbol.for("react.memo_cache_sentinel")?(l=()=>{let e=v.current.pop();void 0!==e&&(b.current.push(w.current),b.current.length>100&&b.current.shift(),w.current=e,m(e),q())},h[10]=l):l=h[10];let A=l;h[11]===Symbol.for("react.memo_cache_sentinel")?(g=()=>{w.current!==Z&&(b.current.push(w.current),b.current.length>100&&b.current.shift()),v.current=[],w.current=Z,m(Z),q()},h[11]=g):g=h[11];let P=g;h[12]===Symbol.for("react.memo_cache_sentinel")?(u=e=>{D(e)},h[12]=u):u=h[12];let j=u;return h[13]!==x||h[14]!==f||h[15]!==H||h[16]!==y?(p={text:y,setText:D,parsed:H,reset:P,importText:j,undo:C,redo:A,canUndo:f,canRedo:x},h[13]=x,h[14]=f,h[15]=H,h[16]=y,h[17]=p):p=h[17],p})(),{theme:eg,toggleTheme:eu}=(()=>{let[e,o]=(0,a.useState)("dark");return(0,a.useEffect)(()=>{let e=null;try{let o=window.localStorage.getItem(eo);("dark"===o||"light"===o)&&(e=o)}catch{}o(e??"dark")},[]),(0,a.useEffect)(()=>{document.documentElement.dataset.theme="dark"===e?"diagram":"light";try{window.localStorage.setItem(eo,e)}catch{}},[e]),{theme:e,toggleTheme:()=>o(e=>"dark"===e?"light":"dark")}})(),ep=(0,a.useRef)(null),[eh,ey]=(0,a.useState)(1),[em,ew]=(0,a.useState)(!1),[eb,ev]=(0,a.useState)(!1),[ef,ek]=(0,a.useState)("horizontal"),[ex,eS]=(0,a.useState)(null);W[0]===Symbol.for("react.memo_cache_sentinel")?(e={},W[0]=e):e=W[0];let[eH,eq]=(0,a.useState)(e);W[1]!==ef||W[2]!==Q.diagram?(t=(0,ei.computeLayout)(Q.diagram,ef),W[1]=ef,W[2]=Q.diagram,W[3]=t):t=W[3];let eD=t;W[4]!==eD||W[5]!==eH?(r=(0,ei.applyManualPositions)(eD,eH),W[4]=eD,W[5]=eH,W[6]=r):r=W[6];let eC=r,eA=Q.diagram.title||"diagram";W[7]===Symbol.for("react.memo_cache_sentinel")?(d=()=>{eq({}),eS(null)},W[7]=d):d=W[7],W[8]!==z?(s=[z],W[8]=z,W[9]=s):s=W[9],(0,a.useEffect)(d,s),W[10]===Symbol.for("react.memo_cache_sentinel")?(c=()=>{ep.current?.click()},W[10]=c):c=W[10];let eP=c;W[11]!==J?(l=async e=>{e&&J(await e.text())},W[11]=J,W[12]=l):l=W[12];let ej=l;W[13]!==eA||W[14]!==z?(g=()=>{(0,en.downloadDiagram)(z,eA)},W[13]=eA,W[14]=z,W[15]=g):g=W[15];let eI=g;W[16]!==eC||W[17]!==eA||W[18]!==Q.diagram.title?(u=()=>{(0,en.downloadSvg)(eC,Q.diagram.title,eA)},W[16]=eC,W[17]=eA,W[18]=Q.diagram.title,W[19]=u):u=W[19];let eN=u;W[20]!==eC||W[21]!==eA||W[22]!==Q.diagram.title?(p=()=>{(0,en.downloadSvg)(eC,Q.diagram.title,eA,{print:!0,page:"a4-landscape"})},W[20]=eC,W[21]=eA,W[22]=Q.diagram.title,W[23]=p):p=W[23];let eR=p;W[24]!==eC||W[25]!==eA||W[26]!==Q.diagram.title?(h=()=>{(0,en.downloadPng)(eC,Q.diagram.title,eA,{page:"a4-landscape"})},W[24]=eC,W[25]=eA,W[26]=Q.diagram.title,W[27]=h):h=W[27];let eB=h;W[28]!==Q.diagram?(y=async e=>{let o=(0,en.buildSnippet)(Q.diagram,e);try{await navigator.clipboard.writeText(o)}catch{}},W[28]=Q.diagram,W[29]=y):y=W[29];let eG=y;W[30]!==F?(m=e=>{F(e.text),ev(!1)},W[30]=F,W[31]=m):m=W[31];let eE=m;W[32]===Symbol.for("react.memo_cache_sentinel")?(w=e=>{ek(e),eq({})},W[32]=w):w=W[32];let eL=w;W[33]!==eC.nodes.length||W[34]!==F||W[35]!==z?(b=e=>{let o=`shape${eC.nodes.length+1}`,n=`node ${o}: ${er[e]} [${e}]`;F(z?`${z.replace(/\s+$/,"")}
${n}`:n)},W[33]=eC.nodes.length,W[34]=F,W[35]=z,W[36]=b):b=W[36];let eT=b;W[37]!==eC.nodes?(v=(e,o,n)=>{eq(a=>{let i=eC.nodes.find(o=>o.id===e);if(!i)return a;let t=a[e]??{x:i.x,y:i.y};return{...a,[e]:{x:t.x+o,y:t.y+n}}})},W[37]=eC.nodes,W[38]=v):v=W[38];let eM=v,e_=Q.diagram.nodes.length>0;return W[39]!==eG?(f=e=>void eG(e),W[39]=eG,W[40]=f):f=W[40],W[41]===Symbol.for("react.memo_cache_sentinel")?(k=()=>ev(!0),W[41]=k):k=W[41],W[42]===Symbol.for("react.memo_cache_sentinel")?(x=()=>ew(!0),W[42]=x):x=W[42],W[43]===Symbol.for("react.memo_cache_sentinel")?(S=()=>ey(ed),H=()=>ey(es),q=()=>ey(1),W[43]=S,W[44]=H,W[45]=q):(S=W[43],H=W[44],q=W[45]),W[46]!==e_||W[47]!==el||W[48]!==ec||W[49]!==ef||W[50]!==eB||W[51]!==eN||W[52]!==eR||W[53]!==eT||W[54]!==eI||W[55]!==et||W[56]!==V||W[57]!==f||W[58]!==eg||W[59]!==eu||W[60]!==K||W[61]!==eh?(D=(0,o.jsx)($,{canExport:e_,canRedo:el,canUndo:ec,direction:ef,onCopySnippet:f,onDirectionChange:eL,onExamples:k,onExportPng:eB,onExportSvg:eN,onExportSvgPrint:eR,onHelp:x,onNew:V,onNewShape:eT,onOpen:eP,onRedo:et,onSave:eI,onToggleTheme:eu,onUndo:K,onZoomIn:S,onZoomOut:H,onZoomReset:q,theme:eg,zoom:eh}),W[46]=e_,W[47]=el,W[48]=ec,W[49]=ef,W[50]=eB,W[51]=eN,W[52]=eR,W[53]=eT,W[54]=eI,W[55]=et,W[56]=V,W[57]=f,W[58]=eg,W[59]=eu,W[60]=K,W[61]=eh,W[62]=D):D=W[62],W[63]!==ej?(C=(0,o.jsx)("input",{ref:ep,accept:".diagram,.txt,text/plain","aria-label":"Open diagram file",className:"hidden",type:"file",onChange:e=>{ej(e.target.files?.[0]),e.target.value=""}}),W[63]=ej,W[64]=C):C=W[64],W[65]!==Q.errors?(A=Q.errors.length>0&&(0,o.jsx)(G,{errors:Q.errors}),W[65]=Q.errors,W[66]=A):A=W[66],W[67]!==Q.errors||W[68]!==et||W[69]!==F||W[70]!==z||W[71]!==K?(P=(0,o.jsx)("div",{className:"flex w-[44%] max-w-[52%] min-w-64",children:(0,o.jsx)(U,{errors:Q.errors,onChange:F,onRedo:et,onUndo:K,text:z})}),W[67]=Q.errors,W[68]=et,W[69]=F,W[70]=z,W[71]=K,W[72]=P):P=W[72],W[73]!==eM||W[74]!==eC||W[75]!==Q.diagram.title||W[76]!==ex||W[77]!==eh?(j=(0,o.jsx)(i.default,{layout:eC,onDragNode:eM,onSelectNode:eS,selectedId:ex,title:Q.diagram.title,zoom:eh}),W[73]=eM,W[74]=eC,W[75]=Q.diagram.title,W[76]=ex,W[77]=eh,W[78]=j):j=W[78],W[79]!==P||W[80]!==j?(I=(0,o.jsxs)("div",{className:"flex min-h-0 flex-1",children:[P,j]}),W[79]=P,W[80]=j,W[81]=I):I=W[81],W[82]!==Q.diagram.edges.length||W[83]!==Q.diagram.kind||W[84]!==Q.diagram.nodes.length||W[85]!==Q.diagram.title||W[86]!==Q.errors.length?(N=(0,o.jsx)(O,{edges:Q.diagram.edges.length,errors:Q.errors.length,kind:Q.diagram.kind,nodes:Q.diagram.nodes.length,title:Q.diagram.title}),W[82]=Q.diagram.edges.length,W[83]=Q.diagram.kind,W[84]=Q.diagram.nodes.length,W[85]=Q.diagram.title,W[86]=Q.errors.length,W[87]=N):N=W[87],W[88]===Symbol.for("react.memo_cache_sentinel")?(R=()=>ew(!1),W[88]=R):R=W[88],W[89]!==em?(B=(0,o.jsx)(_,{onClose:R,open:em}),W[89]=em,W[90]=B):B=W[90],W[91]===Symbol.for("react.memo_cache_sentinel")?(E=()=>ev(!1),W[91]=E):E=W[91],W[92]!==eb||W[93]!==eE?(T=(0,o.jsx)(L,{examples:ea,onClose:E,onLoadExample:eE,open:eb}),W[92]=eb,W[93]=eE,W[94]=T):T=W[94],W[95]!==D||W[96]!==C||W[97]!==A||W[98]!==I||W[99]!==N||W[100]!==B||W[101]!==T?(M=(0,o.jsxs)("div",{className:"flex h-screen flex-col",children:[D,C,A,I,N,B,T]}),W[95]=D,W[96]=C,W[97]=A,W[98]=I,W[99]=N,W[100]=B,W[101]=T,W[102]=M):M=W[102],M}],69837)}]);